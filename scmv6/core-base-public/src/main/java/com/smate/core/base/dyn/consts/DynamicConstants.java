package com.smate.core.base.dyn.consts;
...
public class DynamicConstants {
  ...
  public static final int RES_TYPE_AGENCY = 25;// 基金资助机构
  public static final int RES_TYPE_NEWS = 26;// 新闻
  public static final int RES_TYPE_GROUP_FILE = 27;// 群组文件
  public static final int RES_TYPE_INS = 29;// 机构
  ...
  static {
    ...
    SHARE_TYPE_MAP.put(RES_TYPE_FUND, RES_TYPE_FUND);
  }

  // 资源分享时，分享资源的类型
  public static final Map<Integer, Integer> SHAER_RESTYPE_MAP = new HashMap<>();
  static {
    SHAER_RESTYPE_MAP.put(RES_TYPE_PUB, RES_TYPE_PUB);
    SHAER_RESTYPE_MAP.put(RES_TYPE_REF, RES_TYPE_REF);
    SHAER_RESTYPE_MAP.put(RES_TYPE_PRJ, RES_TYPE_PRJ);
    SHAER_RESTYPE_MAP.put(RES_TYPE_FUND, RES_TYPE_FUND);
    SHAER_RESTYPE_MAP.put(RES_TYPE_PUB_PDWH, RES_TYPE_PUB_PDWH);
    SHAER_RESTYPE_MAP.put(RES_TYPE_PUB_PDWH, RES_TYPE_PUB_PDWH);
    SHAER_RESTYPE_MAP.put(RES_TYPE_JOURNALAWARD, RES_TYPE_JOURNALAWARD);
    SHAER_RESTYPE_MAP.put(RES_TYPE_JOURNALAWARD, RES_TYPE_JOURNALAWARD);
    SHAER_RESTYPE_MAP.put(RES_TYPE_AGENCY, RES_TYPE_AGENCY);
  }
  ...
  public static final Integer NINE_NINE = 99; // 99标识
  public static final Integer ZERO = 0; // 0标识
  public static final Integer ONE = 1; // 1标识
}
