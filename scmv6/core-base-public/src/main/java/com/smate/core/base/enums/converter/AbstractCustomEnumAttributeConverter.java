...
/**
 * 自定义枚举类型（需实现{@link IBaseEnum}接口）属性转换器
 * 
 * @author houchuanjie
 * @date 2017年7月26日
 * @param <X> 需要转换的枚举类型
 ...
 */
public abstract class AbstractCustomEnumAttributeConverter<X extends IBaseEnum<Y>, Y>
  ...
  public AbstractCustomEnumAttributeConverter() {
