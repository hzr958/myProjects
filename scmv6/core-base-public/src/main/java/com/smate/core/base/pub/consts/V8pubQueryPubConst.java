...
public class V8pubQueryPubConst {
  ...
  public static final String PUB_DUPCHECK_URL = "/data/pub/dupcheck";// 重复成果url
  ...
  public static final String QUERY_LAST_UPDATE_PUB = "queryLastUpdatePub";// 最新成果

  public static final String QUERY_LAST_UPDATE_PUB_BY_PUBIDS = "queryLastUpdatePubByPubIds";// 最新成果

  public static final String PUB_QUERY_BY_PUB_ID = "pubQueryByPubId";// 通过成果id查询成果

  public static final String PUB_LIST_QUERY_BY_PUB_IDS = "pubListQueryByPubIds";// 通过pubids
  // 查询成果列表
  ...
  /** 成果操作 */
  public final static String DELETE_PSN_PUBHANDLER = "deletePsnPubHandler"; // 删除成的hanndel
  public final static String PUBHANDLER_URL = "/data/pub/saveorupdate"; // 保存成果
  public final static String PDWHUPDATESORL_URL = "/data/pub/sorlupdate"; // 更新基准库成果sorl


  public final static String OPEN_VERIFY_PDWH_PUB = "openVerifyPdwhPub"; // 基准库服务类
