 ...
 */
@Entity
@Table(name = "PSN_CONFIG_EDU")
public class PsnConfigEdu implements PsnCnfBase, Serializable {
  /**
   * 
   */
  private static final long serialVersionUID = 7973906744117497616L;

  private PsnConfigEduPk id;
  ...
  public PsnConfigEdu() {
    this.id = new PsnConfigEduPk();
  }

  public PsnConfigEdu(Long cnfId) {
    this.id = new PsnConfigEduPk(cnfId);
  }

  public PsnConfigEdu(PsnConfigEduPk id) {
    this.id = id;
  }

  @JsonIgnore
  @EmbeddedId
  public PsnConfigEduPk getId() {
    return id;
  }
  ...
  public void setId(PsnConfigEduPk id) {
    this.id = id;
  }
