 ...
 */
@Entity
@Table(name = "PSN_CONFIG_WORK")
public class PsnConfigWork implements PsnCnfBase, Serializable {

  /**
   * 
   */
  private static final long serialVersionUID = 1679760744880891487L;

  private PsnConfigWorkPk id;
  ...
  public PsnConfigWork() {
    this.id = new PsnConfigWorkPk();
  }

  public PsnConfigWork(Long cnfId) {
    this.id = new PsnConfigWorkPk(cnfId);
  }

  public PsnConfigWork(PsnConfigWorkPk id) {
    this.id = id;
  }

  @JsonIgnore
  @EmbeddedId
  public PsnConfigWorkPk getId() {
    return id;
  }
  ...
  public void setId(PsnConfigWorkPk id) {
    this.id = id;
  }
