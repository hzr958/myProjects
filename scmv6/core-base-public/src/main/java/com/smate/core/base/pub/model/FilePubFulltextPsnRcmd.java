...
public class FilePubFulltextPsnRcmd implements Serializable {
  ...
  public FilePubFulltextPsnRcmd() {}

  public FilePubFulltextPsnRcmd(Long rcmdId, Long pubId, Long psnId, Long fulltextFileId, Integer dbId,
      Integer matchType, Integer status, Date rcmdDate, Long srcPubId, Long srcPsnId) {
    this.rcmdId = rcmdId;
    this.pubId = pubId;
    this.psnId = psnId;
