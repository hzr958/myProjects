 ...
 */
@Entity
@Table(name = "PSN_CONFIG_BRIEF")
public class PsnConfigBrief implements PsnCnfBase, Serializable {
  /**
   * 
   */
  private static final long serialVersionUID = -3362889560650391776L;
  // 配置主键
  private Long cnfId;
  ...
  public PsnConfigBrief() {

  }

  public PsnConfigBrief(Long cnfId) {
    this.cnfId = cnfId;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (!(obj instanceof PsnConfigBrief)) {
      return false;
    }
    PsnConfigBrief other = (PsnConfigBrief) obj;
    if (anyUser == null) {
