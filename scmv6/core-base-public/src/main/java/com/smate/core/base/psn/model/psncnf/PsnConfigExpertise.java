 ...
 */
@Entity
@Table(name = "PSN_CONFIG_EXPERTISE")
public class PsnConfigExpertise implements PsnCnfBase, Serializable {

  /**
   * 
   */
  private static final long serialVersionUID = 2566564833277312184L;
  ...
  public PsnConfigExpertise() {}

  public PsnConfigExpertise(Long cnfId) {
    this.cnfId = cnfId;
  }
