...
(function($){
    ...
    //供自动单词使用
	// $.autoword.config 供自动单词完成插件(jquery.autoword.js)使用
    $.auto = $.auto ? $.auto : {};
	
    $.auto.key_word = function(input){
    	//是否触发ajax全局事件
    	var inputGlobal = input.attr("global");
        return input.complete({
			"width": 200,
            "key": "key_word",
            "global": inputGlobal=="false" ? false : true
        });
    };
	
	// 研究领域关键词
	/*
$.auto.disc_key_word = function(input){
        return input.complete({
			"width": 200,
            "key": "disc_key_word"
        });
...
*/
     ...
     * 专家系统，关键词提示
     */
    $.auto.expert_keyword = function(input){
        return input.complete({
			"width": 200,
			"ctx":"/egtexpertweb",
            "key": "expert_keyword"
    ...
    $.auto.key_word_hot = function(input){
        return input.complete({
			"width": 200,
            "key": "key_word_hot"
        });
	...
	//rol资助机构
	$.auto.find_Agencys = function(input){
        return input.complete({
            "key": "find_Agencys",
            "width": 200,
			"ctx": "/scmwebrol",
			"bind":{"callback":typeof $.auto.agency_callback !="undefined"?$.auto.agency_callback:function(data){}}
        });
    };
	
  //rol单位人员提示
    $.auto.rolpsn_name = function(input){
        return input.complete({
            "key": "ajaxGetRolPsns",
            "width": 200,
            "parse": $.rolInsPsns_parse,
			"extraParams":typeof extraParams != "undefined"?extraParams:{},
			"bind":{"callback":typeof $.auto.rolpsn_callback !="undefined"?$.auto.rolpsn_callback:function(data){}}
        });
    };
	//联系人名字提示
    $.auto.friend_name = function(input){
        return input.complete({
            "key": "ajaxGetFriends",
            "width": 200,
			...
			"extraParams":typeof extraParams != "undefined"?extraParams:{},
			"bind":{"callback":typeof $.auto.friend_callback !="undefined"?$.auto.friend_callback:function(data){}}
        });
    };
    //群组成员名字提示
    $.auto.groupMember_name = function(input){
    	return input.complete({
    ...
    //报表单位提示
    $.auto.rolRptIns = function(input){
    	return input.complete({
    		"key":"rolRptIns",
    		"width":200
    	});
    };
    $.auto.rolPosition = function(input){
    	return input.complete({
    		"key":"rolPosition",
    		"width":200
    	});
	...
	//研究领域
    $.auto.disc_input = function(input){
        return input.complete({
            "key": "disc_input",
            "width": 200,
    		"extraParams":typeof extraParams != "undefined"?extraParams:{}
    ...
    //基金关键词
    $.auto.rol_fund_keywords = function(input){
        return input.complete({
            "key": "fund_keywords",
            "width": 200,
            "ctx": "/scmwebrol",
    ...
    //基金关键词
    $.auto.bpo_fund_keywords = function(input){
        return input.complete({
            "key": "fund_keywords",
            "width": 200,
            "ctx": "/scmwebbpo",
    ...
    $.fn.complete = function(options){
        ...
        var urlMap = {
            ...
            //"disc_key_word": defaults["ctx"] + "/psnView/ajaxAutoCompleteKw",//研究领域关键词
            ...
            "keywordCmd": defaults["ctx"] + "/keywordscmd/ajaxAutoKwCmd", // 领域推荐
            "egrantkeywordCmd": defaults["ctx"] + "/egrant/keywordscmd/ajaxAutoKwCmd", //egrant领域推荐
            "position": defaults["ctx"] + "/ac/position.action", // 职称
            "ajaxGetFriends": defaults["ctx"] + "/publication/ajaxGetFriendsByAuto",//我的联系人
            "queryJournal": defaults["ctx"] + "/ac/journalInfAc.action", // 期刊检索
            "ajaxGetGroupMember":defaults["ctx"] + "/ac/ajaxGetGroupMembers",//群组成员
            "ajaxGetRolPsns": defaults["ctx"] + "/publication/ajaxGetInsPersonAuto",//rol单位人员
        ...
        this.each(function(index){
            ...
            _this.autocomplete(defaults["key"], {
            	global : defaults["global"] != null ? defaults["global"] : true,
...
(function($){
    ...
    $.Autocompleter = function(input, options){
        ...
        var hasFocus = 0;
         //input获得焦点时触发自动展开：第一次失去体焦点会触发focus,第二次不会。 新增变量isBlur：是否失去焦点、blur_times：失去焦点次数
        var isBlur = false;
        var blur_times = 0;
        ...
        $input.bind(($.browser.opera ? "keypress" : "keyup") + ".autocomplete", function(event){
            ...
            //input获得焦点时触发自动展开：第一次失去体焦点会触发focus,第二次不会。 由失去焦点触发的focus,不展开列表
        	if(!isBlur){
        	  $(this).click();
        	}
        	isBlur=false;
        	//input获得焦点时触发自动展开：第一次失去体焦点会触发focus,第二次不会。 由失去焦点触发的focus,不展开列表end
            ...
            //input获得焦点时触发自动展开：第一次失去体焦点会触发focus,第二次不会。 
            blur_times++;
            if(blur_times%2==0){
            	isBlur=false;
            }else{
            ...
            //input获得焦点时触发自动展开：第一次失去体焦点会触发focus,第二次不会。end
        ...
        function request(term, success, failure){
          //这个方法应该没用了  如果还需要用 在调用的界面上定义need变量
            if(!need){
              return;
            }
            //登录后不刷新当前页面
    ...
    $.Autocompleter.Select = function(options, input, select, config){
        ...
        function init(){
            ...
            list = $("<ul/>").appendTo(element).mouseover(function(event){
                ...
                if(typeof $.autoword!="undefined"){//SCM-4345
                    $.autoword.config = config; 
                     }// 供自动单词完成插件(jquery.autoword.js)使用
            }).mouseup(function(){
