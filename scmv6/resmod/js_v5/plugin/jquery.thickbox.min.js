	...
	$.fn.extend({
		thickbox: function(options) {
			var defaults = {
					...
					loadimg:"/images_v5/plugin/thickbox/loading.gif",
					isShowImgLink:true,
					urlTypes:{},
					closeEvent:null,
	...
	$.Thickbox = function(obj, options) {
		...
		function tb_show(caption, url, imageGroup,params) {//function called when the user clicks on a thickbox link
			...
			try {
				...
				$("body").append("<div id='TB_load'><img src='"+options.respath+options.loadimg+"' /></div>");//add loader to the page
				...
				if(urlType == '.jpg' || urlType == '.jpeg' || urlType == '.png' || urlType == '.gif' || urlType == '.bmp'){//code to show images
					...
					if(url.indexOf('TB_iframe') != -1){// either iframe or ajax window
						...
						if(params['modal'] != "true"){//iframe no modal 
							$("#TB_window").append('<div id="TB_title" style='+ajaxContentW+'><div id="TB_ajaxWindowTitle" style="padding-left: 0px; padding-top: 0px;padding-bottom: 0px;" >'+caption+'</div><div id="TB_closeAjaxWindow" style="padding-left: 0px;padding-top: 0px;padding-bottom: 0px;padding-right: 0px;"><a href="javascript:;" id="TB_closeWindowButton" title="'+options.closeStr+'"><img src="' + options.respath + '/images_v5/mbClose2.gif" alt="" border="0" /></a></div></div><iframe frameborder="0" hspace="0" src="'+urlNoQuery[0]+'" id="TB_iframeContent" scrolling="auto" name="TB_iframeContent'+Math.round(Math.random()*1000)+'" style="width:'+ajaxContentW+'px;height:'+ajaxContentH +'px; overflow-x:hidden; border:solid #395c93; border-width:0px 1px 1px 1px;" > </iframe>');
						...
						tb_position();
							...
							if($("#TB_window").css("display") != "block"){ 
								if( params['modal'] != "true"){//ajax no modal
									...
									$("#TB_window").append("<div id='TB_title' style="+ajaxContentW+"><div id='TB_ajaxWindowTitle' style='padding-left: 0px;padding-top: 0px;padding-bottom: 0px;' >"+caption+"</div><div id='TB_closeAjaxWindow' style='padding-left: 0px;padding-top: 0px;padding-bottom: 0px;padding-right: 0px;' ><a href='javascript:;' id='TB_closeWindowButton'><img src='" + options.respath + "/images_v5/mbClose2.gif' alt='' border='0' /></a></div></div><div id='TB_ajaxContent' style='width:"+ajaxContentW+"px;height:"+ajaxContentH+"px'></div>");
								}else{//ajax modal
									$("#TB_overlay").unbind();
