...
(function($){
    $.fn.discipline = function(options){
        ...
        $(".discipline_body ol li").live("click", function(e){//选择学科代码
            var liId = $(this).attr("id");
            if (/^.+disc_code_(.{1,7})$/gi.test(liId)) {
    ...
    $.discipline = {
        ...
        "_locale": {//国际化
            ...
            "zh_CN.label.disciplineChoosen": "您已经选中了",
            "zh_CN.label.disciplineChoosenTips": "请从上面的选择框中由左到右选择您的学科",
            ...
            "zh_CN.label.tip": "提示",
            "zh_CN.label.loginTimeout": "系统超时或未登录，您要登录吗？",
