...
(function (e) {
    ...
    function v(a, b, c, d, h) {
        ...
        if (l && b.toLowerCase() == "inserthtml") y(a).pasteHTML(c);
            ...
            d || ("cutcopypaste".indexOf(b) >
                -1 ? z(a, "For security reasons, your browser does not support the " + b +
                    " command. Try using the keyboard shortcut or context menu instead.", h) : z(a, f ? f :
                    "Error executing the " + b + " command.", h))
        }
        u(a);
        return d
    }
    ...
    function K(a) {
        ...
        var d = a.$frame = e('<iframe frameborder="0" src="javascript:true;">').hide().appendTo(b),
            ...
            i = e(f);
        f.open();
        f.write(c.docType + "<html>" + (c.docCSSFile === "" ? "" :
                '<head><link rel="stylesheet" type="text/css" href="' + c.docCSSFile + '" /></head>') +
...
["Header 3", "<h3>"], ["Header 4", "<h4>"], ["Header 5", "<h5>"], ["Header 6", "<h6>"]],
    ...
    var H = "backgroundColor",
        ...
        B = "cleditorPrompt",
        fa = "cleditorMsg",
        l = /msie/.test(navigator.userAgent.toLowerCase()),
    ...
    cleditor = function (a, b) {
        ...
        e.each(b.controls.split(" "), function (g, j) {
            ...
            if (j == "|") {
                ...
                var k = s[j],
                    o = e(m).data(x, k.name).addClass(W).attr("title", k.title).bind(q, e.proxy(aa, c))
                    .appendTo(i).hover(O, P),
                    G = {};
                if (k.css) G = k.css;
    ...
    e.each([["clear", function (a) {
            a.$area.val("");
            E(a)
        }], ["disable", T], ["execCommand", v], ["focus", w], ["hidePopups", r], ["sourceMode", t, true], [
            "refresh", K], ["select",
function (a) {
                setTimeout(function () {
