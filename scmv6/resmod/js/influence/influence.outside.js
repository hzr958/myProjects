...
Influence.main = function(){
	...
	$.ajax({
		url: "/psnweb/outside/influence/ajaxmain",
		data: {
...
Influence.getPsnStatistics = function(){
    var des3PsnId = $("#outsideDes3PsnId").val();
    $.ajax({
        url: '/psnweb/outside/influence/ajaxstatistics',
        type: 'post',
        data: {
            "des3PsnId" : des3PsnId
        },
...
Influence.getVisitIns = function(){
    var des3PsnId = $("#outsideDes3PsnId").val();
    $.ajax({
        url: '/psnweb/outside/influence/ajaxvisitins',
        type: 'post',
        data: {
            "des3PsnId" : des3PsnId
        },
...
Influence.getVisitPos = function(){
    var des3PsnId = $("#outsideDes3PsnId").val();
    $.ajax({
        url: '/psnweb/outside/influence/ajaxvisitpos',
        type: 'post',
        data: {
            "des3PsnId" : des3PsnId
        },
...
Influence.showVisitMap = function(){
	$.ajax({
		url: '/psnweb/outside/influence/ajaxvisitmap',
		type: 'post',
		data: {"des3PsnId":$("#outsideDes3PsnId").val()},
		dataType: "json",
		success: function(data){
			if (data.result=="success") {
...
Influence.showLineMap = function(){
    var des3PsnId = $("#outsideDes3PsnId").val();
	$.ajax({
		url: '/psnweb/outside/influence/ajaxreadline',
		type: 'post',
		data: {
		    "des3PsnId": des3PsnId
		},
...
Influence.showBarMap = function(){
	$.ajax({
		url: '/psnweb/outside/influence/ajaxpubcite',
		type: 'post',
		data: {"des3PsnId": $("#outsideDes3PsnId").val()},
		dataType: "json",
		success: function(data){
...
Influence.showHindexMap = function(){
	$.ajax({
		url: '/psnweb/outside/influence/ajaxhindex',
		type: 'post',
		data: {
...
Influence.showLineOption = function(data){
    ...
    if(document.getElementById("linemap") != null && document.getElementById("linemap") != undefined){
        var myChart = echarts.init(document.getElementById("linemap"), "walden");
        // 为echarts对象加载数据
        myChart.setOption(option);
    }else{
        console.log("为echarts对象加载数据 为null");
    }
};
/**
 * 论文引用趋势柱状图option
...
Influence.getHindexRankingInFriends = function(){
    $.ajax({
        url: '/psnweb/outside/influence/hindex/ajaxranking',
        type: 'post',
        data: {
            "des3PsnId": $("#outsideDes3PsnId").val()
        },
...
Influence.getVisitRankingInFriends = function(){
    $.ajax({
        url: '/psnweb/outside/influence/visit/ajaxranking',
        type: 'post',
        data: {
            "des3PsnId": $("#outsideDes3PsnId").val()
        },
...
Influence.showHindexPub = function() {
    $.ajax({
        url: '/pub/outside/influence/ajaxhindexlist',
        type: 'post',
        data: {
            "des3PsnId" : $("#outsideDes3PsnId").val(),
            "hIndex": $("#influence_hindex").html()
        },
        dataType: "html",
        success: function(data){
			BaseUtils.ajaxTimeOut(data,function(){
