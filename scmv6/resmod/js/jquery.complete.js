...
*/
     ...
     * 专家系统，关键词提示
     */
    $.auto.expertKeyword = function(input){
        return input.complete({
			"width": 200,
			"ctx":"/egtexpertweb",
            "key": "expert_keyword"
    ...
    $.auto.keywordHot = function(input){
        return input.complete({
			"width": 200,
            "key": "key_word_hot"
        });
	...
	//rol资助机构
	$.auto.findAgencys = function(input){
        return input.complete({
            "key": "find_Agencys",
            "width": 200,
			"ctx": "/scmwebrol",
  ...
  //rol单位人员提示
    $.auto.rolPsnName = function(input){
        return input.complete({
            "key": "ajaxGetRolPsns",
            "width": 200,
	...
	//联系人名字提示
    $.auto.friendName = function(input){
        return input.complete({
            "key": "ajaxGetFriends",
            "width": 200,
    ...
    //群组成员名字提示
    $.auto.groupMemberName = function(input){
    	return input.complete({
    ...
    //基金关键词
    $.auto.rolFundKeywords = function(input){
        return input.complete({
            "key": "fund_keywords",
            "width": 200,
            "ctx": "/scmwebrol",
    ...
    //基金关键词
    $.auto.bpoFundKeywords = function(input){
        return input.complete({
            "key": "fund_keywords",
            "width": 200,
            "ctx": "/scmwebbpo",
