...
(function($){
    ...
    $.fn.smate.appraisal = function(options){
        var defaults = {
            "key": null,
            "snsctx": null,
            "appStatus": null
        ...
        if (typeof options != "undefined") {
            ...
            if (typeof snsctx != "undefined") {
                defaults["snsctx"] = snsctx;
            }
        }
        ...
        var urlMap = {
            //工作评价
            "work": defaults["snsctx"] + "/friendFappraisal/ajaxLoadMain",
			//工作评价详情
            "work_detail": defaults["snsctx"] + "/friendFappraisal/ajaxLoadDetail"
        };
