 ...
 */
@Entity
@Table(name = "V_BATCH_JOBS")
public class BatchJobs implements Serializable {

  /**
   * 
   */
  private static final long serialVersionUID = -1101840893732705190L;

  @Id
  @Column(name = "JOB_ID")
  @SequenceGenerator(name = "SEQ_STORE", sequenceName = "V_SEQ_BATCH_JOBS", allocationSize = 1)
  ...
  public BatchJobs(String jobContext, String weight, String strategy) {
    super();
