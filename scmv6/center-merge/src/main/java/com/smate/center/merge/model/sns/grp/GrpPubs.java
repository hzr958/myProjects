...
public class GrpPubs implements Serializable {
  ...
  public GrpPubs(Long id, Long grpId, Long pubId, Integer labeled, Integer relevance, Long createPsnId, Date createDate,
      Date updateDate, Long updatePsnId, Integer isProjectPub, Integer status, Long ownerPsnId) {
    super();
    this.id = id;
    this.grpId = grpId;
    this.pubId = pubId;
  ...
  public String toString() {
    return "GrpPubs [id=" + id + ", grpId=" + grpId + ", pubId=" + pubId + ", labeled=" + labeled + ", relevance="
