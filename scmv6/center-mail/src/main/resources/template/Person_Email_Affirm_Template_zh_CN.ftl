            ...
            <td>
                <table border="0" cellspacing="0" cellpadding="0" style=" width:100%; font-family:Arial, Helvetica, 'Microsoft YaHei'; font-size:14px; color:#333333; background:#fff; padding:20px; border:1px solid #eaeaea; line-height:150%;">
                  <tr>
                    ...
                    <p style=" margin:0; padding:0; margin-left:40px;font-weight:bold;">${zh_CN_psnname}，请在24小时内点击下面的按钮确认邮箱地址。</p>
                    <p style=" margin:30px 0 0 40px;font-weight:bold;">
                    <a href="${keycode_app_baseUrl!''}"  target="_blank"  style=" height:26px; padding:0 20px; margin:0; margin-right:10px; line-height:26px; color:#fff; text-decoration:none; background:#55b1f5; border:1px solid #c9cdd1; display:inline-block;width: 72px;text-align:center">确认</a>
                    </p>
                    </td>
                  </tr>
                </table>
