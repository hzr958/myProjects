					...
					<tr>
						<td style="font-size: 14px; font-weight: bold; line-height: 150%;">
							<p style="margin: 0; padding: 0;">
								${receiver}，<span><a href="${senderPersonUrl!'#'}"  target="_blank"  style=" color:#55b1f5;text-decoration:none; ">${sender}</a></span><#if assignmentCount?number ==1>
								在群组“${groupName}”添加了1个作业。 <#elseif (assignmentCount?number >1)>
								在群组“${groupName}”添加了${assignmentCount}个作业。 </#if>
							</p>
						</td>
					</tr>
					<tr>
									...
									<td rowspan="4" valign="top" style="padding-left:15px;">
										...
										<p style="margin: 15px 0 0 0px; font-weight: bold;">
											<a href="${shareAssignmentUrl!''}" target="_blank"
												style="height: 26px; padding: 0 20px; margin: 0; margin-right: 10px; line-height: 26px; color: #fff; text-decoration: none; background: #55b1f5; border: 1px solid #49a0e0; display: inline-block;">查看作业</a>
											<a href="${assignmentUrl!''}" target="_blank"
												style="height: 26px; padding: 0 20px; margin: 0; margin-right: 10px; line-height: 26px; color: #666666; text-decoration: none; background: #ffffff; border: 1px solid #c9cdd1; display: inline-block;">全部作业</a>
										</p>
									</td>
								</tr>
							</table>
