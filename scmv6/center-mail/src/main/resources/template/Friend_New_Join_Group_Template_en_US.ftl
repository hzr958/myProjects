...
<table width="600" border="0" align="center" cellpadding="0" bgcolor="#d0daea" cellspacing="10" style="font-family:Arial, Helvetica, '宋体'; font-size:12px; color:#333;">
  ...
  <tr style="font-size:14px;">
    <td style="line-height:25px;"><span style="font-weight:bold;">${psnName}</span>, <a href="${frdUrl1!'#'}" style="font-weight:bold; color:#426cad; text-decoration:none;">${friendName}</a><#if (count?exists)>&nbsp;and <a href="${groupUrl2!'#'}" style="font-weight:bold; color:#426cad; text-decoration:none;">${count}</a> others</#if> joined the group:</td>
  </tr>
  <tr>
    <td align="left" valign="top" bgcolor="#f9f9f9"><table width="100%" border="0" cellspacing="0" cellpadding="5" style="font-size:12px; color:#333; line-height:20px;">
      <tr>
        <td align="left" valign="top"><a href="${groupUrl3!'#'}" style="font-weight:bold; color:#426cad; font-size:12px; text-decoration:none;">${groupName}</a><br /><#if (groupDesc?exists)><a href="${groupUrl4!'#'}" style="font-weight:bold; color:#426cad; font-size:12px; text-decoration:none;">Group Introduction:</a>${groupDesc}</#if></td>
        </tr>
      </table></td>
  </tr>
  </table></td>
                ...
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td align="left" valign="middle"><table width="130" border="0" cellpadding="0" cellspacing="1" bgcolor="#6a8bbf">
                      <tr>
                        <td height="30" align="center" bgcolor="#d6e3f6"  style=" border-top:1px solid #ebf1fb;"><a href="${groupUrl5!'#'}" style="font-size:14px; color:#3f68a8;  text-align:center; line-height:30px; text-align:center; font-weight:bold; text-decoration:none;">View Group</a></td>
                        </tr>
                      </table></td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="13">
                    <tr>
                      <td height="40" align="center" bgcolor="#f3f3f3" style="text-align:center; font-size:14px; color:#999999;">Expand your social network to gain more information and opportunities, and to increase your productivity.</td>
                    </tr>
                  </table>
            </td>
          </tr>
