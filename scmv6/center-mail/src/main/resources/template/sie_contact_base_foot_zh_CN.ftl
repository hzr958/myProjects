<!-- 页脚内容(样式内容) -->
 <table width="728" border="0" align="center" cellpadding="0" cellspacing="0" style=" font-family:Arial, Helvetica, 'Microsoft YaHei'; font-size:12px; color:#999999; padding:10px 0; margin-top:5px;">
...
此邮件为系统发出，请勿回复。如对我们的产品有疑问，请发送邮件至<a href="mailto:sie-support@scholarmate.com"  target="_blank" style="color:#55b1f5; text-decoration:none;">sie-support@scholarmate.com</a>。
