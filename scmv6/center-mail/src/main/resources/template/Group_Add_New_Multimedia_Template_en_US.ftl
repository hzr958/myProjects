...
<head>
<meta charset="utf-8">
<title>Upload group courseware in a group</title>
</head>
<body>
					...
					<tr>
						<td style="font-size: 14px; font-weight: bold; line-height: 150%;">
							...
							<p style="margin: 0; padding: 0;">
								...
								added a course material to group"${groupName}".<#elseif (materialCount?number >1)> 
								added ${materialCount} course materials to group "${groupName}". </#if>
							</p>
							</p>
						</td>
					</tr>
									...
									<td rowspan="4" valign="top" style="padding-left: 15px;">
										...
										<p style="margin: 15px 0 0 0px; font-weight: bold;">
											<a href="${shareMaterialUrl!''}" target="_blank"
												style="height: 26px; padding: 0 20px; margin: 0; margin-right: 10px; line-height: 26px; color: #fff; text-decoration: none; background: #55b1f5; border: 1px solid #49a0e0; display: inline-block;">view material</a>
											<a href="${materialUrl!''}" target="_blank"
												style="height: 26px; padding: 0 20px; margin: 0; margin-right: 10px; line-height: 26px; color: #666666; text-decoration: none; background: #ffffff; border: 1px solid #c9cdd1; display: inline-block;">all materials</a>
										</p>
									</td>
								</tr>
							</table>
