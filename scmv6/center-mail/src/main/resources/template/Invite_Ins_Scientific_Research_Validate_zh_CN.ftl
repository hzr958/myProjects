        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Helvetica, 'Microsoft YaHei'; font-size:14px; color:#333333;">
           <tr>
            <td style="font-size:14px; font-weight:bold; line-height:150%;">
               <p style="margin:0; padding:0;"><span >${psnName!''}</span>， 您好，</p>
            </td>
          </tr>
          <tr>
            <td height="15">&nbsp;</td>
            ...
            <td>
                <table border="0" cellspacing="0" cellpadding="0" style=" width:100%; font-family:Arial, Helvetica, 'Microsoft YaHei'; font-size:14px; color:#333333; background:#fff; padding:20px; border:1px solid #eaeaea; line-height:150%;">
                  <tr>
                    ...
                    <p style=" margin:0; padding:0; margin-left:10px;">自科基金申报截止时间就快到了，想要检查申请书中的人员、单位和成果信息是否规范吗？</p>
                  	<p style=" margin:0; padding:0; margin-left:10px;">贵单位可为申报人订购“<span style="color:#55b1f5;">科研验证</span>”服务 ，在线验证申请书PDF，减少申请书填写不规范的问题，从而提高申请书审查通过率。
                    <p style=" margin:0; padding:0; height:20px; width: 100%;"></p>
                    <p style=" margin:0; padding:0; margin-left:10px;">如贵单位有意向订购，请联系 0755-26551963 或 400-161-6289</p>
                    </td>
                  </tr>
                </table>
            </td>
         ...
         <tr>
            <td width="560" valign="bottom"  style=" height:50px; font-size:14px; font-weight:bold; display: block;width: 560px;  text-align:center; text-decoration:none;  outline: none; ">
            	<a href="${validateUrl!'#'}"   target="_blank" style="width:560px; height:26px; text-align:center; margin:0; margin-right:10px; line-height:26px; color:#fff; text-decoration:none; background:#55b1f5; border:1px solid #49a0e0; border-bottom:#55b1f5!important; outline: none;  display:inline-table; ">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;了解详情（请在PC端访问）&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
			</td>
          </tr>
        </table>
	</td>
