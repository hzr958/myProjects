...
<head>
<meta charset="utf-8">
<title>${commentedPsnName}评论了你的论文:${pubTitle}</title>
</head>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Helvetica, 'Microsoft YaHei'; font-size:14px; color:#333333;">
          <tr>
            <td style="font-size:14px; font-weight:bold; line-height:150%;">
                <p style="margin:0; padding:0;">${psnName!''}，<span ><a href="${commentedPsnUrl!''}"  target="_blank"  style=" color:#55b1f5;text-decoration:none; ">${commentedPsnName}</a></span>评论了你的论文。</p>
            </td>
          </tr>
          <tr>
            <td height="15">&nbsp;</td>
          ...
          <tr>
            <td valign="bottom" style=" height:30px; font-size:14px; text-align:center; color:#999999;font-style:italic;">分享与下载成果，提高论文引用</td>
          </tr>
        </table>
	</td>
  </tr>
