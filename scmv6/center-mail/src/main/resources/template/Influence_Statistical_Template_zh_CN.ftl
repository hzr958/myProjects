    ...
    <td style="padding:30px;">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Helvetica, 'Microsoft YaHei'; font-size:12px; color:#333333;">
          <tr>
            ...
            <a href="${viewDetail!''}"  target="_blank" style="  width:300px; height:30px; text-align:center; margin:0; line-height:30px; color:#fff; text-decoration:none; background:#55b1f5; border:1px solid #49a0e0; display:inline-block;">查看我的影响力</a>	
            </td>
          </tr>
          <tr>
            <td colspan="2">
                <table border="0" cellspacing="0" cellpadding="0" style=" width:100%; font-size:14px; color:#333333; background:#fff; padding:20px; border:1px solid #eaeaea; line-height:150%;">
                  <tr>
                    <td>
                    	<a href="${viewDetail!''}"   target="_blank" style=" border:none; padding:0; margin:0; margin-right:20px; float:left;"><img src="http://www.scholarmate.com/resscmwebsns/images_v5/fulltextImg/scm_pdf.jpg" width="66" height="78"  style="border:1px solid #e2e2e2;"></a>
                        <font style=" font-size:30px; color:#55b1f5; height:40px; line-height:40px; font-family:Arial, Helvetica, '宋体'; padding:0; margin:20px 10px 0 0; float:left;">${titleCount!''}</font>
                        <font style=" height:30px; line-height:30px; font-size:18px; color:#333333; font-family:Arial, Helvetica, '宋体'; padding:0; margin:0; margin-top:25px; float:left;">${titlesName!''}</font>
                        <a href="${viewDetail!''}"  target="_blank" style=" width:75px; height:26px; padding:0; display:inline-block; text-align:center; margin:0; margin-top:26px; line-height:26px; color:#666666; text-decoration:none; background:#ffffff; border:1px solid #c9cdd1; float:right;">查看</a>
                    </td>
                  </tr>
                </table>
            </td>
            	...
            	<table border="0" cellspacing="0" cellpadding="0" style=" width:100%; font-family:Arial, Helvetica,  'Microsoft YaHei'; font-size:12px; color:#333333; background:#fff; padding:10px 20px; border:1px solid #eaeaea; line-height:150%;">
                	<tr>
                    	...
                    	<tr>
                            ...
                            <td width="30%" height="40" align="center" style="  font-size:14px; color:#999999; border-bottom:1px solid #eaeaea;">全部</td>
                            <td width="30%" height="40" align="center" style="  font-size:14px; color:#999999; border-bottom:1px solid #eaeaea;">本周</td>
                        </tr>
                        <tr>
                        	<th height="40" align="left" style=" font-size:14px; color:#999999; border-bottom:1px solid #eaeaea; text-indent:1em;">论文</th>
                        ...
                        <tr>
                        	<th height="40" align="left" style=" font-size:14px; color:#999999; border-bottom:1px solid #eaeaea; text-indent:1em;">引用</th>
                            <td height="40" align="center" style=" font-size:18px; color:#55b1f5; border-bottom:1px solid #eaeaea;">${citedCount?default(0)}</td>
                            <td height="40" align="center" style=" font-size:18px; color:#55b1f5; border-bottom:1px solid #eaeaea;">${citedMonth?default(0)}</td>
                        </tr>
                        <tr>
                        	<th height="40" align="left" style="  font-size:14px; color:#999999; border-bottom:1px solid #eaeaea; text-indent:1em;">社交<span style="color:#999999; font-size:12px; font-weight:normal; font-style:italic;"> (赞、分享)</span></th>
                        ...
                        <tr>
                        	<th height="40" align="left" style="  font-size:14px; color:#999999; border-bottom:1px solid #eaeaea; text-indent:1em;">下载</th>
                        ...
                        <tr>
                        	<th height="40" align="left" style="  font-size:14px; color:#999999; border-bottom:1px solid #eaeaea; text-indent:1em;">阅读</th>
                        ...
                        <tr>
                        	<th height="40" align="left" style=" font-size:14px; color:#999999; text-indent:1em;">H-Index <span style="color:#999999; font-size:12px; font-weight:normal; font-style:italic;">(个人影响力)</span></th>
          ...
          <tr>
            <td width="370" align="left" valign="middle"><img src="http://www.scholarmate.com/resscmwebsns/images_v5/process.png"></td>
            <td width="190" align="center" valign="middle" style=" font-size:14px; text-align:center; color:#999999; line-height:200%;"><a href="${addPub!''}"   target="_blank" style="  width:188px; height:30px; text-align:center; margin:0; line-height:30px; color:#fff; font-weight:bold; text-decoration:none; background:#55b1f5; border:1px solid #49a0e0; display:inline-block;">上传我的论文</a>
            <p style="padding:0; margin:0; font-style:italic;">上传论文，提高引用</p>
            </td>
          </tr>
        </table>
	</td>
