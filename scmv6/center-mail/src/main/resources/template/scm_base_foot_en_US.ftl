  ...
  <tr >
	<td align="center" valign="bottom" style="color:#999999; font-size:12px; line-height:150%;">
	      Like us @ <a href="http://www.facebook.com/scholarmate1"  target="_blank" style="color:#55b1f5; text-decoration:none;">facebook.com/scholarmate1</a>; follow us @ <a href="http://twitter.com/ScholarMate1" target="_blank" style="color:#55b1f5; text-decoration:none;">twitter.com/ScholarMate1</a> and <a href="http://plus.google.com/+Scholarmate" target="_blank" style="color:#55b1f5; text-decoration:none;">plus.google.com/+Scholarmate</a>.<br />
			...
			If you don't want to receive these emails from ScholarMate in the future, you can <a href="${unsubscribeUrl!'#'}" target="_blank;" style="color:#55b1f5;">unsubscribe</a> here.
	        If you cannot view this email properly, please<a href="${viewMailPath!''}${viewMailUrl}"  target="_blank" style="color:#55b1f5; text-decoration:none;"> click here.</a>
	</td>
  </tr>
</table>