        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Helvetica, 'Microsoft YaHei'; font-size:14px; color:#333333;">
          <tr>
            <td style="font-size:14px; font-weight:bold; line-height:150%;">
                <p style="margin:0; padding:0;">${psnName!''}，<span ><a href="${frdUrl!'#'}"  target="_blank"  style=" color:#55b1f5;text-decoration:none; ">${frdName!''}</a></span><#if (frdTitlo?exists)>（<a href="${frdUrl!'#'}"  target="_blank"  style="text-decoration:none; color:#55b1f5; font-size:14px;">${frdTitlo!''}</a>）</#if> uploaded full-text for you.</p>
            </td>
          </tr>
          <tr>
            <td height="15">&nbsp;</td>
                ...
                <table border="0" cellspacing="0" cellpadding="0" style=" width:100%; font-family:Arial, Helvetica, 'Microsoft YaHei'; font-size:14px; color:#333333; background:#fff; padding:20px; border:1px solid #eaeaea; line-height:150%;">
                  <tr  align="left">
                    ...
                    <td align="left" style="width:80%;">
                      <p style=" margin:0; padding:0; margin-left:0px;font-weight:bold;"><a  href="${pubsUrl!'#'}" target="_blank" style="text-decoration:none;color:#333333;">${pubTitle!''}</a></p>
                      ...
                      <p style=" margin:15px 0 0 0px;font-weight:bold;">
                        <a href="${fulltextUrl!pubsUrl}"  target="_blank" style=" height:26px; padding:0 20px; margin:0; margin-right:10px; line-height:26px; color:#fff; text-decoration:none; background:#55b1f5; border:1px solid #49a0e0; display:inline-block;">Download Full-text</a>
                      </p>
                    </td>
                  </tr>
