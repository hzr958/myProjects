...
<head>
<meta charset="utf-8">
<title>Scholarmate -joined the group</title>
</head>
<body>
  ...
  <tr>
    <td style="padding:30px;">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Helvetica, 'Microsoft YaHei'; font-size:14px; color:#333333;">
            ...
            <td>
                <table border="0" cellspacing="0" cellpadding="0" style=" width:100%; font-family:Arial, Helvetica, 'Microsoft YaHei'; font-size:14px; color:#333333; background:#fff; padding:20px; border:1px solid #eaeaea; line-height:150%;">
                  <tr>
                    ...
                    <p style=" margin:0; padding:0; margin-left:40px;font-weight:bold;">${adminPsnName}, <a href="${viewPsnUrl}" target="_blank"  style="font-weight:bold; color:#426cad; text-decoration:none;">${viewName}</a> joined the group <a href="${viewGroupUrl}"  target="_blank" style="font-weight:bold; color:#426cad; text-decoration:none;">${groupName}</a>.</p>
                    <p style=" margin:30px 0 0 40px;font-weight:bold;">
                    <a href="${viewGroupUrl!''}"  target="_blank"  style=" height:26px; padding:0 20px; margin:0; margin-right:10px; line-height:26px; color:#fff; text-decoration:none; background:#55b1f5; border:1px solid #c9cdd1; display:inline-block;text-align:center">Enter Group</a>
                    </p>
                    </td>
                  </tr>
                </table>
          ...
          <tr>
            <td valign="bottom" style=" height:30px; font-size:14px; text-align:center; color:#999999; font-style:italic;">Expand the Group’s membership to improve its influence.</td>
          </tr>
        </table>
	</td>
  </tr>
