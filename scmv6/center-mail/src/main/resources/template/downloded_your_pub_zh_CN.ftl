        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Helvetica, 'Microsoft YaHei'; font-size:14px; color:#333333;">
          <tr>
            <td style="font-size:14px; font-weight:bold; line-height:150%;">
                <p style="margin:0; padding:0;">${psnName!''}，<span ><a href="${downlodedPsnUrl!''}"  target="_blank"  style=" color:#55b1f5;text-decoration:none; ">${downlodedPsnName}</a></span>下载了你的论文。</p>
            </td>
          </tr>
          <tr>
            <td height="15">&nbsp;</td>
                    ...
                    <a href="${pubDetailUrl!'#'}"  target="_blank" style="border:1px solid #e2e2e2; padding:0; margin:0; float:left; margin-right:10px; width: 66px; height: 78px;">
                     ...
                     <td  style="width: 85%;">
                        ...
                        <p style=" margin: 0px;font-weight:bold; display: block;">
                          <a href="${pubDetailUrl!''}"  target="_blank" style=" height:26px; padding:0 20px; margin:0; margin-right:10px; line-height:26px; color:#fff; text-decoration:none; background:#55b1f5; border:1px solid #49a0e0; display:inline-block;">查看论文</a>
