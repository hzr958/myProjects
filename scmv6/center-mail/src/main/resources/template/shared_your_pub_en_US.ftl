...
<head>
<meta charset="utf-8">
<title>${sharedPsnName} shared your publication:${pubTitle}</title>
</head>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Helvetica, 'Microsoft YaHei'; font-size:14px; color:#333333;">
          <tr>
            <td style="font-size:14px; font-weight:bold; line-height:150%;">
                <p style="margin:0; padding:0;">${psnName!''}，<span ><a href="${sharedPsnUrl!''}"  target="_blank"  style=" color:#55b1f5;text-decoration:none; ">${sharedPsnName}</a></span>  shared your publication.</p>
            </td>
          </tr>
          <tr>
            <td height="15">&nbsp;</td>
