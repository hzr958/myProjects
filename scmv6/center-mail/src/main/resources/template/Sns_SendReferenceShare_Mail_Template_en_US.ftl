...
<title>
	Scholarmate - ${keycode_sharePsnName} shared references
</title>
</head>
																...
																<table width="100%" border="0" cellspacing="0" cellpadding="5"
																	...
																	<tr>
																		<td align="left">
																			...
																			标题：  ${keycode_sharePsnName}共享给您了 ${keycode_shareRefCount}个文献 <br/>
																			内容：  ${keycode_sharePsnName}共享给您了${keycode_shareRefCount}个文献 ，请点击以下链接查看详细的文献信息：<br/>
																			${keycode_shareURL}
																			<div>
																		</td>
																	</tr>
