...
<table width="700" align="center" border="0" cellspacing="1" cellpadding="1" bgcolor="#bcbcbc" style="font-family:Arial, Helvetica, '宋体'; font-size:14px; color:#333333;">
  ...
  <tr>
    <td align="right" bgcolor="#f5f5f5" style="padding:10px 3px;"><strong>邮箱：</strong></td>
    <td align="left" bgcolor="#FFFFFF" style="padding:10px 3px;">${email!''}</td>
    <td align="right" bgcolor="#f5f5f5" style="padding:10px 3px;"><strong>类别：</strong></td>
    <td align="left" bgcolor="#FFFFFF" style="padding:10px 3px;">${type!''}</td>
  </tr>
  <tr>
