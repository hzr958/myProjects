  ...
  <tr>
    <td style="padding:30px;">
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Helvetica, 'Microsoft YaHei'; font-size:14px; color:#333333;">
            ...
            <td>
                <table border="0" cellspacing="0" cellpadding="0" style=" width:100%; font-family:Arial, Helvetica, 'Microsoft YaHei'; font-size:14px; color:#333333; background:#fff; padding:20px; border:1px solid #eaeaea; line-height:150%;">
                  <tr>
                    ...
                    <p style=" margin:0; padding:0; margin-left:40px;font-weight:bold;">${adminPsnName}，<a href="${viewInvitePsnUrl}" target="_blank"  style="font-weight:bold; color:#426cad; text-decoration:none;">${psnName}</a>申请加入<a href="${viewUrl}" target="_blank" style="font-weight:bold; color:#426cad; text-decoration:none;">${groupName}</a>群组。</p>
                    <p style=" margin:30px 0 0 40px;font-weight:bold;">
                    <a href="${operateUrl!''}"  target="_blank"  style=" height:26px; padding:0 20px; margin:0; margin-right:10px; line-height:26px; color:#fff; text-decoration:none; background:#55b1f5; border:1px solid #c9cdd1; display:inline-block;text-align:center">批准加入</a>
                    </p>
                    </td>
                  </tr>
                </table>
          ...
          <tr>
            <td valign="bottom" style=" height:30px; font-size:14px; text-align:center; color:#999999; font-style:italic;">扩大群组成员社交网络，提升影响力。</td>
          </tr>
        </table>
	</td>
  </tr>
