					...
					<tr>
						<td style="font-size: 14px; font-weight: bold; line-height: 150%;">
							<p style="margin: 0; padding: 0;">
								...
								在群组“${groupName}”添加了1个文件。 <#elseif (fileCount?number >1)>
								在群组“${groupName}”添加了${fileCount}个文件。 </#if>
							</p>
						</td>
					</tr>
					<tr>
									...
									<td rowspan="4" valign="top" style="padding-left:15px;">
										...
										<p style="margin: 15px 0 0 0px; font-weight: bold;">
											<a href="${shareFileUrl!''}" target="_blank"
												style="height: 26px; padding: 0 20px; margin: 0; margin-right: 10px; line-height: 26px; color: #fff; text-decoration: none; background: #55b1f5; border: 1px solid #49a0e0; display: inline-block;">查看文件</a>
											<a href="${fileUrl!''}" target="_blank"
												style="height: 26px; padding: 0 20px; margin: 0; margin-right: 10px; line-height: 26px; color: #666666; text-decoration: none; background: #ffffff; border: 1px solid #c9cdd1; display: inline-block;">全部文件</a>
										</p>
									</td>
								</tr>
							</table>
