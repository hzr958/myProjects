          ...
          <tr>
            <td>
                <table border="0" cellspacing="0" cellpadding="0" style=" width:100%; font-family:Arial, Helvetica, 'Microsoft YaHei'; font-size:14px; color:#333333; background:#fff; padding:20px; border:1px solid #eaeaea; line-height:150%;">
                 <tr>
                    <td rowspan="4" valign="top"><a href="${pubDetail.pdwhPubIndexUrl!'#'}"  target="_blank" style="border:none; padding:0; margin:0; float:left; margin-right:20px;"><img src="${pubDetail.fulltextImg!'http://www.scholarmate.com/resmod/images_v5/images2016/file_img.jpg'}" width="66" height="78" style="border:1px solid #e2e2e2;"></a>
