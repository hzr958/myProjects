...
<head>
<meta charset="utf-8">
<title>${likedPsnName}赞了你的论文:${pubTitle}</title>
</head>
            ...
            <td>
                <table border="0" cellspacing="0" cellpadding="0" style=" width:100%; font-family:Arial, Helvetica, 'Microsoft YaHei'; font-size:14px; color:#333333; background:#fff; padding:20px; border:1px solid #eaeaea; line-height:150%;">
                  <tr  align="left" valign="top">
                    <td  valign="top" align="left" style="width: 20%; display: block;">
                    ...
                    <td  style="width: 85%;">
                      ...
                      <a href="${impactsUrl!''}"    target="_blank"  style=" height:26px; padding:0 20px; margin:0; margin-right:10px; line-height:26px; color:#fff; text-decoration:none; background:#55b1f5; border:1px solid #c9cdd1; display:inline-block; font-weight: normal;">查看我的影响力</a>
                      </p>
