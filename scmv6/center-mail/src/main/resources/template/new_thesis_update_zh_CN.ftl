        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Helvetica, 'Microsoft YaHei'; font-size:14px; color:#333333;">
          ...
          <tr>
            <td style="font-size:14px; font-weight:bold; line-height:150%;">
               <p style="margin:0; padding:0;"><span ><a href="${psnUrl!'#'}"   target="_blank" style="  border:none; padding:0; margin:0; float:left; margin-right:0px; text-decoration: none; color:#55b1f5;">${psnName!''}</a></span>，你有${pubSum!''}篇新成果。</p>
            </td>
          </tr>
            ...
            <td>
                <table border="0" cellspacing="0" cellpadding="0" style=" width:100%; font-family:Arial, Helvetica, 'Microsoft YaHei'; font-size:14px; color:#333333; background:#fff; padding:20px; border:1px solid #eaeaea; line-height:150%;">
                  <tr width="100%">
                    ...
                    <p style=" margin: 10px 0px 0px 0px; font-weight: bold; ">
         ...
         <tr width="100%" valign="center" style="text-align: center;">
            <td valign="bottom"  width="100%"  style=" height:50px; font-size:14px; font-weight:bold; width: 100%;  text-align:center;"><a href="${pubListUrl!'#'}"   target="_blank" style=" width:100%; height:26px; text-align:center; margin:0; margin-right:10px; line-height:26px; color:#fff; text-decoration:none; background:#55b1f5; border:1px solid #49a0e0; display:inline-block;">&nbsp;&nbsp;&nbsp;&nbsp;查看我的全部成果&nbsp;&nbsp;&nbsp;&nbsp;</a></td>
          </tr>
          </#if>
          <tr width="100%" valign="center" style="text-align: center;">
