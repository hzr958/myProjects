           ...
           <td>
                <table border="0" cellspacing="0" cellpadding="0" style=" width:100%; font-family:Arial, Helvetica, 'Microsoft YaHei'; font-size:14px; color:#333333; background:#fff; padding:20px; border:1px solid #eaeaea; line-height:150%; border-top:none; border-bottom: none;">
                  <tr>
                    ...
                    <a href="${grpReqUrl!'#'}"  target="_blank" style=" height:26px; display: inline-block;  padding:0px 20px; margin:0;line-height:26px; color:#666666; text-decoration:none; background:#ffffff; border:1px solid #c9cdd1;">&nbsp;&nbsp;&nbsp;&nbsp;忽略&nbsp;&nbsp;&nbsp;&nbsp;</a>
                    </td>
                  </tr>
                </table>
            </td>
           ...
           <td>
                <table border="0" cellspacing="0" cellpadding="0" style=" width:100%; font-family:Arial, Helvetica, 'Microsoft YaHei'; font-size:14px; color:#333333; background:#fff; padding:20px; border:1px solid #eaeaea; line-height:150%; border-top:none; border-bottom: none;">
                  <tr>
                    ...
                    <a href="${grpInviteUrl!'#'}"  target="_blank" style=" height:26px; display: inline-block;  padding:0px 20px; margin:0; line-height:26px; color:#666666; text-decoration:none; background:#ffffff; border:1px solid #c9cdd1; ">&nbsp;&nbsp;&nbsp;&nbsp;忽略&nbsp;&nbsp;&nbsp;&nbsp;</a>
                    </td>
                  </tr>
                </table>
            </td>
           ...
           <td>
                <table border="0" cellspacing="0" cellpadding="0" style=" width:100%; font-family:Arial, Helvetica, 'Microsoft YaHei'; font-size:14px; color:#333333; background:#fff; padding:20px; border:1px solid #eaeaea; line-height:150%;border-top:none; border-bottom: none;">
                  <tr>
                    ...
                    <a href="${insideLetterUrl!'#'}"  target="_blank" style=" height:26px; display: inline-block;  padding:0px 20px; margin:0; line-height:26px; color:#666666; text-decoration:none; background:#ffffff; border:1px solid #c9cdd1;">&nbsp;&nbsp;&nbsp;&nbsp;忽略&nbsp;&nbsp;&nbsp;&nbsp;</a>
                    </td>
                  </tr>
                </table>
            </td>
           ...
           <td>
                <table border="0" cellspacing="0" cellpadding="0" style=" width:100%; font-family:Arial, Helvetica, 'Microsoft YaHei'; font-size:14px; color:#333333; background:#fff; padding:20px; border:1px solid #eaeaea; line-height:150%; border-top:none; border-bottom: none;">
                  <tr>
                    ...
                    <a href="${centerMsgUrl!'#'}"  target="_blank" style="height:26px; display: inline-block;  padding:0px 20px; margin:0; line-height:26px; color:#666666; text-decoration:none; background:#ffffff; border:1px solid #c9cdd1;">&nbsp;&nbsp;&nbsp;&nbsp;忽略&nbsp;&nbsp;&nbsp;&nbsp;</a>
                    </td>
                  </tr>
                </table>
            </td>
