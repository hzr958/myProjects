                    ...
                    <#list fundList as fund> 
                      ...
                      <tr style="width: auto;">
                        ...
                        <td align="center" valign="middle">
                          <p style="width: 82px; height: 29px; border-radius: 3px; line-height: 29px; text-align: center; cursor: pointer;">
                         <#if (fund_index == 0)>
                          <a href="${fundDetail_0!'#'}" target="_blank" style="border: 1px solid #218aed; background-color: #218aed; width: 82px; text-align: center;text-decoration:none; color:#fff; font-size:12px; padding-right: 5px;  height: 29px;line-height:29px; 
                           display: block; width: 100%;">&nbsp;&nbsp;&nbsp;&nbsp;立即查看&nbsp;&nbsp;&nbsp;&nbsp;</a></p>
                         </#if>
                          <#if (fund_index == 1)>
           ...
           <tr>
            ...
            <td align="center" valign="middle">
              <p style=" color: #fff;width: 407px; height: 40px; line-height: 40px; cursor: pointer;">
                <a href="${viewUrl}" target="_blank" style="border: 1px solid #2882d8;  background-color: #2882d8; text-decoration:none; color:#fff; font-size:16px; padding-right: 5px;height: 40px; line-height: 40px;  width: 407px; display:inline-block;">
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;查看所有关注的基金机会&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>
              </p>
            </td>
         </tr>
