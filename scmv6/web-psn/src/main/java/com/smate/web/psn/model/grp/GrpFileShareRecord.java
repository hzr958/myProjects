package com.smate.web.psn.model.grp;
 ...
 */
@Entity
@Table(name = "V_GRP_FILE_SHARE_RECORD")
public class GrpFileShareRecord implements Serializable {

  private static final long serialVersionUID = -3479630081395088944L;

  @Id
  @Column(name = "ID")
  @SequenceGenerator(name = "SEQ_STORE", sequenceName = "SEQ_V_GRP_FILE_SHARE_RECORD", allocationSize = 1)
  ...
  public GrpFileShareRecord(Long id, Long sharerId, Long reveiverId, Long grpFileId, Date createDate, Date updateDate,
