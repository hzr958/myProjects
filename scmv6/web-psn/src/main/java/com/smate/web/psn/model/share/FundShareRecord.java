 ...
 */
@Entity
@Table(name = "V_FUND_SHARE_RECORD")
public class FundShareRecord implements Serializable {

  private static final long serialVersionUID = 1729360320955852911L;

  @Id
  @Column(name = "ID")
  @SequenceGenerator(name = "SEQ_STORE", sequenceName = "SEQ_V_FUND_SHARE_RECORD", allocationSize = 1)
  ...
  public FundShareRecord(Long id, Long sharerId, Long reveiverId, Long fundId, Date createDate, Date updateDate,
