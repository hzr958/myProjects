 ...
 */
@Entity
@Table(name = "V_GRP_FILE_SHARE_BASE")
public class GrpFileShareBase implements Serializable {
  ...
  public GrpFileShareBase(Long id, Long sharerId, Date createDate, Date updateDate, Integer status) {
    super();
    this.id = id;
    this.sharerId = sharerId;
    this.createDate = createDate;
