...
public class GrpFile implements Serializable {
  ...
  @Id
  @SequenceGenerator(name = "SEQ_GRP_FILE_STORE", sequenceName = "V_SEQ_GRP_FILE_ID", allocationSize = 1)
  ...
  public GrpFile(Long grpFileId, String fileName, String filePath, String fileType, String fileDesc, Date uploadDate,
      Long uploadPsnId, Long archiveFileId, Integer fileModuleType) {
    super();
