 ...
 */
@Entity
@Table(name = "V_FUND_SHARE_BASE")
public class FundShareBase implements Serializable {

  private static final long serialVersionUID = -4114209030452033003L;
  ...
  public FundShareBase(Long id, Long sharerId, Date createDate, Date updateDate, Integer status) {
    super();
    this.id = id;
    this.sharerId = sharerId;
    this.createDate = createDate;
