...
public class SysMergeUserInfoDao extends SnsHibernateDao<SysMergeUserInfo, Long> {
   ...
   */
  @SuppressWarnings("unchecked")
  public List<SysMergeUserInfo> getMergeUserInfoList(Long psnId, List<Long> delPsnIdList) {
    String hql = "from SysMergeUserInfo t where t.psnId=? and t.delPsnId in (:delPsnId) ";
    return super.createQuery(hql, psnId).setParameterList("delPsnId", delPsnIdList).list();
  }
}
