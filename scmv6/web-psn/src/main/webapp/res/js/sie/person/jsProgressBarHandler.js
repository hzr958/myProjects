 	...
 	// Default Options
		var defaultOptions = {
			...
			width		: 120,										// Width of the progressbar - don't forget to adjust your
                                        // image too!!!
			boxImage	: '/ressie/images/percentImage.png',			// boxImage : image around the progress
                                                          // bar
			barImage	: '/ressie/images/percentImage_back1.png',	// Image to use in the progressbar. Can
                                                            // be an array of images too.
   ...
   */
       ...
       */
				...
				initialize		: function(el, percentage, options) {
					...
					this.imgWidth		= this.options.width * 2;		// define the width of the image (twice the
                                                      // width of the progressbar)
					this.initialPos		= this.options.width * (-1);	// Initial postion of the background in
                                                          // the progressbar (0% is the middle of
                                                          // our image!)
					...
					if (this.options.barImage.constructor != Array) { 	// used to be (but doesn't work in
                                                              // Safari): if
       ...
       */
				...
				processQueueEntry	: function(targetPercentage) {
					...
					// define if we need to add/subtract something to the current percentage in order to reach
