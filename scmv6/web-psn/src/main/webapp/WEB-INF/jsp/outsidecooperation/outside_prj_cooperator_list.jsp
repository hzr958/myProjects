      ...
      <div class="psn-idx_medium">
        <div class="psn-idx__base-info">
          <div class="psn-idx__avatar_box">
            <div class="psn-idx__avatar_img" onclick="Pub.lookOtherPsnHome('${result.personDes3Id}');" style="cursor: pointer;">
          ...
          <div class="psn-idx__main_box">
            <div class="psn-idx__main">
              <div class="psn-idx__main_name"  style="cursor: pointer;" onclick="Pub.lookOtherPsnHome('${result.personDes3Id}');" title="${result.personName}">
                ${result.personName}
              </div>
