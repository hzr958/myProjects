...
<div class="module-card__box">
  <div class="module-card__header">
    ...
    <button class="button_main button_icon button_light-grey operationBtn" onclick="javascript:showContactInfoBox();">
        ...
        <c:if test="${not empty tel || isMySelf}">
          <div class="form__sxn_row">
            <div class="input__box readonly icon-label">
              ...
              <div class="input__area" style="pointer-events: none;">
