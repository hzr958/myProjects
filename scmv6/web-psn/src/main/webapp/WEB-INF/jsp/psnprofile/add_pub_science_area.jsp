                  ...
                  <div class="nav-cascade__toggle-list">
                    <c:forEach items="${categoryMap[subKey] }" var="subLevel">
                      <c:if test="${!subLevel.added }">
                        <div class="nav-cascade__item" onclick="PubEdit.addScienceArea('${subLevel.categryId}')"
              ...
              <c:forEach items="${categoryList }" var="area" varStatus="status">
                <div class="main-list__item" areaid="${area.categryId }" style="padding: 0px 16px !important;">
                  ...
                  <div class="main-list__item_actions">
                    <a onclick="PubEdit.delScienceArea('${area.categryId }');"><i class="material-icons">close</i></a>
                  </div>
                </div>
              </c:forEach>
            </div>
...
<div class="dialogs__childbox_fixed">
  <div class="dialogs__footer">
    <button class="button_main button_primary-reverse" id="homepage_area_save_btn" onclick="PubEdit.saveScienceArea();">
      <s:text name='homepage.profile.btn.save' />
    </button>
    <button class="button_main button_primary-cancle" onclick="PubEdit.hideScienceAreaBox(this);">
