...
<div class="dialogs__box oldDiv setnormalZindex" style="width: 480px;" id="addPsnWorkBox" dialog-id="addPsnWorkBox" cover-event="hide">
  ...
  <div class="dialogs__childbox_fixed">
    <div class="dialogs__footer">
      <button class="button_main button_primary-reverse" onclick="saveWorkHistory('add',this);">
