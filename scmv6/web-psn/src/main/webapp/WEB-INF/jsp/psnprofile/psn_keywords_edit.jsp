...
<div class="dialogs__box" style="width: 520px;" id="psnKeyWordsBox" dialog-id="psnKeyWordsBox" cover-event="hide">
          ...
          <div class="chip-panel__box inline-style">
            <c:forEach items="${recommendKeywords}" var="recommendKeyword" varStatus="status">
              <div class="chip__box white-style recommendKeywordItem" id="recommendKeywords_${status.index }"
                ...
                onclick="javascript:addPsnKeywords('recommendKeywords_${status.index }', '${recommendKeyword }',$createGrpChipBox);">
                <div class="chip__avatar">
                  <!-- <img src="/img/avatar.jpg"> -->
                </div>
  ...
  <div class="dialogs__childbox_fixed">
    <div class="dialogs__footer">
      <button class="button_main button_primary-reverse" onclick="javascript: savePsnKeyWords(this);"
        id="homepage_keywords_save_btn">
        <s:text name='homepage.profile.btn.save' />
      </button>
      <button class="button_main button_primary-cancle" onclick="javascript:hidePsnKeyWordsBox(this);">
