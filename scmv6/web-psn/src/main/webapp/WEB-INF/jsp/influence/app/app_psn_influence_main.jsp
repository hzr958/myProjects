...
<body>
  <input id="des3PsnId" value="${des3PsnId }" type="hidden" />
  <div class="new-Influencefactor_container">
    <div class="new-Influencefactor_body influence_module" style="margin-top:28px;">
      <div class="new-Influencefactor_neck">
        <div class="new-Influencefactor_neck-item">
          <span class="new-Influencefactor_neck-item_content">赞/分享</span> <span
            class="new-Influencefactor_neck-item_cnt" id="influence_award_share_sum">0</span>
        </div>
        <div class="new-Influencefactor_neck-item">
      ...
      <div class="new-Influencefactor_body-item">
