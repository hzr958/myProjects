...
public class Inspg implements Serializable {
   ...
   * 
   */
  private static final long serialVersionUID = 7362714938219862399L;
  ...
  private Integer inspgType;// 1.高校 2.公司 3.期刊 4.联盟 0.其他
  private String inspgUrl; // 机构主页对外地址，用于pageurl
  private Integer status; // 1：有效，99:无效(删除)
  private Date createTime; // 创建时间
  private String logoUrl; // 机构主页logo(头像)
  private Integer attSum;// 关注数--Transient
  private Integer isFollow;// 是否关注字段 1.关注 2.未关注-Transient
  private Date viewTime; // 阅读时间-Transient
  ...
  public Inspg(Long id, String name, String logoUrl, Date createTime) {
    super();
    this.id = id;
    this.name = name;
    this.logoUrl = logoUrl;
  ...
  public Inspg(Long id, Long psnId) {
    super();
    this.id = id;
    this.psnId = psnId;
  }
