...
import com.smate.center.open.model.sie.publication.RolPsnInsPk;
...
public class RolPsnInsDao extends RolHibernateDao<RolPsnIns, RolPsnInsPk> {
   ...
   * @throws DaoException
   */
  public boolean findPsnIsIns(Long psnId, Long insId) throws Exception {
   ...
   * @throws DaoException
   */
  public RolPsnIns findPsnIns(Long psnId, Long insId) throws Exception {
   ...
   * @throws DaoException
   */
  public boolean isPsnInIns(Long psnId, Long insId) throws Exception {
