 ...
 */
@Entity
@Table(name = "NSFC_PUB_MEMBER")
public class NsfcPubMember implements Serializable {
  ...
  @Id
  @Column(name = "PM_ID")
  @SequenceGenerator(name = "SEQ_STORE", sequenceName = "SEQ_NSFC_PUB_MEMBER", allocationSize = 1)
