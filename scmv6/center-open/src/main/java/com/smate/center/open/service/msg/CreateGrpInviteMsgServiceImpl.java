...
public class CreateGrpInviteMsgServiceImpl extends CreateMsgBase {
  @Autowired
  ...
  public Map<String, Object> parameterVeify(Map<String, Object> paramet) throws Exception {
    ...
    Object grpIdObj = paramet.get(MsgConstants.MSG_RCMD_GRP_ID);
    if (grpIdObj == null || !NumberUtils.isNumber(grpIdObj.toString())) {
      result = super.errorMap(OpenMsgCodeConsts.SCM_720, paramet, "rcmdGrpId，不能为空，且为数字");
    }
    return result;
  }
  ...
  public void buildMsg(Map<String, Object> dateMap, Long senderId, String receiverIds) throws Exception {
    ...
    contentMap.put(MsgConstants.MSG_RCMD_GRP_ID, dateMap.get(MsgConstants.MSG_RCMD_GRP_ID));
    GrpBaseinfo grpBaseinfo =
        grpBaseInfoDao.get(NumberUtils.toLong(dateMap.get(MsgConstants.MSG_RCMD_GRP_ID).toString()));
    if (grpBaseinfo != null) {
  ...
  public void produceMsg(Map<String, Object> dateMap, Long senderId, Long receiverId) throws Exception {
    ...
    mr.setType(Integer.parseInt(MsgConstants.MSG_TYPE_ADD_GRP_INVITE));
