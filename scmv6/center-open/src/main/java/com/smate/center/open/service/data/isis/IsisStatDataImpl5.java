...
public class IsisStatDataImpl5 extends ThirdDataTypeBase {
  ...
  public Map<String, Object> doHandler(Map<String, Object> paramet) {
    try {
      ...
      List<Map<String, Object>> statData = nsfcStatService.getStatData5(dataMap);
      for (Map<String, Object> n : statData) {
        ...
        map.put("granttypeid", n.get("GRANTTYPEID"));
        map.put("granttypename", n.get("GRANTTYPENAME"));
        dataList.add(map);
      }
