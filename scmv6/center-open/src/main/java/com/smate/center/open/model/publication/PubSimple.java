...
public class PubSimple implements Serializable {
  ...
  // 互联互通获取成果
  public PubSimple(Long pubId, Integer status) {
    super();
    this.pubId = pubId;
    this.status = status;
  }
  ...
  // 互联互通获取成果
  public PubSimple(Long pubId, Date updateDate) {
    super();
    this.pubId = pubId;
  ...
  // 互联互通 接口 获取成果
  public PubSimple(Long pubId, Long ownerPsnId, Integer status) {
    super();
    this.pubId = pubId;
    this.status = status;
  ...
  // 互联互通 接口 获取成果
  public PubSimple(Long pubId, Long ownerPsnId, Integer status, Date updateDate) {
    super();
    this.pubId = pubId;
    this.status = status;
    this.ownerPsnId = ownerPsnId;
