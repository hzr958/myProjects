 ...
 * 
 */
public class IrisPaperPubXmlBuildServiceImpl implements IrisPubXmlBuildService {
  ...
  public String buildPubXml(Publication pub, String xmlData) {
    ...
    try {
      ...
      String confCategory = doc.getXmlNodeAttribute(PubXmlConstants.PUB_CONF_PAPER_XPATH, "paper_type");
      ConstDictionary constDic = this.constDictionaryManage.findConstByCategoryAndCode("pub_conf_type", confCategory);
      irisDoc.setNodeAttribute(IrisPubXmlConstants.PUBLICATION_XPATH, IrisPubXmlConstants.CONF_CATEGORY_ATTR,
          constDic != null ? constDic.getZhCnName() : "");

      String paperType = doc.getXmlNodeAttribute(PubXmlConstants.PUB_CONF_PAPER_XPATH, "conf_category");
      constDic = this.constDictionaryManage.findConstByCategoryAndCode("pub_conf_category", paperType);
      irisDoc.setNodeAttribute(IrisPubXmlConstants.PUBLICATION_XPATH, IrisPubXmlConstants.PAPER_TYPE_ATTR,
          constDic != null ? constDic.getZhCnName() : "");
      ...
      irisDoc.setNodeAttribute(IrisPubXmlConstants.PUBLICATION_XPATH, IrisPubXmlConstants.LIST_INFO_ATTR,
          publicationListService.convertPubListToString(publicationListService.getPublicationList(pub.getPubId())));
