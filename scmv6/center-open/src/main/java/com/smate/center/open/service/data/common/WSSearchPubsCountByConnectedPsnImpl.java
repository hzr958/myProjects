...
/**
 * 返回该人员个人成果库中所有的成果记录总数 2cdfac1a
 * 
 * @author lxz
 *
 */
public class WSSearchPubsCountByConnectedPsnImpl extends ThirdDataTypeBase {
  ...
  public Map<String, Object> doVerify(Map<String, Object> paramet) {
    ...
    if (paramet.get(OpenConsts.MAP_DATA) == null && StringUtils.isEmpty(paramet.get(OpenConsts.MAP_DATA).toString())) {
      logger.error("返回该人员个人成果库中所有的成果记录总数数据不能为空,服务码:2cdfac1a");
      temp = super.errorMap(OpenMsgCodeConsts.SCM_209, paramet, "返回该人员个人成果库中所有的成果记录总数数据不能为空,服务码:2cdfac1a");
      return temp;
    } else {
  ...
  public Map<String, Object> doHandler(Map<String, Object> paramet) {
    ...
    try {
      ...
      String result =
          pubInfoService.searchPubsCountByConnectedPsn(psnGuidID, psnID, keywords, excludedPubIDS, putTypes);
      Map<String, Object> temp = new HashMap<String, Object>();
      temp.put(OpenConsts.RESULT_COUNT, result);
      dataList.add(temp);
    } catch (Exception e) {
      e.printStackTrace();
