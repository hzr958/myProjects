 ...
 * 
 */
public class IrisAwardPubXmlBuildServiceImpl implements IrisPubXmlBuildService {
  ...
  public String buildPubXml(Publication pub, String xmlData) {
    ...
    try {
      ...
      irisDoc.setNodeAttribute(IrisPubXmlConstants.PUBLICATION_XPATH, IrisPubXmlConstants.ISSUE_INS_NAME_ATTR,
          doc.getXmlNodeAttribute(PubXmlConstants.PUB_AWARD_XPATH, "issue_ins_name"));
      irisDoc.setNodeAttribute(IrisPubXmlConstants.PUBLICATION_XPATH, IrisPubXmlConstants.AWARD_CATEGORY_ATTR,
          doc.getXmlNodeAttribute(PubXmlConstants.PUB_AWARD_XPATH, "award_category"));
      irisDoc.setNodeAttribute(IrisPubXmlConstants.PUBLICATION_XPATH, IrisPubXmlConstants.AWARD_GRADE_ATTR,
          doc.getXmlNodeAttribute(PubXmlConstants.PUB_AWARD_XPATH, "award_grade"));
