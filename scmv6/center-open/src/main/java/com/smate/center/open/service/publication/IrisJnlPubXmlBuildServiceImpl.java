 ...
 * 
 */
public class IrisJnlPubXmlBuildServiceImpl implements IrisPubXmlBuildService {
  ...
  public String buildPubXml(Publication pub, String xmlData) {
    ...
    try {
      ...
      irisDoc.setNodeAttribute(IrisPubXmlConstants.PUBLICATION_XPATH, IrisPubXmlConstants.ISSN_ATTR,
          doc.getXmlNodeAttribute(PubXmlConstants.PUBLICATION_XPATH, "issn"));
      ...
      irisDoc.setNodeAttribute(IrisPubXmlConstants.PUBLICATION_XPATH, IrisPubXmlConstants.IMPACT_FACTORS_ATTR,
          publicationService.getPub(pub.getPubId()).getImpactFactors());
