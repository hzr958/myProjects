package com.smate.center.open.model.profile.psnwork;
...
public class PsnWorkHistoryInsInfo implements Serializable {
  ...
  public PsnWorkHistoryInsInfo(String departmentZh, String departmentEn, String positionZh, String positionEn) {
    this.departmentZh = departmentZh;
    this.departmentEn = departmentEn;
    this.positionZh = positionZh;
    this.positionEn = positionEn;
