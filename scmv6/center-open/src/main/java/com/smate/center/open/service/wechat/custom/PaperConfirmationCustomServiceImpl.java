 ...
 *
 */
public class PaperConfirmationCustomServiceImpl extends AbstractCustom {
  ...
  public Map<String, Object> buildMessage(Map<String, Object> paramMap) throws OpenException {
    try {
      ...
      sb.append("通过以下方式打开论文认领：");
      sb.append("\n\n<a href=\"");
      sb.append(viewUrl);
      sb.append("?openid=");
      sb.append(touser);
      sb.append("\">点击这里，立即打开论文认领</a>");
      ...
      logger.error("Paper Confirmation:build message error", e);
