...
public class ConstRegionDao extends SnsHibernateDao<ConstRegion, Long> {
  ...
  public List<ConstRegion> findRegionBySuperRegionId(Long id, Locale locale) throws Exception {
   ...
   */
  @SuppressWarnings("unchecked")
  public List<ConstRegion> getAllCountryAndRegion(Locale locale) throws Exception {
   ...
   * @throws DaoException
   */
  public List<ConstRegion> getAllProvince(Locale locale) throws Exception {
    //
    String hql =
   ...
   * @throws DaoException
   */
  public List<ConstRegion> getAllCity(Locale locale) throws Exception {
    String hql =
  ...
  public List<ConstRegion> findRegionData(Long superRegionId) throws Exception {
   ...
   * @throws DaoException
   */
  public ConstRegion getConstRegionById(Long id) throws Exception {

    return super.findUniqueBy("id", id);
  }

  public ConstRegion getRegionId(String regionCode) throws Exception {
   ...
   */
  @SuppressWarnings("unchecked")
  public ConstRegion getConstRegionByName(String name) throws Exception {
   ...
   */
  @SuppressWarnings("unchecked")
  public List<ConstRegion> getNoCacheConstRegion() throws Exception {
   ...
   */
  @SuppressWarnings("unchecked")
  public List<ConstRegion> getAcCountryRegion(String startWith, int size) throws Exception {
  ...
  public List<ConstRegion> getAllCNRegion() throws Exception {
    String hql = "from ConstRegion where countryCode = 'CN'";
    Query query = createQuery(hql);
    query.setCacheable(true);
    List<ConstRegion> list = query.list();
    return list;
  ...
  @SuppressWarnings("unchecked")
  public List<Long> getAllProvinceId() {
    String hql = "select id from ConstRegion t where t.superRegionId = 156";
    return super.createQuery(hql).list();

  }

  @SuppressWarnings("unchecked")
  public List<Long> getReginIdList(List<Long> provinceIdList) {
    String hql = "select id from ConstRegion t where t.superRegionId  in ( :provinceIds)";
    return super.createQuery(hql).setParameterList("provinceIds", provinceIdList).list();
  }

  @SuppressWarnings("unchecked")
  public List<Long> getReginIds(Long provinceId) {
    String hql = "select id from ConstRegion t where t.superRegionId = :provinceId";
    return super.createQuery(hql).setParameter("provinceId", provinceId).list();
  }
}
