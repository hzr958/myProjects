...
public class NsfcReschPrjRptPub implements Serializable {
  ...
  public NsfcReschPrjRptPub(NsfcReschPrjRptPubId id, Integer version, Integer pubType, Integer pubYear, Integer defType,
      String authors, String title, String source, Integer isTag, Integer isOpen, String needSyc, String listInfo,
      Integer seqNo, Integer nodeId, Long pubOwnerPsnId, Integer matched, String listInfoSource, Integer citedTimes,
