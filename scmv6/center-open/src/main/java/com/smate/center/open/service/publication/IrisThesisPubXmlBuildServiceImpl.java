 ...
 * 
 */
public class IrisThesisPubXmlBuildServiceImpl implements IrisPubXmlBuildService {
  ...
  public String buildPubXml(Publication pub, String xmlData) {
    ...
    try {
      ...
      irisDoc.setNodeAttribute(IrisPubXmlConstants.PUBLICATION_XPATH, IrisPubXmlConstants.PROGRAMME_ATTR,
          doc.getXmlNodeAttribute(PubXmlConstants.PUB_THESIS_XPATH, "zh_programme_name"));
      irisDoc.setNodeAttribute(IrisPubXmlConstants.PUBLICATION_XPATH, IrisPubXmlConstants.ISSUE_ORG_ATTR,
          doc.getXmlNodeAttribute(PubXmlConstants.PUB_THESIS_XPATH, "issue_org"));
      irisDoc.setNodeAttribute(IrisPubXmlConstants.PUBLICATION_XPATH, IrisPubXmlConstants.DEPARTMENT_ATTR,
          doc.getXmlNodeAttribute(PubXmlConstants.PUB_THESIS_XPATH, "department"));
