...
public class V8pubQueryPubConst {
  ...
  // 不分页 不分状态
  public static final String QUERY_PUB_UNCONFIRM_LIST_IGNORE_STATUS = "pubConfirmListIgnoreStatus";// 未认领的成果列表
   ...
   * 查看单个成果的详情的服务
   */
  public static final String QUERY_OPEN_SNS_PUB = "openSnsPub"; // 通过id查询个人库的基本信息
  public static final String QUERY_SIE_OPEN_SNS_PUB = "sieOpenSnsPub"; // 通过id查询个人库的基本信息
  public static final String OPEN_GRP_PUB = "openGrpPub"; // open系统群组成果基本信息
  public static final String OPEN_PDWH_PUB = "openPdwhPub"; // 基准库成果详情
  public static final String PDWH_PUBBY_PUB_CONFIRM_ID = "pdwhPubByPubConfirmId"; // 基准库成果详情

  /**
   * 成果认领
   */
  public static final String PUB_CONFIRM = "/data/pub/affirmconfirm";

  public static final String GRP_PUB_CONFIRM = "/groupweb/grppub/ajaxacceptpubrcmd";
  ...
  public final static String ISIS_PUB_LIST = "IsisPubList"; // isis个人成果列表

  public final static String ISIS_PUB_ASSIGN_LOG_LIST = "IsisPubAssignLogList"; // isis个人推荐成果列表

  public final static String ISIS_GRP_PUB_LIST = "IsisGrpPubList"; // isis群组成果列表

  public final static String ISIS_GRP_RCMD_PUB_LIST = "IsisGrpRcmdPubList"; // isis群组推荐成果列表

  public final static String OPEN_VERIFY_PDWH_PUB = "openVerifyPdwhPub"; // 成果验证 需要的详情
