...
public class GrpPubIndexUrl implements Serializable {
  ...
  public GrpPubIndexUrl() {
    super();
  }

  public GrpPubIndexUrl(Long id, Long grpId, Long pubId, String pubIndexUrl, Long psnId, Date updateDate) {
    super();
    Id = id;
    this.grpId = grpId;
    this.pubId = pubId;
