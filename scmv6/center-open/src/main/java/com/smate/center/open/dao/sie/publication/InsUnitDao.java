...
public class InsUnitDao extends RolHibernateDao<InsUnit, Long> {
   ...
   * @throws Exception
   */
  public InsUnit getInsUnitName(Long insId, Long unitId) throws Exception {
  ...
  public List<Long> getIdsByIns(Long insId) throws Exception {
   ...
   * @throws Exception
   */
  public InsUnit getInsUnit(String unitName, Long insId) throws Exception {
   ...
   * @throws Exception
   */
  public InsUnit getInsUnit(String unitName, Long superInsUnitId, Long insId) throws Exception {
    return findUnique("from InsUnit where (zhName=? or enName = ?)  and insId=?", unitName, unitName, insId);
  }
   ...
   * @throws Exception
   */
  public Long findUnitSuperId(Long unitId) throws Exception {
    String hql = "select superInsUnitId from InsUnit where id =?";
    return findUnique(hql, unitId);
  }

  @SuppressWarnings("unchecked")
  public List<Long> findSubUnitId(Long unitId) throws Exception {
   ...
   */
  @SuppressWarnings("unchecked")
  public List<Long> findUnitById(Long unitId) throws Exception {
   ...
   * @throws Exception
   */
  public int updateUnit(Long unitId, Long insId, Long toUnitId) throws Exception {
    String hql =
   ...
   * @throws Exception
   */
  public int updateUnitId(Long unitId, Long insId, Long toUnitId) throws Exception {
   ...
   */
  @SuppressWarnings("unchecked")
  public List<InsUnit> findByNameLike(String name, Long insId, int maxSize) throws Exception {
   ...
   */
  @SuppressWarnings("unchecked")
  public List<InsUnit> findByNameLikeSuper(String name, Long insId, int maxSize) throws Exception {
    name = name.toLowerCase();
    String hql =
   ...
   */
  @SuppressWarnings("unchecked")
  public List<InsUnit> findAcInsUnit(String startWith, Long insId, Long superUnitId, int maxSize) throws Exception {
   ...
   */
  @SuppressWarnings("unchecked")
  public List<InsUnit> getInsUnitBySuperId(Long superId) throws Exception {
   ...
   */
  @SuppressWarnings("unchecked")
  public List<InsUnit> getInsUnitWithSubByInsIdAndUnitId(Long insId, Long unitId) throws Exception {
   ...
   */
  @SuppressWarnings("unchecked")
  public List<InsUnit> getInsUnitWithSubByInsId(Long insId) throws Exception {
  ...
  @SuppressWarnings("unchecked")
  public InsUnit getUnitWithSub(Long insId, Long unitId) throws Exception {
   ...
   * @throws Exception
   */
  public InsUnit getInsUnitWithSubByUnitId(Long insId, Long unitId) throws Exception {
   ...
   */
  @SuppressWarnings("unchecked")
  public List<InsUnit> getSuperUnitByInsId(Long insId) throws Exception {
   ...
   */
  @SuppressWarnings("unchecked")
  public List<InsUnit> getSuperUnitByInsId(Long insId, int maxSize) throws Exception {
   ...
   * @throws Exception
   */
  public InsUnit getInsUnitRolById(Long id) throws Exception {
   ...
   * @throws Exception
   */
  public int deleteUnit(Long unitId) throws Exception {
   ...
   * @throws Exception
   */
  public int deleteMergeUnit(Long unitId) throws Exception {
    String hql = "delete from InsUnit where id =? or superInsUnitId=?";
    int count = createQuery(hql, unitId, unitId).executeUpdate();
    return count;
  }
   ...
   * @throws Exception
   */
  public String getUnitName(Long unitId, Long insId, Locale locale) throws Exception {
    if (unitId == null)
      return null;
   ...
   * @throws Exception
   */
  public String getUnitName(Long unitId, Locale locale) throws Exception {
    if (unitId == null)
      return null;
   ...
   * @throws Exception
   */
  public String getUnitEnName(Long unitId) throws Exception {
    if (unitId == null)
      return null;
   ...
   */
  @SuppressWarnings("unchecked")
  public Map<Long, String> getUnitName(Collection<Long> unitIds, Locale locale) throws Exception {
  ...
  public List<String> findNameByInsId(Long insId) throws Exception {
   ...
   * @throws Exception
   */
  public Long getSubUnitCountBySuperUnitId(Long superId) throws Exception {
   ...
   * @throws Exception
   */
  public Long getInsUnitCountByInsId(Long insId) throws Exception {
    String hql = "select count(iu.id) from InsUnit iu where iu.insId=?";
    return super.findUnique(hql, insId);
  }

  @SuppressWarnings("unchecked")
  public List<InsUnit> queryInsUnitBySuperId(Long superId, Long insId) throws Exception {
   ...
   * @return
   */
  public List<InsUnit> findAllInsUnit(Long insId, Long unitId) throws Exception {
   ...
   * @return
   */
  public List<InsUnit> findTopInsUnit(Long insId, Long unitId) throws Exception {
    String hql = "from InsUnit t where t.insId = :insId";
    Map<String, Object> params = new HashMap<String, Object>();
    params.put("insId", insId);
    if (unitId != null && unitId != 0l) {
