...
@Embeddable
public class NsfcInsRoleId implements Serializable {
  ...
  public NsfcInsRoleId() {}

  public NsfcInsRoleId(long userId, long insId, long roleId) {
    this.userId = userId;
    this.insId = insId;
    this.roleId = roleId;
  }
  ...
  public boolean equals(Object other) {
    ...
    if ((other == null))
      return false;
    if (!(other instanceof InsRoleId))
      return false;
    InsRoleId castOther = (InsRoleId) other;
