...
<s:if test="page.totalPages>1 || page.totalCount>page.pageSize">
  <div class="web-Page">
    <input type="hidden" name="page.order" id="order" value="${page.order}" /> <input type="hidden" name="page.orderBy"
      ...
      value="${empty page.pageNo||page.pageNo<1?1:page.pageNo}" /> <input type="hidden" name="page.totalPages"
      id="totalPages" value="${empty page.totalPages||page.totalPages<1?0:page.totalPages}" />
