...
var title_watermark = '<s:text name="cooperator.label.watermark.title.tip2" />';
var abs_watermark = '<s:text name="cooperator.label.watermark.abs.tip2" />';
...
<body>
  <div id="content">
    <form id="mainForm" action="/scmmanagement/cooperatorCmd/detail" method="post">
