...
<script type="text/javascript">
  ...
  function loadOtherPage(pageNo) {
    ...
    if (searchKey != "") {
      fundThirdMaint.search(2);
    } else {
      fundThirdMaint.searchByLeft(this);
      return;
    }
  }
...
<body>
  <div class="box_nav3tab">
    ...
    <div class="nav4_div_hover">
      <ul>
        <li><a href="${ctx}/fund/third/main"><b class="left"></b><b class="middle">待审核基金机会</b><b class="right"></b></a></li>
      </ul>
    </div>
  </div>
  <input type="hidden" class="thickbox" id="thickbox_fundThird" />
  <div id="rol_main">
    <div id="Tab">
      <div class="Menubox">
        <ul>
          <li id="one1" onClick="setTabUrl('${ctx}/fund/third/main')" class="hover">待审核基金机会列表</li>
        </ul>
      </div>
        ...
        <div id="con_one_1" class="hover">
          ...
          <div class="right-wrap">
            <div class="mdown10">
              ...
              <span class="Fright"> <a onclick="fundThirdMaint.checkFund();" class="uiButton">审核</a>
              <a onclick="fundThirdMaint.rejectFund();" class="uiButton">删除</a>
              </span>
              <div class="clear"></div>
            </div>
            <div id="loading_tip">
