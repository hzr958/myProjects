...
<script type="text/javascript" src="${resmod}/js/echarts.min.js"></script>
<script type="text/javascript" src="${resmod}/js/linechart.js"></script>
<script type="text/javascript" src="${resmod}/js/piechart.js"></script>
...
$(document).ready(function(){
	...
	<s:iterator value="keywordsList">
	   ...
	   keywordStr = keywordStr+'${fn:replace(keyword, "\'", "\\\'")}; ';
	</s:iterator>
	$('#_keywords_div').val(keywordStr);
...
<body>
  ...
  <div id="content">
    <div class="peer">
      <div class="keyword_search mdown15">
        ...
        <div class="peer_table" id="peer_table">
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
              <td>&nbsp;</td>
              <td height="25" align="left"><a class="uiButton text14"
                onclick="CooperatorCmd.editTitleAndAbsForKwAnalysis();" style="padding: 4px 15px; course: pointer;"
                title="<s:text name='cooperator.btn.edit' />"><s:text name="cooperator.btn.edit" /></a></td>
            </tr>
          </table>
          <div class="t_line">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tbody>
                ...
                <tr>
                  <td align="right">&nbsp;</td>
                  <td height="35" align="left"><a onclick="CooperatorCmd.reloadPieChartEx();"
                    class="uiButton uiButtonConfirm text14" style="padding: 4px 15px; cursor: pointer;"
                    title="<s:text name='cooperator.btn.reanalysis' />"><s:text name="cooperator.btn.reanalysis" /></a>
                  </td>
                </tr>
                <tr>
              </tbody>
      ...
      <td align="left"><input id="_keywords_div" class="inp_text" style="width: 840px; color: rgb(0, 0, 0);"
        value="" type="text"></td>
      </tr>
    </div>
    <div class="Menubox">
      <ul>
        ...
        <li id="two2" class="hover" onclick="selectTab('pieChart');"><s:text name="cooperator.label.piechart" /></li>
        <li id="two3" onclick="selectTab('lineChart');"><s:text name="cooperator.label.linechart" /></li>
      </ul>
    </div>
    <div class="clear_h20"></div>
    <div>
      <%-- <h2 style="font-size:14px; margin-bottom:10px;"><i class="icon21 py-icon"></i>
             		<c:choose>
	           			    <c:when test="${urlType eq '/fund' }"><s:text name="cooperator.label.table.min.title1"/></c:when>
	           			    <c:otherwise><s:text name="cooperator.label.table.min.title2"/></c:otherwise>
	           		</c:choose>
              	  </h2> --%>
      <div id="con_one_tip">
      ...
      <div id="con_one_page">
        <%-- <%@ include file="/WEB-INF/keywords/keywordsChart_piechart.jsp"%> --%>
