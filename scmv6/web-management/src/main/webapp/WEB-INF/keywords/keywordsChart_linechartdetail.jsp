  ...
  <div id="content">
    ...
    <div class="Menubox">
      <ul>
        ...
        <li id="two2" onclick="CooperatorCmd.loadPieChart();"><s:text name="cooperator.label.piechart" /></li>
        <li id="two3" class="hover"><s:text name="cooperator.label.linechart" /></li>
      </ul>
    </div>
    ...
    <div>
      <h2 style="font-size: 14px; margin-bottom: 10px;">
        ...
        <c:choose>
          ...
          <c:otherwise>
            <s:text name="cooperator.label.table.min.title2" />
          </c:otherwise>
        </c:choose>
      </h2>
      <div id="con_one_tip">
