...
<script type="text/javascript">
	...
	patentMaintSearch = function(obj,mId) {
		$.ajax({
			url : "/scmmanagement/keywordsdistr/ajaxfrontierinfo",
			type : "post",
			dataType : "html",
			data : {
				"mId" : mId
	...
	patentMaintLatedLeftMenu = function() {
		$.ajax({
			url : "/scmmanagement/keywordsdistr/ajaxcategoryLeft",
			type : "post",
			data : {
				"id" : 1
			},
...
<body>
  <div id="content" style="display: flex; justify-content: center; align-items: center; margin_right: 32px;">
    ...
    <div id="main4" style="width: 800px; height: 600px; margin-top: 100px; margin-left: 16px;"></div>
  </div>
</body>
</html>