...
public class ThirdSourcesFund {
  ...
  // 页面上显示分开的附件地址
  @Transient
  private List<Map<String, String>> accessoryUrlView;

  public List<Map<String, String>> getAccessoryUrlView() {
    return accessoryUrlView;
  }

  public void setAccessoryUrlView(List<Map<String, String>> accessoryUrlView) {
    this.accessoryUrlView = accessoryUrlView;
  }
