...
public class InsReg implements Serializable {
   ...
   * 
   */
  private static final long serialVersionUID = 3542215153720889626L;
  // 注册单位ID
  ...
  @Column(name = "CONTACT_PS_CN")
  public String getContactPsCn() {
    return contactPsCn;
  }
  ...
  public void setContactPsCn(String contactPsCn) {
    this.contactPsCn = contactPsCn;
  }
