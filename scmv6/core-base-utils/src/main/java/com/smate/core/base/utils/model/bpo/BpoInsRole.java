...
public class BpoInsRole implements Serializable {

  /**
   * 
   */
  private static final long serialVersionUID = -6162735366481144101L;
  private BpoInsRoleId id;
  ...
  public BpoInsRole(long userId, long insId, long rolId) {
    super();
    this.id = new BpoInsRoleId(userId, insId, rolId);
  }

  public BpoInsRole(BpoInsRoleId id, String roleName) {
    super();
    this.id = id;
   ...
   */
  public void setId(BpoInsRoleId id) {
    this.id = id;
  }
