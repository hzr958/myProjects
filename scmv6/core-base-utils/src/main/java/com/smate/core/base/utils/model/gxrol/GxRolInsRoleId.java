 ...
 */
@Embeddable
public class GxRolInsRoleId implements java.io.Serializable {
  ...
  public GxRolInsRoleId() {}

  public GxRolInsRoleId(long userId, long insId, long roleId) {
    this.userId = userId;
    this.insId = insId;
    this.roleId = roleId;
  }
  ...
  public boolean equals(Object other) {
    ...
    if ((other == null))
      return false;
    if (!(other instanceof GxRolInsRoleId))
      return false;
    GxRolInsRoleId castOther = (GxRolInsRoleId) other;
