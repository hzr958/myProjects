 ...
 */
@Repository
public class InsRoleDao extends SnsHibernateDao<InsRole, InsRoleId> {
  ...
  public void removeRole(Long userId) {
    ...
    String hql = "delete from InsRole where id.userId = :userId";
    super.createQuery(hql).setParameter("userId", userId).executeUpdate();
  }
