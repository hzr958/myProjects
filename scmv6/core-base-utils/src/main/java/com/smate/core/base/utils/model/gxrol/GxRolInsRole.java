...
public class GxRolInsRole implements Serializable {

  /**
   * 
   */
  private static final long serialVersionUID = -6162735366481144101L;
  private GxRolInsRoleId id;
  ...
  public GxRolInsRole(long userId, long insId, long rolId) {
    super();
    this.id = new GxRolInsRoleId(userId, insId, rolId);
  }

  public GxRolInsRole(GxRolInsRoleId id, String roleName) {
    super();
    this.id = id;
   ...
   */
  public void setId(GxRolInsRoleId id) {
    this.id = id;
  }
