 ...
 */
@Embeddable
public class SieInsRoleId implements java.io.Serializable {
  ...
  public SieInsRoleId(long userId, long insId, long roleId) {
    this.userId = userId;
    this.insId = insId;
    this.roleId = roleId;
  }
  ...
  public boolean equals(Object other) {
    ...
    if ((other == null))
      return false;
    if (!(other instanceof SieInsRoleId))
      return false;
    SieInsRoleId castOther = (SieInsRoleId) other;
