...
public class ZsRolInsRole implements Serializable {

  /**
   * 
   */
  private static final long serialVersionUID = -6162735366481144101L;
  private ZsRolInsRoleId id;
  ...
  public ZsRolInsRole(long userId, long insId, long rolId) {
    super();
    this.id = new ZsRolInsRoleId(userId, insId, rolId);
  }

  public ZsRolInsRole(ZsRolInsRoleId id, String roleName) {
    super();
    this.id = id;
   ...
   */
  public void setId(ZsRolInsRoleId id) {
    this.id = id;
  }
