 ...
 */
@Embeddable
public class HnRolInsRoleId implements java.io.Serializable {
  ...
  public HnRolInsRoleId() {}

  public HnRolInsRoleId(long userId, long insId, long roleId) {
    this.userId = userId;
    this.insId = insId;
    this.roleId = roleId;
  }
  ...
  public boolean equals(Object other) {
    ...
    if ((other == null))
      return false;
    if (!(other instanceof HnRolInsRoleId))
      return false;
    HnRolInsRoleId castOther = (HnRolInsRoleId) other;
