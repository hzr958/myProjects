 ...
 */
@Embeddable
public class ZsRolInsRoleId implements java.io.Serializable {
  ...
  public ZsRolInsRoleId() {}

  public ZsRolInsRoleId(long userId, long insId, long roleId) {
    this.userId = userId;
    this.insId = insId;
    this.roleId = roleId;
  }
  ...
  public boolean equals(Object other) {
    ...
    if ((other == null))
      return false;
    if (!(other instanceof ZsRolInsRoleId))
      return false;
    ZsRolInsRoleId castOther = (ZsRolInsRoleId) other;
