 ...
 */
@Entity
@Table(name = "MERGE_INS_ALIAS")
public class SieMergeInsAliasBak implements Serializable {
  ...
  public SieMergeInsAliasBak() {
    super();
  }

  public SieMergeInsAliasBak(Long insId, Long dbId, String name) {
    super();
