 ...
 * 
 */
public class PatMemberBean implements Serializable {

  /**
   * 
   */
  private static final long serialVersionUID = -9079482626170310234L;
  ...
  public String toString() {
    return "PatMemberBean [pmId=" + pmId + ", psnId=" + psnId + ", seqNo=" + seqNo + ", name=" + name + ", email="
