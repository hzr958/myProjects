 ...
 */
@Entity
@Table(name = "KPI_IMPACT_BASE_INDEX")
public class KpiImpactBaseIndex implements Serializable {
  private static final long serialVersionUID = 4389857766416124153L;
  // 主键
  private Long id;
  // 数据所属单位
  private Long insId;
  ...
  public KpiImpactBaseIndex() {
    super();
  }

  public KpiImpactBaseIndex(Long insId, Date timeRecords, String ip, String country, String prov, String city,
      Long psnId) {
    super();
    this.insId = insId;
  ...
  @Id
  @Column(name = "id")
  @SequenceGenerator(name = "SEQ_STORE", sequenceName = "SEQ_KPI_IMPACT_BASE_INDEX", allocationSize = 1)
