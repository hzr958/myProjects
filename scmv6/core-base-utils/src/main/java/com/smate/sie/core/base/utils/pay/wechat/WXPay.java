...
import com.smate.sie.core.base.utils.pay.wechat.WXPayConstants.SignType;
...
public class WXPay {
  ...
  public String requestWithoutCert(String urlSuffix, Map<String, String> reqData, int connectTimeoutMs,
    ...
    String resp =
        this.wxPayRequest.requestWithoutCert(urlSuffix, msgUUID, reqBody, connectTimeoutMs, readTimeoutMs, autoReport);
    return resp;
  }
