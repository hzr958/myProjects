...
public class SieInsRefDb implements Serializable {

  /**
   * 
   */
  private static final long serialVersionUID = -1470144565137453590L;
  private SieInsRefDbId sieInsRefDbId;
  // 标识当前记录是否要用.
   ...
   */
  @EmbeddedId
  public SieInsRefDbId getInsRefDbId() {
    return sieInsRefDbId;
  }

  public void setInsRefDbId(SieInsRefDbId sieInsRefDbId) {
    this.sieInsRefDbId = sieInsRefDbId;
  }
