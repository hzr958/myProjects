 ...
 */
@Entity
@Table(name = "KPI_IMPACT_BASE_DOWNLOAD")
public class KpiImpactBaseDownload implements Serializable {

  private static final long serialVersionUID = 2692815804256882692L;
  // 主键
  private Long id;
  // 数据所属单位
  private Long insId;
  ...
  public KpiImpactBaseDownload() {
    super();
  }


  public KpiImpactBaseDownload(Long insId, Date timeRecords, Integer keyType, Long keyCode, String title, String ip,
