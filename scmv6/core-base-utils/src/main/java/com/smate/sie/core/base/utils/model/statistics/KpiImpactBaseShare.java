 ...
 */
@Entity
@Table(name = "KPI_IMPACT_BASE_SHARE")
public class KpiImpactBaseShare implements Serializable {
  private static final long serialVersionUID = -3493104769658758043L;
  // 主键
  private Long id;
  // 数据所属单位
  private Long insId;
  ...
  public KpiImpactBaseShare() {
    super();
  }


  public KpiImpactBaseShare(Long insId, Date timeRecords, Integer keyType, Long keyCode, String title, String ip,
