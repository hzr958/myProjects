 ...
 */
@Entity
@Table(name = "KPI_IMPACT_BASE_VIEW")
public class KpiImpactBaseView implements Serializable {

  private static final long serialVersionUID = -1504963941661302774L;
  // 主键
  private Long id;
  // 数据所属单位
  private Long insId;
  ...
  public KpiImpactBaseView() {
    super();
  }


  public KpiImpactBaseView(Long insId, Date timeRecords, Integer keyType, Long keyCode, String title, String ip,
