 ...
 */
@Entity
@Table(name = "PDWH_PUB_KEYWORDS20180511")
public class PdwhPubKeywords20180511 implements Serializable {
  /**
   * 
   */
  ...
  public PdwhPubKeywords20180511() {
    super();
  }

  public PdwhPubKeywords20180511(Long pubId, String keywords, int language) {
    super();
    this.pubId = pubId;
