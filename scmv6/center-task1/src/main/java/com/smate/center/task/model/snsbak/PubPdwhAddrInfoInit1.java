...
@Entity
@Table(name = "PUB_PDWH_ADDR_INIT1")
public class PubPdwhAddrInfoInit1 implements Serializable {

  /**
   * 
   */
  private static final long serialVersionUID = -246021957888407726L;
