...
/**
 * 基准库成果ID和SNS个人库成果ID的关系备份表 用于基准库与个人库评论记录同步任务
 * 
 */

@Entity
@Table(name = "V_PUB_PDWH_SNS_RELATION_BAK_C")
public class PubPdwhSnsRelationBakC implements Serializable {
