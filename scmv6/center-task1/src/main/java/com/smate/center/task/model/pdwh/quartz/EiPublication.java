 ...
 */
@Entity
@Table(name = "EI_PUBLICATION")
public class EiPublication implements Serializable {

  /**
   * 
   */
  private static final long serialVersionUID = -4140117736387548505L;
  private Long pubId;
  // 出版年份
  ...
  // 文献地址列表
  private List<EiPubAddr> pubAddrs;
  // 同步到publication_all冗余表状态。0:未同步，1:已同步
  ...
  @Id
  @Column(name = "PUB_ID")
  @SequenceGenerator(name = "SEQ_STORE", sequenceName = "SEQ_EI_PUBLICATION", allocationSize = 1)
  ...
  @Transient
  public List<EiPubAddr> getPubAddrs() {
    return pubAddrs;
  }
  ...
  public void setPubAddrs(List<EiPubAddr> pubAddrs) {
