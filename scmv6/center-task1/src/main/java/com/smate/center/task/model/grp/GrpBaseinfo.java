...
public class GrpBaseinfo implements Serializable {
  ...
  @Id
  // @SequenceGenerator(name = "SEQ_GRP_BASEINFO_STORE", sequenceName =
  // "SEQ_V_GRP_BASEINFO", allocationSize = 1)
  // @GeneratedValue(strategy = GenerationType.SEQUENCE, generator =
  // "SEQ_GRP_BASEINFO_STORE")
  @Column(name = "GRP_ID")
  ...
  public GrpBaseinfo(String grpName, String grpAuatars) {
    super();
    this.grpName = grpName;
    this.grpAuatars = grpAuatars;
  }
  ...
  public GrpBaseinfo(Long grpId, Integer grpCategory) {
    super();
    this.grpId = grpId;
    this.grpCategory = grpCategory;
  }

  public GrpBaseinfo(Long grpId, String grpName, Long ownerPsnId) {
    super();
    this.grpId = grpId;
    this.grpName = grpName;
