...
public class DynamicMsg implements Serializable {
  ...
  public DynamicMsg(Long dynId, Long producer, String dynType) {
    this.dynId = dynId;
   ...
   * DAO中获取MODEL会用到的构造器
   */
  public DynamicMsg(Long dynId, Long producer, String dynType, Integer dynTmp, Integer permission, Integer delstatus,
      Integer relDealStatus, Long sameFlag, Integer fromType, Long targetId, Date createDate, Date updateDate,
      Long resId, Integer resType, String platform) {
    super();
    this.dynId = dynId;
    this.producer = producer;
    this.dynType = dynType;
