package com.smate.center.task.single.model.rol.psn;
...
public class RolPsnIns implements Serializable {
  ...
  public RolPsnIns(RolPsnInsPk pk, String psnName, String ename, String psnEmail, String firstName, String lastName,
      String tel, String avatars, Integer status, Integer cyFlag, Long cyId, Long provId, Long sid) {
    super();
    this.pk = pk;
    this.zhName = psnName;
    this.enName = ename;
