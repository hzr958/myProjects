 ...
 */
@Entity
@Table(name = "PSN_JOURNAL")
public class RcmdPsnJournal implements Serializable {


  /**
   * 
   */
  private static final long serialVersionUID = 3146857358939543607L;
  private Long id;
  // 成果所有人
  private Long psnId;
  // ISSN
  ...
  public RcmdPsnJournal() {
    super();
  }

  public RcmdPsnJournal(Long psnId, String issn, String issnTxt, Integer grade, Integer hxj) {
    super();
    this.psnId = psnId;
    this.issn = issn;
