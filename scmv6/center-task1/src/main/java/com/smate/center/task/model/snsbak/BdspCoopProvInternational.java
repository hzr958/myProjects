...
@Entity
@Table(name = "BDSP_COOP_PROVI_INTERNTIONAL")
public class BdspCoopProvInternational implements Serializable {
  ...
  public BdspCoopProvInternational() {
    super();
  }

  public BdspCoopProvInternational(Integer indexId, Integer pubYear, Integer categoryId, Integer provinceId,
