...
public class PersonPmNameDao extends SnsHibernateDao<PersonPmName, Long> {
  ...
  public void savePrefixName(Set<String> prefixs, Long psnId, Long insId) {
    ...
    super.createQuery("delete from PersonPmName where psnId = ? and type = 2 and nameSource=1 ", psnId).executeUpdate();
  ...
  public void saveInitName(Set<String> initNames, Long psnId, Long insId) {
    ...
    super.createQuery("delete from PersonPmName where psnId = ? and type = 5 and nameSource=1", psnId).executeUpdate();
  ...
  public void saveFullName(Set<String> fullNames, Long psnId, Long insId) {
    ...
    super.createQuery("delete from PersonPmName where psnId = ? and type = 1 and nameSource=1", psnId).executeUpdate();
