 ...
 */
@Entity
@Table(name = "JXKJT_PRP_INFO_TEMP")
public class JxkjtPrpInfoTemp implements Serializable {
  ...
  public JxkjtPrpInfoTemp() {
    super();
  }

  public JxkjtPrpInfoTemp(Long prpCode, Long posCode, String summary, String zhTitle, String keyWords) {
    super();
