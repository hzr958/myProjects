...
public class PdwhPublication implements Serializable {
  ...
  public PdwhPublication(Long pubId, Integer dbId, Long jnlId, Integer pubType, Integer pubYear) {
    super();
    this.pubId = pubId;
    this.dbId = dbId;
    this.jnlId = jnlId;
  ...
  public PdwhPublication(Long pubId, String zhTitle, String enTitle, String authorName, String authorNameSpec,
      String zhBriefDesc, String enBriefDesc, Integer pubType) {
    super();
    this.pubId = pubId;
    this.zhTitle = zhTitle;
    this.enTitle = enTitle;
