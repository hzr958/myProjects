...
public class ImportPubXmlDocument {
  ...
  public Integer getCiteTimes() {
    ...
    } else if (StringUtils.isEmpty(citeTimes.trim())) {
      return 0;
    }
    return null;
  }
  ...
  public Integer getPatentCategory() {
    ...
    String category = this.getXmlNodeAttribute(ImportPubXmlConstants.PUBLICATION_XPATH, "patent_category");
   ...
   * @return
   */
  public String getPatentMainCategoryNo() {

    String mainCategoryNo =
        this.getXmlNodeAttribute(ImportPubXmlConstants.PUBLICATION_XPATH, "patent_main_category_no");
   ...
   * @return
   */
  public String getPatentCategoryNo() {

    String categoryNo = this.getXmlNodeAttribute(ImportPubXmlConstants.PUBLICATION_XPATH, "patent_category_no");
    return categoryNo;
  }

  /**
   * 获取rainpat ，cnkipat引用次数.
   * 
   * @return
   */
  ...
  public String getStandardNo() {
    String standardNo = this.getXmlNodeAttribute(ImportPubXmlConstants.PUBLICATION_XPATH, "lblStdNo");
    return standardNo;
  }
  ...
  public String getRegisterNo() {
    String registerNo = this.getXmlNodeAttribute(ImportPubXmlConstants.PUBLICATION_XPATH, "registration_number");
    return registerNo;
  }
