...
public class SaveFundInfoFromXMlTask4 extends TaskAbstract {
  ...
  public static String PDWH_PUB_ID_CACHE4 = "pdwh_pub_id_cache4";

  public SaveFundInfoFromXMlTask4() {
    super();
  }

  public SaveFundInfoFromXMlTask4(String beanName) {
    super(beanName);
  }
  ...
  public void doRun() throws SingleTaskException {
    ...
    // 是否移除psn_id缓存
    if (taskMarkerService.getApplicationQuartzSettingValue("SaveFundInfoFromXMlTask_removePubIdCache4") == 1) {
      cacheService.remove(PDWH_PUB_ID_CACHE4, "last_pub_id");
    }
    logger.error("===========lastPubId为=======" + cacheService.get(PDWH_PUB_ID_CACHE4, "last_pub_id"));
    try {
      Long lastPubId = (Long) cacheService.get(PDWH_PUB_ID_CACHE4, "last_pub_id");
      if (lastPubId == null) {
        lastPubId = 19901336968L;
      }
      ...
      this.cacheService.put(PDWH_PUB_ID_CACHE4, 60 * 60 * 24, "last_pub_id", lastPubId);
