package com.smate.center.task.single.oldXml.pub;
...
public class PubXmlDocument {
  ...
  public String getBriefDesc() {
    String str = this.getXmlNodeAttribute(PubXmlConstants.PUBLICATION_XPATH, "brief_desc");
    return str;
  }
  ...
  public String getBriefDescEN() {
    String str = this.getXmlNodeAttribute(PubXmlConstants.PUBLICATION_XPATH, "brief_desc_en");
    return str;
  }
  ...
  public String getAuthorNames() {
    String str = this.getXmlNodeAttribute(PubXmlConstants.PUBLICATION_XPATH, "author_names");
    return str;
  }
