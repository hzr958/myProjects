...
public class PubIndependentPrCityAnalysisTask extends TaskAbstract {
  private final Logger logger = LoggerFactory.getLogger(getClass());

  public PubIndependentPrCityAnalysisTask() {
    super();
  }

  public PubIndependentPrCityAnalysisTask(String beanName) {
    super(beanName);
  }
  ...
  public void doRun() throws SingleTaskException {
    ...
    this.bdspDataStatisticsService.pubIndependentPrCityAnalysis(pubList);
  }
