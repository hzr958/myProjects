...
public class SaveFundInfoFromXMlTask2 extends TaskAbstract {
  private final Logger logger = LoggerFactory.getLogger(getClass());
  private int batchSize = 200;
  private Long PubId = 20670637L;
  @Autowired
  ...
  public static String PDWH_PUB_ID_CACHE2 = "pdwh_pub_id_cache2";

  public SaveFundInfoFromXMlTask2() {
    super();
  }

  public SaveFundInfoFromXMlTask2(String beanName) {
    super(beanName);
  }
  ...
  public void doRun() throws SingleTaskException {
    ...
    // 是否移除psn_id缓存
    if (taskMarkerService.getApplicationQuartzSettingValue("SaveFundInfoFromXMlTask_removePubIdCache2") == 1) {
      cacheService.remove(PDWH_PUB_ID_CACHE2, "last_pub_id");
    }
    logger.error("===========lastPubId为=======" + cacheService.get(PDWH_PUB_ID_CACHE2, "last_pub_id"));
    try {
      Long lastPubId = (Long) cacheService.get(PDWH_PUB_ID_CACHE2, "last_pub_id");
      if (lastPubId == null) {
        lastPubId = 15415739L;
      }
      ...
      this.cacheService.put(PDWH_PUB_ID_CACHE2, 60 * 60 * 24, "last_pub_id", lastPubId);
