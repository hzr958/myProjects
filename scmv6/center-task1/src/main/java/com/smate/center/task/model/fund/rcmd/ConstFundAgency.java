...
public class ConstFundAgency implements Serializable {
   ...
   * 
   */
  private static final long serialVersionUID = -40927423708396237L;
  private Long id;
  ...
  private Long addrCoun;// 地址-国家
  private Long addrPrv;// 地址-省
  private Long addrCity;// 地址-市
  private String addrCounName;// 地址-国家
  private String addrPrvName;// 地址-省
  private String addrCityName;// 地址-市

  private String enAddress;// 英文资助机构地址

  public ConstFundAgency() {
    super();
  }

  public ConstFundAgency(Long id, String logoUrl) {
    super();
    this.id = id;
  ...
  public ConstFundAgency(Long id, String nameZh, String nameEn, Integer flag, Long type, Long regionId, String code,
      String abbr, String address, String url, String contact, String logoUrl, Long insId, Integer status, Long psnId,
      Date createDate, Date useDate) {
    super();
    this.id = id;
    this.nameZh = nameZh;
    this.nameEn = nameEn;
  ...
  public String getNameView() {
    // nameView = StringUtils.isBlank(this.nameZh) ? this.nameEn :
    // this.nameZh;
    return nameView;
  }
  ...
  @Column(name = "ADDRPRV")
  public Long getAddrPrv() {
    return addrPrv;
  }

  public void setAddrPrv(Long addrPrv) {
  ...
  @Transient
  public String getAddrPrvName() {
    return addrPrvName;
  }

  public void setAddrPrvName(String addrPrvName) {
    this.addrPrvName = addrPrvName;
  }
  ...
  @Column(name = "ADDRCOUN")
  public Long getAddrCoun() {
    return addrCoun;
  }

  public void setAddrCoun(Long addrCoun) {
    this.addrCoun = addrCoun;
  }

  @Transient
  public String getAddrCounName() {
    return addrCounName;
  }

  public void setAddrCounName(String addrCounName) {
    this.addrCounName = addrCounName;
  }
