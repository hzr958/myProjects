...
public class ConstFundCategory implements Serializable {
   ...
   * 
   */
  private static final long serialVersionUID = 4718274140500370633L;
  private Long id;
  ...
  private String insType;// 单位要求：1.企业，2.科研机构
  ...
  public int getIsOver() {
    ...
    if (this.endDate != null) {
      try {
        ...
        Date afterOneMonth = DateUtils.addMonths(new Date(), 1);
