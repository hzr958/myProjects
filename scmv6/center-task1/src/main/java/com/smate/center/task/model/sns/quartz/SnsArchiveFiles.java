...
public class SnsArchiveFiles implements Serializable {

  /**
  * 
  */
  private static final long serialVersionUID = -6005254582397130747L;
  @Id
  @Column(name = "FILE_ID")
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    SnsArchiveFiles other = (SnsArchiveFiles) obj;
    if (createTime == null) {
