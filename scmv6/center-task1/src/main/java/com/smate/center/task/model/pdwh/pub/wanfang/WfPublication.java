 ...
 */
@Entity
@Table(name = "WF_PUBLICATION")
public class WfPublication implements Serializable {

  /**
   * 
   */
  private static final long serialVersionUID = 4612996743899948554L;
  ...
  // 文献地址列表
  private List<WfPubAddr> pubAddrs;

  @Id
  @Column(name = "PUB_ID")
  @SequenceGenerator(name = "SEQ_STORE", sequenceName = "SEQ_WF_PUBLICATION", allocationSize = 1)
  ...
  @Transient
  public List<WfPubAddr> getPubAddrs() {
    return pubAddrs;
  }
  ...
  public void setPubAddrs(List<WfPubAddr> pubAddrs) {
