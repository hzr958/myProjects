...
public interface PersonManager {
   ...
   * @throws ServiceException
   */
  List<Long> findPersonKnowByPsnId(Long lastPsnId, int batchSize) throws ServiceException;

  List<Long> findPsnDisciplineByAutoRecommend(List<Long> psnIds) throws ServiceException;
   ...
   * @throws ServiceException
   */
  Integer getPsnByNode(Long psnId) throws ServiceException;
   ...
   * @throws ServiceException
   */
  List<PsnKnowWorkEdu> findKnowPsn(List<Long> psnIds) throws ServiceException;

  List<Long> findTaskPsnRefCommendIds(int batchSize);

  void updateTaskPsnRefCommendIds(Long psnId);
  ...
  List<Person> getSendNewYearMailPsnIds(Integer size, Long psnId);

  List<String> getSendNewYearEnMail(Long minPsnId, Long maxPsnId);

  List<NewYearGreetingEmail> getToHandleEmail(Integer size);

  void saveNewYearEmailStatus(NewYearGreetingEmail email, Integer status);
}
