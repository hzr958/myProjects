...
public class PubFulltextPsnRcmd implements Serializable {
  ...
  public PubFulltextPsnRcmd(Long pubId, Long psnId, Long fulltextFileId, Integer dbId, Integer matchType,
      Integer status, Date rcmdDate, Long srcPubId, Long srcPsnId, Long fileSize) {
    this.pubId = pubId;
    this.psnId = psnId;
    this.fulltextFileId = fulltextFileId;
    this.dbId = dbId;
