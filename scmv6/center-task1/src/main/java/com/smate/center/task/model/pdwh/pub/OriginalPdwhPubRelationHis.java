 ...
 */
@Entity
@Table(name = "ORIGINAL_PDWH_PUB_RELATION_HIS")
public class OriginalPdwhPubRelationHis {
  ...
  public OriginalPdwhPubRelationHis() {
    super();
  }

  public OriginalPdwhPubRelationHis(Long xmlId, String seqNo, Long insId, Long psnId, Integer recordFrom,
  ...
  public OriginalPdwhPubRelationHis(Long xmlId, Long psnId, Integer recordFrom, Integer status, Date createDate) {
    super();
    this.xmlId = xmlId;
    this.psnId = psnId;
    this.recordFrom = recordFrom;
