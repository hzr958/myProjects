...
@Entity
@Table(name = "PUB_PDWH_ADDR_INIT2")
public class PubPdwhAddrInfoInit2 implements Serializable {

  /**
   * 
   */
  private static final long serialVersionUID = 3628479717186573616L;
