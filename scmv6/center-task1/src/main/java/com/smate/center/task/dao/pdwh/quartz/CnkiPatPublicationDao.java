...
import com.smate.center.task.model.pdwh.pub.cnkipat.CnkiPatPubDup;
import com.smate.center.task.model.pdwh.pub.cnkipat.CnkiPatPubExtend;
import com.smate.center.task.model.pdwh.pub.cnkipat.CnkiPatPublication;
...
public class CnkiPatPublicationDao extends PdwhHibernateDao<CnkiPatPublication, Long> {
  ...
  public void saveCnkiPatPubDup(Long pubId, Long titleHash, Long patentHash, Long patentOpenHash) {
    ...
    CnkiPatPubDup dup = new CnkiPatPubDup(pubId, titleHash, patentHash, patentOpenHash);
