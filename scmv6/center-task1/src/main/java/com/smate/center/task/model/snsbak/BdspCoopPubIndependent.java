...
// 成果统计只有一个作者
@Entity
@Table(name = "BDSP_COOP_PERSON")
public class BdspCoopPubIndependent implements Serializable {
  ...
  public BdspCoopPubIndependent() {
    super();
  }

  public BdspCoopPubIndependent(Integer indexId, Integer pubYear, Integer categoryId, Integer cityId,
