...
public class WorkHistoryServiceImpl implements WorkHistoryService {
  ...
  @Override
  public List<WorkHistory> findWorkByAutoRecommend(List<Long> psnIds) throws ServiceException {
    return workHistoryDao.findWorkByAutoRecommend(psnIds);
  }

  @Override
  public Page<WorkHistory> findWork(Long insId, Long psnId, Page<WorkHistory> page) throws ServiceException {
    return workHistoryDao.findWork(insId, psnId, page);
  }
}
