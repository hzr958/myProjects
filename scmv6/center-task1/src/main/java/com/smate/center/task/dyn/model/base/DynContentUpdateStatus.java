 ...
 */
@Entity
@Table(name = "DYN_CONTENT_UPDATE_STATUS")
public class DynContentUpdateStatus {
  ...
  public DynContentUpdateStatus(Long dynId, String dyntype, Integer updateStatus, Date updateDate, String updateMsg) {
    super();
    this.dynId = dynId;
    this.dyntype = dyntype;
    this.updateStatus = updateStatus;
  ...
  public DynContentUpdateStatus(Long dynId, Integer updateStatus, Date updateDate, String updateMsg) {
    super();
    this.dynId = dynId;
    this.updateStatus = updateStatus;
    this.updateDate = updateDate;
