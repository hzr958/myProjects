 ...
 */
@Entity
@Table(name = "PROMOTE_MAIL_INIT_DATA")
public class PromoteMailInitData implements Serializable {
  ...
  public PromoteMailInitData() {}

  public PromoteMailInitData(String mailData, Integer fromNodeId) {
  ...
  @Id
  @Column(name = "id")
  @SequenceGenerator(name = "SEQ_STORE", sequenceName = "SEQ_PROMOTE_MAIL_INIT_DATA", allocationSize = 1)
