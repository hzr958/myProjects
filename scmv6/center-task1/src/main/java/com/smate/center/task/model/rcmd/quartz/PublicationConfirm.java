...
public class PublicationConfirm implements Serializable {
   ...
   * 
   */
  private static final long serialVersionUID = -5347586059120568106L;
  ...
  public PublicationConfirm(Long rolPubId, Long insId) {
    super();
    this.rolPubId = rolPubId;
    this.insId = insId;
  }

  public PublicationConfirm(Long id, Long psnId, Long insId, Date confirmDate, Integer confirmResult,
      Integer assignSeqNo, Integer confirmSeqNo, Long rolPubId, Long insAssignId, Long pmId, Integer dupStatus,
      Integer syncStatus, String dupPubIds, Float assignScore, Long snsPubId, Integer autoComfirm, Integer syncNum) {
    super();
    this.id = id;
    this.psnId = psnId;
    this.insId = insId;
  ...
  @Id
  @SequenceGenerator(name = "SEQ_STORE", sequenceName = "SEQ_PUB_CONFIRM", allocationSize = 1)
