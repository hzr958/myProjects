...
public class FundRecommendRegion implements Serializable {
  ...
  public FundRecommendRegion(Long id, Long psnId, Long regionId, Date updateDate, String superRegionStrId,
      String zhName, String enName, String showName) {
    super();
    this.id = id;
    this.psnId = psnId;
  ...
  public boolean equals(Object obj) {
    if (!(obj instanceof FundRecommendRegion)) {
      return false;
    }
    FundRecommendRegion p = (FundRecommendRegion) obj;
    return this.psnId.equals(p.psnId) && this.regionId.equals(p.regionId);
  }
