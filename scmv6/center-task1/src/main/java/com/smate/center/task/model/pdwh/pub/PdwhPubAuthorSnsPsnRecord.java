...
public class PdwhPubAuthorSnsPsnRecord implements Serializable {
   ...
   * 
   */
  private static final long serialVersionUID = 3598967544177457054L;
  ...
  private Long insId;// 单位id（,只有当insId匹配上后，insid才为人员的insid）
  private String insName;// 单位名
  private Integer status;
  private Date updateTime;
  private Integer nameType;// 1为全称
  ...
  public PdwhPubAuthorSnsPsnRecord(Long pubId, Long psnId, Long insId, Integer status) {
    super();
    this.pubId = pubId;
    this.psnId = psnId;
    this.insId = insId;
  ...
  public PdwhPubAuthorSnsPsnRecord(Long psnId, String psnName, Long insId, String insName) {
    super();
    this.psnId = psnId;
    this.psnName = psnName;
    this.insId = insId;
  ...
  public PdwhPubAuthorSnsPsnRecord(Long pubId, Long psnId, Integer nameType) {
    super();
    this.pubId = pubId;
    this.psnId = psnId;
    this.nameType = nameType;
