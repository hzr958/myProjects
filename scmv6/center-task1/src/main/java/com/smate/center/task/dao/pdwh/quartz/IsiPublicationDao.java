...
import com.smate.center.task.model.pdwh.quartz.IsiPubAssign;
import com.smate.center.task.model.pdwh.quartz.IsiPubDup;
import com.smate.center.task.model.pdwh.quartz.IsiPubExtend;
import com.smate.center.task.model.pdwh.quartz.IsiPubSourceDb;
import com.smate.center.task.model.pdwh.quartz.IsiPublication;
...
public class IsiPublicationDao extends PdwhHibernateDao<IsiPublication, Long> {
  ...
  public void saveIsiPubDup(Long pubId, Long sourceIdHash, Long titleHash, Long unitHash) {
    ...
    IsiPubDup dup = new IsiPubDup(pubId, sourceIdHash, titleHash, unitHash);
