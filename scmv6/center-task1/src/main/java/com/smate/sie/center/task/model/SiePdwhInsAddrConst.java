...
public class SiePdwhInsAddrConst implements Serializable {
  ...
  public SiePdwhInsAddrConst() {
    super();
  }

  public SiePdwhInsAddrConst(Long constId, Long insId, String insName, Long insNameHash) {
    super();
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    SiePdwhInsAddrConst other = (SiePdwhInsAddrConst) obj;
    if (other.getInsId().equals(insId) && other.getInsNameHash().equals(getInsNameHash())) {
      return true;
    }
    return false;
  }
