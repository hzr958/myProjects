...
public class PubXmlDocument {
  ...
  public List getNodes(String xpath) {
    ...
    System.out.println(this.xmlDocument.getStringValue());
   ...
   * @return
   */
  public String getExpandLocal() {
    String str = this.getXmlNodeAttribute(PubXmlConstants.PUB_EXPAND_XPATH, "local");
    return str;
  }
   ...
   * @return
   */
  public String getExpandFrom() {
    String str = this.getXmlNodeAttribute(PubXmlConstants.PUB_EXPAND_XPATH, "from");
    return str;
  }
   ...
   * @return
   */
  public String getExpandIsisGuid() {
    String str = this.getXmlNodeAttribute(PubXmlConstants.PUB_EXPAND_XPATH, "isisGuid");
    return str;
  }
   ...
   * @return
   */
  public String getExpandRptId() {
    String str = this.getXmlNodeAttribute(PubXmlConstants.PUB_EXPAND_XPATH, "rptId");
    return str;
  }
   ...
   * @return
   */
  public String getExpandPId() {
    String str = this.getXmlNodeAttribute(PubXmlConstants.PUB_EXPAND_XPATH, "pId");
    return str;
  }

  /**
   * 获取expand-currentPubStatus.
   * 
   * @return
   */
  public String getExpandPubStatus() {
    String str = this.getXmlNodeAttribute(PubXmlConstants.PUB_EXPAND_XPATH, PubXmlConstants.CURRENT_PUB_STATUS);
    return str;
  }

  /**
   * 获取expand-currentAction.
   * 
   * @return
   */
  public String getExpandCurrentAction() {
    String str = this.getXmlNodeAttribute(PubXmlConstants.PUB_EXPAND_XPATH, PubXmlConstants.CURRENT_ACTION);
    return str;
  }

  /**
   * 获取expand-articleType.
   * 
   * @return
   */
  public String getExpandArticleType() {
    String str = this.getXmlNodeAttribute(PubXmlConstants.PUB_EXPAND_XPATH, PubXmlConstants.ARTICLE_TYPE);
    return str;
  }

  /**
   * 获取expand-groupFolderId.
   * 
   * @return
   */
  public String getExpandGroupFolderId() {
    String str = this.getXmlNodeAttribute(PubXmlConstants.PUB_EXPAND_XPATH, PubXmlConstants.GROUP_FOLDER_ID);
    return str;
  }

  /**
   * 获取expand-privacyLevel.
   * 
   * @return
   */
  public String getExpandPrivacyLevel() {
    String str = this.getXmlNodeAttribute(PubXmlConstants.PUB_EXPAND_XPATH, PubXmlConstants.PRIVACY_LEVEL);
    return str;
  }
  ...
  public String getExpandGroupId() {
    String str = this.getXmlNodeAttribute(PubXmlConstants.PUB_EXPAND_XPATH, PubXmlConstants.GROUP_ID);
    return str;
  }
  ...
  public void fillPubList(List<PdwhPubSituationPO> situationPO) {
    if (this.xmlDocument == null) {
      throw new java.lang.NullPointerException("xmlDocument can't be null.");
    }
    PubXmlDocument.fillPubList1(situationPO, this);
  }

  private static void fillPubList1(List<PdwhPubSituationPO> situationPO, PubXmlDocument pubXmlDocument) {
    for (PdwhPubSituationPO pdwhPubSituationPO : situationPO) {
      if ("ei".equals(pdwhPubSituationPO.getLibraryName().toLowerCase())) {
        pubXmlDocument.setXmlNodeAttribute(PubXmlConstants.PUB_LIST_XPATH, "list_ei", "1");
        pubXmlDocument.setXmlNodeAttribute(PubXmlConstants.PUB_LIST_XPATH, "list_ei_source", "1");
      } /*
         * else { pubXmlDocument.setXmlNodeAttribute(PubXmlConstants.PUB_LIST_XPATH, "list_ei", "0");
         * pubXmlDocument.setXmlNodeAttribute(PubXmlConstants.PUB_LIST_XPATH, "list_ei_source", "0"); }
         */
      if ("sci".equals(pdwhPubSituationPO.getLibraryName().toLowerCase())
          || "scie".equals(pdwhPubSituationPO.getLibraryName().toLowerCase())) {
        pubXmlDocument.setXmlNodeAttribute(PubXmlConstants.PUB_LIST_XPATH, "list_sci", "1");
        pubXmlDocument.setXmlNodeAttribute(PubXmlConstants.PUB_LIST_XPATH, "list_sci_source", "1");
      } /*
         * else { pubXmlDocument.setXmlNodeAttribute(PubXmlConstants.PUB_LIST_XPATH, "list_sci", "0");
         * pubXmlDocument.setXmlNodeAttribute(PubXmlConstants.PUB_LIST_XPATH, "list_sci_source", "0"); }
         */
      if ("istp".equals(pdwhPubSituationPO.getLibraryName().toLowerCase())) {
        pubXmlDocument.setXmlNodeAttribute(PubXmlConstants.PUB_LIST_XPATH, "list_istp", "1");
        pubXmlDocument.setXmlNodeAttribute(PubXmlConstants.PUB_LIST_XPATH, "list_istp_source", "1");
      } /*
         * else { pubXmlDocument.setXmlNodeAttribute(PubXmlConstants.PUB_LIST_XPATH, "list_istp", "0");
         * pubXmlDocument.setXmlNodeAttribute(PubXmlConstants.PUB_LIST_XPATH, "list_istp_source", "0"); }
         */
      if ("ssci".equals(pdwhPubSituationPO.getLibraryName().toLowerCase())) {
        pubXmlDocument.setXmlNodeAttribute(PubXmlConstants.PUB_LIST_XPATH, "list_ssci", "1");
        pubXmlDocument.setXmlNodeAttribute(PubXmlConstants.PUB_LIST_XPATH, "list_ssci_source", "1");
      } /*
         * else { pubXmlDocument.setXmlNodeAttribute(PubXmlConstants.PUB_LIST_XPATH, "list_ssci", "0");
         * pubXmlDocument.setXmlNodeAttribute(PubXmlConstants.PUB_LIST_XPATH, "list_ssci_source", "0"); }
         */
      if ("cscd".equals(pdwhPubSituationPO.getLibraryName().toLowerCase())) {
        pubXmlDocument.setXmlNodeAttribute(PubXmlConstants.PUB_LIST_XPATH, "list_cscd", "1");
        pubXmlDocument.setXmlNodeAttribute(PubXmlConstants.PUB_LIST_XPATH, "list_cscd_source", "1");
      } /*
         * else { pubXmlDocument.setXmlNodeAttribute(PubXmlConstants.PUB_LIST_XPATH, "list_cscd", "0");
         * pubXmlDocument.setXmlNodeAttribute(PubXmlConstants.PUB_LIST_XPATH, "list_cscd_source", "0"); }
         */
      if ("cssci".equals(pdwhPubSituationPO.getLibraryName().toLowerCase())) {
        pubXmlDocument.setXmlNodeAttribute(PubXmlConstants.PUB_LIST_XPATH, "list_cssci", "1");
        pubXmlDocument.setXmlNodeAttribute(PubXmlConstants.PUB_LIST_XPATH, "list_cssci_source", "1");
      } /*
         * else { pubXmlDocument.setXmlNodeAttribute(PubXmlConstants.PUB_LIST_XPATH, "list_cssci", "0");
         * pubXmlDocument.setXmlNodeAttribute(PubXmlConstants.PUB_LIST_XPATH, "list_cssci_source", "0"); }
         */
      if ("other".equals(pdwhPubSituationPO.getLibraryName().toLowerCase())) {
        pubXmlDocument.setXmlNodeAttribute(PubXmlConstants.PUB_LIST_XPATH, "list_other", "1");
      } /*
         * else { pubXmlDocument.setXmlNodeAttribute(PubXmlConstants.PUB_LIST_XPATH, "list_other", "0"); }
         */
      if ("pku".equals(pdwhPubSituationPO.getLibraryName().toLowerCase())) {
        pubXmlDocument.setXmlNodeAttribute(PubXmlConstants.PUB_LIST_XPATH, "list_pku", "1");
        pubXmlDocument.setXmlNodeAttribute(PubXmlConstants.PUB_LIST_XPATH, "list_pku_source", "1");
      } /*
         * else { pubXmlDocument.setXmlNodeAttribute(PubXmlConstants.PUB_LIST_XPATH, "list_pku", "0");
         * pubXmlDocument.setXmlNodeAttribute(PubXmlConstants.PUB_LIST_XPATH, "list_pku_source", "0"); }
         */
    }
