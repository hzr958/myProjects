...
public class SnsPsnScienceArea implements Serializable {
  ...
  public SnsPsnScienceArea() {
    super();
  }

  public SnsPsnScienceArea(Integer scienceAreaId, String scienceArea, String enScienceArea) {
    this.scienceAreaId = scienceAreaId;
    this.scienceArea = scienceArea;
    this.enScienceArea = enScienceArea;
  }

  public SnsPsnScienceArea(Long id, Long psnId, String scienceArea, Integer scienceAreaId, Integer status) {
    super();
    this.id = id;
    this.psnId = psnId;
    this.scienceArea = scienceArea;
