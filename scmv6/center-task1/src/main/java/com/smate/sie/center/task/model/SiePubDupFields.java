...
public class SiePubDupFields implements Serializable {
  ...
  // 著作（中文标题+isbn的hash）
  private Long bzFingerPrint;
  // 著作（英文标题+isbn的hash）
  private Long beFingerPrint;
  // 作者名hash
  ...
  public SiePubDupFields() {
    super();
  }

  public SiePubDupFields(Long pubId, Long sourceDbId) {
    super();
    this.pubId = pubId;
  ...
  @Column(name = "BZFINGER_PRINT")
  public Long getBzFingerPrint() {
    return bzFingerPrint;
  }

  public void setBzFingerPrint(Long bzFingerPrint) {
    this.bzFingerPrint = bzFingerPrint;
  }

  @Column(name = "BEFINGER_PRINT")
  public Long getBeFingerPrint() {
    return beFingerPrint;
  }

  public void setBeFingerPrint(Long beFingerPrint) {
    this.beFingerPrint = beFingerPrint;
  }
