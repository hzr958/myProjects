...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="font-family:Arial, Helvetica, '宋体'; font-size:12px; color:#333333;">
  <tr>
<td height="25" align="center" valign="bottom" style="color:#333333; font-size:12px;">如邮件不能正常显示，请打开下面链接查看<br />
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Helvetica,'Microsoft YaHei'; font-size:14px; color:#333333;">
          <tr>
            <td style="font-size:14px; font-weight:bold; line-height:150%;">
                <p style="margin:0; padding:0;">${copPsnName!''}，<a href="${frdUrl!''}${proLogin1!''}${locale!''}"   target="_blank" style="text-decoration:none;"><span style=" color:#55b1f5;">${psnName!''}</span></a> 认领了以下论文，你是合作者吗？</p>
            </td>
          </tr>
          <tr>
            <td height="15">&nbsp;</td>
           ...
           <#if (pubInfo0?exists)>
            <td>
                <table border="0" cellspacing="0" cellpadding="0" style=" width:100%; font-family:Arial, Helvetica,'Microsoft YaHei'; font-size:14px; color:#333333; background:#fff; padding:20px; border:1px solid #eaeaea; line-height:150%;">
                  <tr>
                    <td rowspan="4" valign="top"><a href="${pubUrl0!''}${proLogin20!''}${locale!''}"  target="_blank" style=" border:none; padding:0; margin:0; float:left; margin-right:20px;"><img src="https://www.scholarmate.com/resscmwebsns/images_v5/fulltextImg/scm_pdf.jpg" width="66" height="78" style="border:1px solid #e2e2e2;" ></a>
                    ...
                    <a href="${pubAllUrl!''}${proLogin9!''}${locale!''}"   target="_blank" style=" height:26px; padding:0 20px; margin:0; margin-right:10px; line-height:26px; color:#fff; text-decoration:none; background:#55b1f5; border:1px solid #49a0e0; display:inline-block;">我是合作者</a>
                    <a href="${pubAllUrl!''}${proLogin9!''}${locale!''}"  target="_blank" style=" height:26px; padding:0 20px; margin:0; margin-right:10px; line-height:26px; color:#666666; text-decoration:none; background:#ffffff; border:1px solid #c9cdd1; display:inline-block;">不是我的</a>
                    <a href="${frdPubAllUrl!''}${proLogin16!''}${locale!''}"  target="_blank" style=" height:26px; padding:0 20px; margin:0; margin-right:10px; line-height:26px; color:#666666; text-decoration:none; background:#ffffff; border:1px solid #c9cdd1; display:inline-block;">查看</a>
                    </p>
                    </td>
                  </tr>
                </table>
          ...
          <tr>
            <td valign="bottom" style="  height:50px; font-size:14px; font-weight:bold;"><a href="${frdPubAllUrl!''}${proLogin16!''}${locale!''}"  target="_blank"  style="  width:100%; height:30px; text-align:center; margin:0; margin-right:10px; line-height:30px; color:#fff; text-decoration:none; background:#55b1f5; border:1px solid #49a0e0; display:inline-block;">查看全部</a></td>
          </tr>
          <tr>
