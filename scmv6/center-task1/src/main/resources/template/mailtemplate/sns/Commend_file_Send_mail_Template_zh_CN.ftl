	                ...
	                <td align="left" valign="top"><table width="100%" border="0" cellpadding="6" cellspacing="0" style="font-size:14px;">
	                  <tr>
	                    <td colspan="2" style="line-height:25px; font-size:14px;">
							...
							<#if total?number == 1>
								${psnName}向您分享了文件&nbsp;${minZhShareTitle}
							<#elseif (total?number > 1)>
								${psnName}向您分享了${minZhShareTitle}等${total}个文件
							</#if>
	                    </td>
	                  </tr>
	                  <tr>
	                        ...
	                        <table width="135" border="0" cellpadding="0" cellspacing="1" bgcolor="#6a8bbf">
	                          <tr>
	                            <td height="37" align="center" bgcolor="#d6e3f6"  style=" border-top:1px solid #ebf1fb;">
									<a href="${keycode_email_view_res_url}" style="font-size:14px; color:#3f68a8;text-align:center; line-height:37px; text-align:center; font-weight:bold; text-decoration:none;">查看更多</a>
								</td>
	                          </tr>
	                        </table>
	                        </td>
