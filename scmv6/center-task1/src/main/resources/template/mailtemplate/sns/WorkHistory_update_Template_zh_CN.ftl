        ...
        <td bgcolor="#FFFFFF"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td align="center" valign="top"><table width="100%" border="0" cellspacing="20" cellpadding="0" style="font-size:14px;">
              <tr>
                <td align="left" valign="top"><table width="100%" border="0" cellpadding="6" cellspacing="0" style="font-size:14px;">
                  <tr>
                    <td style="font-size:14px;"><span style="font-weight:bold;">${psnName}</span>，<a href="${frdUrl1!'#'}" style="font-weight:bold; color:#426cad; text-decoration:none;">${friendName}</a>更新了工作经历：</td>
                  </tr>
                  <tr>
                    <td bgcolor="#f9f9f9"><table width="100%" border="0" cellspacing="0" cellpadding="5" style="font-size:12px; color:#333;">
                      <tr>
                        <td width="35%" align="left" valign="top"><a href="${frdUrl2!'#'}" style="font-weight:bold; color:#426cad; font-size:12px; text-decoration:none;">${friendName!''}</a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="${frdWork1!'#'}" style="font-weight:bold; color:#426cad; text-decoration:none;">${workIns}</a><#if (workTitle?exists)>&nbsp;&nbsp;&nbsp;&nbsp;<a href="${frdWork2!'#'}" style="font-weight:bold; color:#426cad; text-decoration:none;">${workTitle!''}</a></#if></td>
                        </tr>
                      </table></td>
                  </tr>
                </table></td>
                ...
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td align="left" valign="middle"><table width="130" border="0" cellpadding="0" cellspacing="1" bgcolor="#6a8bbf">
                      <tr>
                        <td height="30" align="center" bgcolor="#d6e3f6"  style=" border-top:1px solid #ebf1fb;"><a href="${frdUrl3!'#'}" style="font-size:14px; color:#3f68a8;  text-align:center; line-height:30px; text-align:center; font-weight:bold; text-decoration:none;">查看个人主页</a></td>
                        </tr>
                      </table></td>
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="40" align="center" bgcolor="#f3f3f3" style="text-align:center; font-size:14px; color:#999999;">查看并祝贺好友升迁，与好友互动，保持良好关系。</td>
                    </tr>
                  </table>
            </td>
          </tr>
