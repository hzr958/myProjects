...
<body>
<!-- 页眉内容 (样式内容)-->
<#include "/bpo/base_header_en_US.ftl" encoding= "UTF-8">
<!-- 正文内容 (样式内容)-->
              ...
              <tr>
	            <td align="center" valign="top"><table width="100%" border="0" cellspacing="20" cellpadding="0" style="font-size:14px;">
	              <tr>
	                ...
	                <tr>
	                <td colspan="2" style="font-size:14px;">${senderName} invited you to use “Suggested Journals” for paper submission.</td>
	                </tr>
	                  <tr>
	                    ...
	                    <table width="100%" border="0" cellspacing="0" cellpadding="5" style="font-size:14px; line-height:16px;">
							<tr>
									...
									Click hyperlink below to find useful information:<br/><br/>
