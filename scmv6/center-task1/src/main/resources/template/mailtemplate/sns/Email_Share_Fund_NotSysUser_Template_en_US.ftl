                ...
                <table width="94%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
					  <td height="60" align="left" valign="middle" style="font-size:20px; font-family:Helvetica, Arial, '宋体'; font-weight:bold; color:#FFF;">
					  	ScholarMate: Connect people to innovate smart
					  </td>
                    </tr>
                </table>
				</td>
              ...
              <tr>
	            <td align="center" valign="top"><table width="100%" border="0" cellspacing="20" cellpadding="0" style="font-size:14px;">
	              <tr>
	                ...
	                <tr>
	                <td colspan="2" style="font-size:14px;">${senderName} invited you to use “Suggested Funding” for most suitable funding opportunities.</td>
	                </tr>
	                  <tr>
	                    <td colspan="2" valign="top" bgcolor="#f9f9f9">
						<!-- 正文显示内容 -->
	                    <table width="100%" border="0" cellspacing="0" cellpadding="5" style="font-size:14px; line-height:16px;">
							<tr>
						  	  	<td align="left" style="font-size:14px;">
									Click hyperlink below to find hidden opportunities:<br/><br/>
