...
<table width="600" border="0" align="center" cellpadding="0" bgcolor="#d0daea" cellspacing="10" style="font-family:Arial, Helvetica, '宋体'; font-size:12px; color:#333;">
  ...
  <tr style="font-size:14px;">
    <td style="line-height:25px;"><span style="font-weight:bold;">${psnName!''}</span>,${senderName!''} wrote:</td>
  </tr>
  <tr>
    <td align="left" valign="top" bgcolor="#f9f9f9"><table width="100%" border="0" cellspacing="0" cellpadding="5" style="font-size:12px; color:#005eac;">
   	 <tr>
        <td align="left"><a href="${viewUrl!'#'}" style="text-decoration:none; color:#005eac; font-size:12px;">${content}</a></td>
        </tr>
      </table></td>
             </tr>
                </table></td>
                ...
                <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td align="left" valign="middle"><table width="130" border="0" cellpadding="0" cellspacing="1" bgcolor="#6a8bbf">
                      <tr>
                        <td height="30" align="center" bgcolor="#d6e3f6"  style="border-top:1px solid #ebf1fb;"><a href="${viewUrl!''}" style="font-size:14px; color:#3f68a8; font-weight:bold;  text-align:center; line-height:30px; text-align:center; text-decoration:none;">View More</a></td>
                      </tr>
                    </table>
                    </td>
                    </tr>
