              ...
              <tr>
	            <td align="center" valign="top"><table width="100%" border="0" cellspacing="20" cellpadding="0" style="font-size:14px;">
	              <tr>
	                ...
	                <tr>
	                <td colspan="2" style="font-size:14px;">${senderName} invited you to use “Research Area Suggestion” to find the cutting-edge research fields and understand the most popular subject areas.</td>
	                </tr>
	                  <tr>
	                    ...
	                    <table width="100%" border="0" cellspacing="0" cellpadding="5" style="font-size:12px; line-height:16px;">
							<tr>
									...
									Click hyperlink below to gain more information:<br/><br/>
