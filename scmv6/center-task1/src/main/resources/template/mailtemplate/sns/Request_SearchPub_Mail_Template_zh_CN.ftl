...
<title>科研之友–请求您为其检索个人成果模板</title>
</head>
												...
												<td align="left" valign="top">
													<table width="100%" border="0" cellpadding="6"
														...
														<tr style="font-size: 14px;">
															<td colspan="2" style="line-height: 25px;"><span style="font-weight: bold;">
																	<#if (psnName?exists) >${psnName}，</#if> </span><br />
																${senderName}请求您为其从以下文献库检索并导入个人研究成果：
															</td>
														</tr>
														<tr>
															<td colspan="2" valign="top" bgcolor="#f9f9f9">
																...
																<table width="100%" border="0" cellspacing="0" cellpadding="5"
																	...
																	<tr>
																		<td align="left">${recommendReason}</td>
																	</tr>
																</table>
															</td>
														</tr>
																			...
																			<table width="135" border="0" cellpadding="0" cellspacing="1" bgcolor="#6a8bbf">
																				<tr>
																					<td height="37" align="center" bgcolor="#d6e3f6"  
																						style=" border-top:1px solid #ebf1fb;"><a href="${pubUrl}" 
																						style="font-size:14px; color:#3f68a8;text-align:center; line-height:37px; text-align:center; font-weight:bold; text-decoration:none;">立即检索</a>
																					</td>
																				</tr>
																			</table>
																		</td>
