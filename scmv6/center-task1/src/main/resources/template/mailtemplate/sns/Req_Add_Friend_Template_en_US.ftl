        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial, Helvetica, 'Microsoft YaHei'  ; font-size:14px; color:#333333;">
          <tr>
            <td style="font-size:14px; font-weight:bold; line-height:150%;">
                <p style="margin:0; padding:0;">${invitePsnName}，<span ><a href="${concernUrl!''}"  target="_blank"  style=" color:#55b1f5;text-decoration:none; ">${psnName}</a></span>  requested to be friend with you.</p>
            </td>
          </tr>
          <tr>
            <td height="15">&nbsp;</td>
          ...
          <tr>
            <td>
                <table border="0" cellspacing="0" cellpadding="0" style=" width:100%; font-family:Arial, Helvetica, 'Microsoft YaHei' ; font-size:14px; color:#333333; background:#fff; padding:20px; border:1px solid #eaeaea; line-height:150%;">
                  <tr>
                    <td rowspan="4" valign="top"><a href="${viewPsnUrl}"  target="_blank" style="border:none; padding:0; margin:0; float:left; margin-right:20px;"><img src="${avatars!'https://www.scholarmate.com/resscmwebsns/images_v5/fulltextImg/nofulltext_img.jpg'}" width="66" height="66" style="border:1px solid #e2e2e2;"></a>
                    <p style=" margin:0; padding:0; margin-left:84px;"><a  href="${viewPsnUrl}"   target="_blank" style="text-decoration:none;color:#333333;font-weight:bold;">${psnName}</a></p>
                    ...
                    <a href="${inviteUrl}" target="_blank" style=" height:26px; padding:0 20px; margin:0; margin-right:10px; line-height:26px; color:#fff; text-decoration:none; background:#55b1f5; border:1px solid #49a0e0; display:inline-block;">Add friend</a>
                    <a href="${concernUrl!''}"  target="_blank"  style=" height:26px; padding:0 20px; margin:0; margin-right:10px; line-height:26px; color:#666666; text-decoration:none; background:#ffffff; border:1px solid #c9cdd1; display:inline-block;">Follow</a>
                    </p>
                    </td>
                  </tr>
                </table>
