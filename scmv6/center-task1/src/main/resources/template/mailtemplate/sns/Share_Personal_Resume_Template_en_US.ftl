...
<title>
	ScholarMate- ${keycode_sharePsnName} shared publications
</title>
</head>
	                ...
	                <td align="left" valign="top"><table width="100%" border="0" cellpadding="6" cellspacing="0" style="font-size:14px;">
	                  <tr style="font-size:14px;">
	                    <td colspan="2" style="line-height:25px;">
	                    	Dear 
	                    	<span style="font-weight:bold;"><#if (resPsn?exists)>${resPsn},</#if></span><br />
		                    ${sendPsn} has shared his resume "${resumeName}",Please click these links to view: 
	                    </td>
	                  </tr>
	                  <tr>
