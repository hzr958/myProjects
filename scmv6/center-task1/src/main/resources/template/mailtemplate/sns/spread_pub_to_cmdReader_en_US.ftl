                        ...
                        <tr>
                          <td align="left" valign="top">
                                  ...
                                  <tr style="font-size:14px;">
                                    <td style="line-height:25px;">Dear <span style="font-weight:bold;">${readerName!''}</span>,<br/> The following paper is similar to your field of study. If you are interested, please click to view or download the full-text.</td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                    <td align="left" valign="top" bgcolor="#FFFFFF">Thank you very much.</td>
                                  </tr>
                                </table>
                          </td>
                        </tr>
                        <tr>
                          <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                ...
                                <td width="40%" align="left" valign="middle" style="line-height:22px;">Best Regards,<br/>
                                   ${authorName!''}<br />
                                  ${authorEmail!''}<br />
                                 ${data!''}</td>
                              </tr>
