	                ...
	                <td align="left" valign="top"><table width="100%" border="0" cellpadding="6" cellspacing="0" style="font-size:14px;">
	                  <tr style="font-size:14px;">
	                    <td colspan="2" style="line-height:25px;">
		                    ...
		                    You recently used Forget Password to recover your ScholarMate account for the email address: ${forgetEmail}.<br />

							From the email address you provided, we found ${users?size} matched result(s):
	                    </td>
	                  </tr>
	                  <tr>
						  	  	...
						  	  	<td align="left">
						  	  		<#list users as user>
									 	...
									 	${"Login account"+(user_index+1)}:<br />
									 	 Login Name:${user.loginName}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Name:${user.userName}<br />
