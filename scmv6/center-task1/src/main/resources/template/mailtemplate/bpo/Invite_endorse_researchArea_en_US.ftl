            ...
            <td>
                <table border="0" cellspacing="0" cellpadding="0" style=" width:100%; font-family:Arial, Helvetica,  'Microsoft YaHei'; font-size:14px; color:#333333; background:#fff; padding:20px; border:1px solid #eaeaea; line-height:150%;">
                    ...
                    <td rowspan="4" valign="top">
                     <#list raList as ra>
                        <span style=" font-size:14px;  font-weight: bold; margin: 8px 0px;  line-height:18px; text-align:center; text-decoration:none; border: 1px solid #ccc; padding:8px 20px 8px 4px; color:#666666; display: inline-block;">${ra}
                         <a href="${psnUrl!'#'}" style=" font-size: 14px;  margin: 8px 0px;  line-height:18px; font-weight: bold; text-align:center;margin-right:-21px; text-decoration:none; border: 1px solid #ccc; border: none; padding: 9px 10px;color:forestgreen;  box-sizing: content-box; border-left: 1px solid #ddd; border-right: none; display: ruby-base;">+</a>
                        </span>
                    </#list>
                   	</br>
