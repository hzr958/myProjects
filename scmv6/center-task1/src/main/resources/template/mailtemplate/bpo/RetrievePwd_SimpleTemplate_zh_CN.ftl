	              ...
	              <tr>
	                <td align="left" valign="top"><table width="100%" border="0" cellpadding="6" cellspacing="0" style="font-size:14px;">
	                  <tr style="font-size:14px;">
	                    <td colspan="2" style="line-height:25px;">
	                    	<span style="font-weight:bold;">
		                    	${userName}，你的密码重置要求已经得到验证。请在24小时内点击重置密码。
		                    </span>
	                    </td>
	                  </tr>
	                  <tr>
	                 ...
	                 <tr>
	                        ...
	                        <table width="190" border="0" cellpadding="0" cellspacing="1" bgcolor="#6a8bbf">
	                          <tr>
								<td height="37" align="center" bgcolor="#55b1f5"  style=" border-top:1px solid #55b1f5;">
									<a href="${resetUrl}" target="_blank" style=" height:26px; padding:0 20px; margin:0; margin-right:10px; line-height:26px; color:#fff; text-decoration:none; background:#55b1f5; display:inline-block;">重置密码</a>
								</td>
	                          </tr>
	                        </table>
	                        </td>
	                  ...
	                  <tr>
	                  <td><p>感谢对科研之友的支持，再次希望你在科研之友的体验有益和愉快<p></td>
	                  </tr>
	                  
	                  
	                  <tr>
	                  <td><span>科研之友：<span><a href="http://www.scholarmate.com" target="_blank" style="text-decoration:none;color:#55b1f5;"> http://www.scholarmate.com</a></td>
	                  </tr>
	                </table>
	              </td>
              </tr><!--替换内容end-->
