          ...
          <tr>
            <td>
                <table border="0" cellspacing="0" cellpadding="0" style=" width:100%; font-family:Arial, Helvetica, 'Microsoft YaHei'; font-size:14px; color:#333333; background:#fff; padding:20px; border:1px solid #eaeaea; line-height:150%;">
                  <tr>
                    <td rowspan="4" valign="top"><a href="${psnUrl!'#'}"   target="_blank" style=" border:none; padding:0; margin:0; float:left; margin-right:20px;"><img src="${avatars}" width="66" height="78" style="border:1px solid #e2e2e2;" ></a>
                   
                     <p style="color:#999999; margin:0; padding:0; margin-left:84px;"><a href="${psnUrl!'#'}"   target="_blank"  style="font-weight:bold; text-decoration:none; color:#426cad;">${frdPsnName}</a>
                       <span style="color:#000000"> endorsed your research areas:
                    ...
                    <a href="${psnUrl}%26src%3ddiscipline_box"  target="_blank" style=" height:26px; padding:0 20px; margin:0; margin-right:10px; line-height:26px; color:#fff; text-decoration:none; background:#55b1f5; border:1px solid #49a0e0; display:inline-block;">View More</a>
                    </p>
                    </td>
                  </tr>
                </table>
