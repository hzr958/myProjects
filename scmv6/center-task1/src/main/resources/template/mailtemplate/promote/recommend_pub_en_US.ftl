              ...
              <tr>
                ...
                <table width="100%" border="0" cellpadding="6" cellspacing="0" style="font-size:14px;">
						  <tr style="font-size:14px;">
						    <td style="line-height:25px;"><span style="font-weight:bold;">${psnName!''}</span>, ${pubSize!''} newly published journal papers you may be interested in:</td>
						  </tr>
						   <#list pubList as pub >
							  <tr>
                ...
                <td align="left" valign="top">
                 ...
                 <tr>
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
	                          <tbody><tr>
	                            <td width="26%" valign="middle" align="left"><table width="130" border="0" bgcolor="#6a8bbf" cellspacing="1" cellpadding="0">
	                                <tbody><tr>
	                                  <td height="30" bgcolor="#d6e3f6" align="center" style=" border-top:1px solid #ebf1fb;"><a style="font-size:14px; color:#3f68a8;  text-align:center; line-height:30px; text-align:center; text-decoration:none; font-weight:bold;" href="${InterestPubUrl!'#'}">Read & Save</a></td>
	                                </tr>
	                              </tbody></table></td>
	                            <td valign="middle" align="left"><table width="130" border="0" bgcolor="#6a8bbf" cellspacing="1" cellpadding="0">
	                                <tbody><tr>
	                                  <td height="30" bgcolor="#d6e3f6" align="center" style=" border-top:1px solid #ebf1fb;"><a style="font-size:14px; color:#3f68a8;  text-align:center; line-height:30px; text-align:center; text-decoration:none; font-weight:bold;" href="${InterestPubUrl!'#'}">View More</a></td>
	                                </tr>
	                              </tbody></table></td>
	                             </tr>
                        	</tbody>
                  ...
                  <tr>
                   ...
                   <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="40" align="center" bgcolor="#f3f3f3" style="text-align:center; font-size:14px; color:#999999;">Keep updated of new publications at ScholarMate</td>
                    </tr>
                  </table>
              </tr>
            </table></td>
