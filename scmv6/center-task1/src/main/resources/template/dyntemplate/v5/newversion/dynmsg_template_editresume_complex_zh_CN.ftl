<li onmouseover="dynMsgUtil.showDynOperation(this)"  onmouseout="dynMsgUtil.hideDynOperation(this)">
    ...
    <div class="publish-nr">
      <div class="moving-contat"><a href="/scmwebsns/resume/psnView?des3PsnId=${des3PsnId}&menuId=<#if (isGroupFlag==1)>3<#else>1100</#if>" target="_blank" class="Blue">${psnName}</a>修改了<#list resumeDetails as resume><#switch resume.resumeType><#case 0>基本信息<#break><#case 1>联系方式<#break><#case 2>教育经历<#break><#case 3>工作经历<#break><#case 4>研究领域<#break><#case 5>个人简介<#break><#default></#switch><#if resume_has_next>、</#if></#list></div>
