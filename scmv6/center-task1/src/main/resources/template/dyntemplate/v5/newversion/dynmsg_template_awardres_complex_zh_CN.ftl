<li onmouseover="dynMsgUtil.showDynOperation(this)"  onmouseout="dynMsgUtil.hideDynOperation(this)">
    ...
    <div class="publish-nr">
      ...
      <#list awarderDetails as awarder><a href="/scmwebsns/resume/psnView?des3PsnId=${awarder.awarder_des3PsnId}&menuId=<#if (isGroupFlag==1)>3<#else>1100</#if>" target="_blank" class="Blue">${awarder.awarder_psnName}</a><#if awarder_has_next>、</#if></#list>赞了<#if resOwner_des3PsnId?exists><a href="/scmwebsns/resume/psnView?des3PsnId=${resOwner_des3PsnId}&menuId=<#if (isGroupFlag==1)>3<#else>1100</#if>" target="_blank" class="Blue">${resOwner_psnName }</a>的</#if><#switch resType><#case 0>分享<#break><#case 1>成果<#break><#case 2>文献<#break><#case 3>文件<#break><#case 4>项目<#break><#case 5>课件<#break><#case 8>群组<#break><#case 9>简历<#break><#case 19>工作经历<#break><#case 20>教育经历<#break><#case 21>研究领域<#break><#default>资源</#switch>：
      </div>
         ...
         <#list resReplyDetails as resReply>
          <dd class="reply_item_${resReply.recordId?c}">
            ...
            <div class="t_message2">
              ...
              <p class="en10">${resReply.replyDate}&nbsp;&nbsp;<span class="reply_operation" style="display:none;"><a style="cursor:pointer" receiverPsnName="${resReply.replyerName}" receiverPsnLink="/scmwebsns/resume/psnView?des3PsnId=${resReply.des3ReplyerId}&menuId=<#if (isGroupFlag==1)>3<#else>1100</#if>" target="_blank" onclick="dynMsgUtil.replyToPsn('${resId?c}','${resType}','${resNode}','${dynId?c}','${resReply.des3ReplyerId}',event, this)" class="Blue" title="回复"><i class="evaluate-icon"></i></a>&nbsp;<#if (isResOwner==1 || resReply.replyerId==currentPsnId)><a onclick="dynMsgUtil.deleteReply('${dynId?c}','${resReply.recordId?c}','${resId?c}','${resType}','${resNode}',event, this)" style="cursor:pointer" class="Blue" title="删除"><i class="delete-icon"></i></a></#if></span></p>
            </div>
          </dd>
    ...
    <div class="drop_down"><a style="cursor:pointer;display:none;" onmouseover="dynMsgUtil.extendDynOperation(this)" onmouseout="dynMsgUtil.shrinkDynOperation(this)" class="link_delete"></a>
        ...
        <div class="drop_jt_zh_CN"></div>
           <ul>
             <#if (isMine==1)>
               <li><a style="cursor:pointer; border-width:0;" onclick="dynMsgUtil.ajaxDeleteDyn('${dynId?c}')"><i class="img_nochoose"></i>删除此动态</a></li>
               <!--<li><a style="cursor:pointer;" onclick="dynMsgUtil.ajaxShieldDynByType('01','${dynId?c}')"><i class="img_nochoose"></i>屏蔽此类动态</a></li>-->
             <#else>
               <li><a style="cursor:pointer; border-width:0;" onclick="dynMsgUtil.ajaxDeleteDyn('${dynId?c}')"><i class="img_nochoose"></i>删除此动态</a></li>
