<li onmouseover="dynMsgUtil.showDynOperation(this)"  onmouseout="dynMsgUtil.hideDynOperation(this)">
    ...
    <div class="publish-nr">
      <div class="moving-contat">
       <a href="/scmwebsns/resume/psnView?des3PsnId=${des3PsnId}&menuId=<#if (isGroupFlag==1)>3<#else>1100</#if>" target="_blank" class="Blue">${psnEnName}</a><label style="color:#999"> updated research areas:</label>
      ...
      <div class="appraisa-choose">
        <p class="t_detail">
             ...
             <#if dynDate=='dateTime'>${normalEnDynDate}<#else>${dynDate} ago</#if>
        		 ...
        		 <#if (isMine!=1)>
        		 <a class="Blue" href="/scmwebsns/resume/psnView?des3PsnId=${des3PsnId}&src=discipline_box" target="_blank">Endorse your friend</a>
        		 </#if>
        </p>
      </div>
