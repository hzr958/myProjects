<li onmouseover="dynMsgUtil.showDynOperation(this)" onmouseout="dynMsgUtil.hideDynOperation(this)">
    ...
    <div class="publish-nr">
      <div class="moving-contat"><a href="/scmwebsns/resume/psnView?des3PsnId=${des3PsnId}&menuId=<#if (isGroupFlag==1)>3<#else>1100</#if>" target="_blank" class="Blue">${psnName}</a>分享群组：${sayContent}</div>
      <div class="reproduced">
        <div class="dyn_img"><a href="${groupPage}&menuId=1100"><img src="${groupAvatar}" width="32" height="32" title="groupName"></a></div>
