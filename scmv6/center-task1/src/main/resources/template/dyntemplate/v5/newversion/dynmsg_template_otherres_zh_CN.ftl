...
<#list resDetails as dynRes>
  <div class="txt_box">
    ...
    <span class="icon_${dynRes.fileExt}">&nbsp;</span><a onclick="dynMsgUtil.ajaxDownloadRes(this, '${resType}','${dynRes.resNode}','${dynRes.resId?c}')" class="Blue">${dynRes.resTitle}</a>
    <#else>
  ...
  <div class="appraisa-choose">
        <div class="t_detail">
        <span class="f888 date01"> ${dynDate}&nbsp;&nbsp;&nbsp;&nbsp;</span>
