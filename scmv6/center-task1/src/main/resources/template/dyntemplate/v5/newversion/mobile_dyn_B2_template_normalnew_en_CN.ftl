        ...
        <div class="dynamic-social__list">
            ...
            <div class="dynamic-social__item dynamic-social__item_mobile dev_save" style="padding:0px!important; font-size: 12px;" onClick="dynamic.dynCollectPub('${DES3_DYN_ID}','${DYN_TYPE}','${DES3_RES_ID}','${RES_TYPE}',event);"><a title="Save">Save</a></div>      
        </div>