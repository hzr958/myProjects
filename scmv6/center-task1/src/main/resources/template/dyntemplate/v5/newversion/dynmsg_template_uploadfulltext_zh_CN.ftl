<li onmouseover="dynMsgUtil.showDynOperation(this)"  onmouseout="dynMsgUtil.hideDynOperation(this)">
    ...
    <div class="publish-nr">
      <div class="moving-contat"><a href="/scmwebsns/resume/psnView?des3PsnId=${des3PsnId}&menuId=<#if (isGroupFlag==1)>3<#else>1100</#if>" target="_blank" class="Blue">${psnName}</a>上传了一篇<#switch resType><#case 1>成果<#break><#case 2>文献<#break><#case 4>项目<#break></#switch>的全文
	  </div>
     ...
     <#list resDetails as dynRes>
      <div class="txt_box">
        ...
        <#else>
        <p><a href="${dynRes.imgIcPath}" class="gallery_link thickbox" rel="gallery-plants${dynId?c}${dynId?c}" title="${dynRes.resTitle}"><img src="${dynRes.imgIc}"/></a></p>
      ...
      <div class="appraisa-choose">
        ...
        <div class="t_detail"><span class="f888 date01">${dynDateVar}&nbsp;&nbsp;&nbsp;&nbsp;</span>
	        ...
	        <div class="praise_box" style="margin-left:20px;">
		        ...
		        <#if (isMine!=1)&&(resType==1||resType==2)>
		      	<span class="fe6e6 mright10">|</span>
