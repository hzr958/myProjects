<li onmouseover="dynMsgUtil.showDynOperation(this)"  onmouseout="dynMsgUtil.hideDynOperation(this)">
    ...
    <div class="publish-nr">
      <div class="moving-contat">
        <a href="/scmwebsns/resume/psnView?des3PsnId=${des3PsnId}&menuId=<#if (isGroupFlag==1)>3<#else>1100</#if>" target="_blank" class="Blue">${psnEnName}</a> updated the <#switch resumeType><#case 0>basic information<#break><#case 1>contact<#break><#case 2>education experience<#break><#case 3>work experience<#break><#case 4>research area<#break><#case 5>brief<#break><#default></#switch>
      </div>
