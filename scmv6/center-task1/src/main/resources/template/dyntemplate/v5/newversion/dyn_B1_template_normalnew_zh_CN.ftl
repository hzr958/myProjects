		...
		<div class="dynamic-creator__box">
          <div class="dynamic-creator__info"><a class="dynamic-creator__name" onclick="dynamic.openPsnDetail('${DES3_PRODUCER_PSN_ID}' ,event)">${PERSON_NAME_ZH?if_exists }</a>${OPERATOR_TYPE_ZH?if_exists }</div>
        </div>
