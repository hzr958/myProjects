<li onmouseover="dynMsgUtil.showDynOperation(this)"  onmouseout="dynMsgUtil.hideDynOperation(this)">
    ...
    <div class="publish-nr">
      <div class="moving-contat"><a href="/scmwebsns/resume/psnView?des3PsnId=${des3PsnId}&menuId=<#if (isGroupFlag==1)>3<#else>1100</#if>" target="_blank" class="Blue">${psnEnName}</a> likes <#if resOwner_des3PsnId?exists><a href="/scmwebsns/resume/psnView?des3PsnId=${resOwner_des3PsnId}&menuId=<#if (isGroupFlag==1)>3<#else>1100</#if>" target="_blank" class="Blue">${resOwner_psnEnName }</a>'s </#if><#switch resType><#case 0>status<#break><#case 1>publication<#break><#case 2>reference<#break><#case 3>file<#break><#case 4>project<#break><#case 5>course material<#break><#case 8>group<#break><#case 9>resume<#break><#case 19>work experience<#break><#case 20>education<#break><#case 21>research areas<#break><#default></#switch>:</div>
