        ...
        <div class="dynamic-content">
          <div class="dynamic-content__post">
            ...
            <div class="dynamic-post__main"  onclick="dynamic.openPsnDetail('${DES3_PRODUCER_PSN_ID}' ,event)">
              <div class="dynamic-post__author" > <a class="dynamic-post__author_name">${ PERSON_NAME_EN?if_exists }</a> </div>
        ...
        <div class="dynamic-social__list">
          ...
          <div class="dynamic-social__item dynamic-social__item_mobile dev_commentcount_${DYN_ID?c }" style="padding:0px!important; font-size: 12px;" onclick="dynamic.replyDyn(${RES_TYPE},'${DES3_RES_ID}', '${DYN_TYPE}', '${DES3_DYN_ID}',event)"><a>Comment</a></div>
             <#if (RES_TYPE!=0)>
          <div class="dynamic-social__item dynamic-social__item_mobile dev_sharecount_${DYN_ID?c }"  style="padding:0px!important; font-size: 12px;"  resType="${RES_TYPE}"  resId="${RES_ID?c}"  dynType="${DYN_TYPE}" databaseType="${PDWH_URL ?if_exists}" dynId="${DYN_ID?c}"  parentDynId="${PARENT_DYN_ID?c}" 
          	 onclick="dynamic.shareDynMain('${DES3_DYN_ID}','${DYN_TYPE}','${DES3_RES_ID}','${RES_TYPE}',event);"
            ><a>Share</a></div>
             <div class="dynamic-social__item dynamic-social__item_mobile dev_save" onClick="dynamic.dynCollectPub('${DES3_DYN_ID}','${DYN_TYPE}','${DES3_RES_ID}','${RES_TYPE}',event);" style="padding:0px!important; font-size: 12px;"><a>Save</a></div>
          </#if> 
        </div>