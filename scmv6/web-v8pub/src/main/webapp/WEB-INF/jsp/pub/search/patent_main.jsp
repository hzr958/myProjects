...
$(function(){
	...
	if(searchString!==null&&searchString!=""){
		...
		//PdwhPubSearch.ajaxsearch("/pub/search/ajaxpatentleftmenu",data,".cont_l");
	}
	//SCM-13624
...
page.showPubList = function(data){
    window.Mainlist({
        name: "pdwhPatenlist",
        listurl: "/pub/search/ajaxpdwhpatentlist",
        listdata: data,
        method: "scroll",
        noresultHTML:noresultHTML,
        listcallback: function(xhr) { 
            var count = $("#pubListTal").attr("total-count");
            count = !count ? 0 : count;            
            if(count==0){
...
page.backSearch = function(str){
	...
	var data = {
			...
			"searchPatYear":searchYear,
			"searchPatTypeId":searchType,
			"orderBy":orderBy,
			"language":language
	};
	page.showPubList(data);
...
<body>
  ...
  <div class="result_class">
    <div class="result_class_wrap">
      <ul>
        ...
        <li id="search_patent" class="cur" onclick="select_search_menu('/pub/search/pdwhpatent');"><a
  ...
  <div id="content" style="display: flex; padding-bottom: 0px;">
    <div class="cont_l" style="width: 280px;"></div>
    <div class="cont_r" style="overflow-x: hidden; max-width: 880px;">
      <div class="sorting_box" id="sortingbox" style="display: flex; align-items: center; justify-content: space-between;">
        <span class="f999"><spring:message code='pub.menu.search.resultPre' /> <span id="pubTotalCountMsg"></span>
        </span> 
<%--       <span class='checked fr' id="defsort" name='typeSpan' checked='false'
          onclick="page.searchBySort('DEFAULT',this)"><spring:message code='pub.menu.list.relate' /></span> 
          <span
          id="yearsort" class='unchecked fr' name='typeSpan' checked='false' onclick="page.searchBySort('YEAR',this)"><spring:message
            code='pub.menu.list.pubYear' /></span>  --%>
      ...
      <div class="main-list__list" id='pubListTal' list-main='pdwhPatenlist' style="min-height: 700px;  margin-bottom: 100px;"></div>
