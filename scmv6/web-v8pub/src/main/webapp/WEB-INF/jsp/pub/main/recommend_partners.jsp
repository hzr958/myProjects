...
<div class="dialogs__box closeUpdate"
  ...
  <div style="color: #333; font-size: 14px; height: 70px; line-height: 24px; text-align: center; padding-top: 12px;">
    <spring:message code="pub.update.nubmers" />
  </div>
  <div style="display: flex; justify-content: center; height: 64px; margin-top: 20px;">
