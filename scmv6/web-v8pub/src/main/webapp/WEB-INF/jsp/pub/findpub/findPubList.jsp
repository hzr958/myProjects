          ...
          <div class="file-rigth-box">
            ...
            <div class="new-Standard_Function-bar">
              ...
              <a href="${pubInfo.pubIndexUrl}" class="tmanage-one mr20" style="">
                ...
                <span class="new-Standard_Function-bar_item-title"> <spring:message code="maint.pubview.label.comment" />
...
<%-- <input type='hidden' id="curPage" value='${pubListVO.pageNo}' />
<input type="hidden" value="${pubListVO.totalPages}" /> --%>
