...
$(function(){
    ...
    if(href.indexOf("/pub/search/pdwhpaper") > 0 || href.indexOf("pub/search/psnsearch") > 0){
      $("#search_person").removeClass("cur");
      $("#search_paper").addClass("cur");
      $(".paperContent").css("display","block");
      $(".psnContent").css("display","none");
      page.showPubList(data);
      //PdwhPubSearch.ajaxsearch("/pub/search/ajaxpaperleftmenu",data,".cont_l");
    }else{
      var patrn=/^-?[1-9]\d*$/; 
      if (patrn.test(searchString) && searchString.length==8){
        $("#search_paper").removeClass("cur");
        $("#search_person").addClass("cur");
        $(".psnContent").css("display","block");
...
<body style="overflow: hidden;">
  ...
  <div id="content" class="paperContent" style="display:none; padding: 0px;">
  ...
  <div id="content" class="psnContent" style="display:none">
    <input id="searchString" type="hidden" value="${searchString }" />
    <div id="psnList"></div>
  </div>
  </div>
