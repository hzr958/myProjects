      ...
      <div class="filter-list vert-style option_has-stats" list-filter="psnpub">
        <div class="filter-list__section js_filtersection" filter-section="orderBy" filter-method="compulsory"
          ...
          <ul class="filter-value__list">
            <li class="filter-value__item js_filtervalue sort-container_item-list" filter-value="publishYear" style="padding: 0px; margin: 0px;">
              ...
              <div class="filter-value__option js_filteroption sort-container_item_name"
                style="font-size: 14px !important; margin: 0px -10px; padding-left: 34px;">
                <spring:message code="pub.filter.recentPublish" />
              </div>
              <div class="filter-value__stats js_filterstats"></div>
            </li>
            <li class="filter-value__item js_filtervalue sort-container_item-list" filter-value="updateDate" style="padding: 0px; margin: 0px;">
              <div class="input-custom-style">
                <input type="checkbox"><i class="material-icons custom-style"></i>
              </div>
              <div class="filter-value__option js_filteroption sort-container_item_name"
            ...
            <li class="filter-value__item js_filtervalue sort-container_item-list" filter-value="citedTimes" style="padding: 0px; margin: 0px;">
              <div class="input-custom-style">
                <input type="checkbox"> <i class="material-icons custom-style"></i>
              </div>
              <div class="filter-value__option js_filteroption sort-container_item_name"
            ...
            <li class="filter-value__item js_filtervalue sort-container_item-list" filter-value="title" style="padding: 0px; margin: 0px;">
              <div class="input-custom-style">
                <input type="checkbox"> <i class="material-icons custom-style"></i>
              </div>
              <div class="filter-value__option js_filteroption sort-container_item_name"
