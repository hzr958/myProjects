...
public class OpenSnsPubDetailQueryService extends AbstractPubDetailQueryService implements PubDetailQueryService {
  ...
  public PubDetailVO queryPubDetail(Long pubId, Long grpId) throws ServiceException {
    ...
    pubDetailVO.setStatus(pub.getStatus().getValue());
