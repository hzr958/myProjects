...
import com.smate.web.v8pub.po.sns.Friend;
...
public class FriendDao extends SnsHibernateDao<Friend, Long> {
  ...
  public List<Friend> findFriendByPsnId(Long psnId) {
    return findBy("psnId", psnId);
  }

  public List<Friend> findByFriendPsnId(Long friendPsnId) {
  ...
  public List<Friend> findFriendAutoRecommend(Long psnId) {
    String hql =
        "select t1 from Friend t1,Person t2 where t1.friendPsnId=t2.personId and not exists(select 1 from PsnPrivate pp where pp.psnId=t1.friendPsnId) and t2.isLogin=1 and t1.psnId=?";
    Query q = createQuery(hql, new Object[] {psnId});
  ...
  public Long findFriendIds(Long friendId) {
    String hql = "select count(*) from Friend where friendPsnId=?";
    return findUnique(hql, friendId);
  }

  @SuppressWarnings("unchecked")
  public List<Long> findFriend(Long psnId) {
    String hql = "select friendPsnId from Friend t where psnId=:psnId and t.friendPsnId is not null";
    return super.createQuery(hql).setParameter("psnId", psnId).list();
  }

  public Friend getFriendByPsn(Long psnId, Long friendPsnId) {
  ...
  public Long getFriendId(Long psnId, Long friendPsnId) {
   ...
   */
  @SuppressWarnings("unchecked")
  public List<Object[]> autoFindFriend(String param, String psnIds, Integer size) {
    String hql =
   ...
   */
  @SuppressWarnings("unchecked")
  public List<Object[]> autoFindFriendFull(String param) {
    String hql =
   ...
   */
  @SuppressWarnings({"unchecked"})
  public Page<Friend> findFriend(Page<Friend> page, Friend friend, String existPsnIds) {
    List<Object> params = new ArrayList<Object>();
    StringBuffer hql = new StringBuffer();
  ...
  @SuppressWarnings("unchecked")
  public Friend getFriend(Long friendPsnId, Long currentPsnId) {
    StringBuffer hql = new StringBuffer();
    hql.append(
  ...
  @SuppressWarnings("unchecked")
  public Page<NodePerson> findFriendElse(Map<String, String> nameByParams, List<Long> disciplines,
      List<Long> exisPsnIds, Page<NodePerson> page) {
    String psnName = nameByParams.get("psnName");
    String firstName = nameByParams.get("firstName");
    String lastName = nameByParams.get("lastName");
    String workName = nameByParams.get("workName");
    String schoolName = nameByParams.get("schoolName");
    String hql = createHql(psnName, firstName, lastName, workName, schoolName, disciplines, exisPsnIds);
    Long count = 0L;
    ...
    q1.setParameterList("paramIds2", exisPsnIds.size() > 99 ? exisPsnIds.subList(0, 99) : exisPsnIds);
    try {
    ...
    if (count != null && count > 0) {
      Query q2 = createQuery(hql);
      q2.setParameterList("paramIds2", exisPsnIds.size() > 99 ? exisPsnIds.subList(0, 99) : exisPsnIds);
      page.setTotalCount(count);
      q2.setFirstResult(page.getFirst() - 1);
      q2.setMaxResults(page.getPageSize());
      List<Object[]> objList = q2.list();
      if (CollectionUtils.isNotEmpty(objList)) {
        List<NodePerson> list = new ArrayList<NodePerson>();
        for (Object[] objects : objList) {
          int j = 0;
          NodePerson psn = new NodePerson();
          psn.setPsnId(Long.valueOf(String.valueOf(objects[j])));
          if (objects[++j] != null) {
            psn.setPsnName(String.valueOf(objects[j]));
          }
          if (objects[++j] != null) {
            psn.setFirstName(String.valueOf(objects[j]));
          }
          if (objects[++j] != null) {
            psn.setLastName(String.valueOf(objects[j]));
          }
          if (objects[++j] != null) {
            psn.setPsnEmail(String.valueOf(objects[j]));
          }
          if (objects[++j] != null) {
            psn.setPsnTitle(String.valueOf(objects[j]));
          }
          if (objects[++j] != null) {
            psn.setPsnHeadUrl(String.valueOf(objects[j]));
          }
          if (objects[++j] != null) {
            psn.setInsName(String.valueOf(objects[j]));
          }
          if (objects[++j] != null) {
            psn.setRegionId(Long.parseLong(String.valueOf(objects[j])));
          }
          list.add(psn);
        }
        page.setResult(list);
  ...
  @SuppressWarnings("unchecked")
  public List<Long> getCancelFriendAttList() {
    String hql =
  ...
  public void updateLoginStatus(Long psnId, int status) {
    String hql = "update Friend set status=? where friendPsnId=?";
    createQuery(hql, status, psnId).executeUpdate();
  }

  public ConstDiscipline getConstDiscipline(Long id) {
    return findUnique("from ConstDiscipline where id=?", id);
  }
   ...
   */
  @SuppressWarnings("unchecked")
  public List<Friend> findMyFriendByName(String name, Long currentPsnId) {
    String hql =
   ...
   * @return @
   */
  public Long getUnreadInviteMsg(Long psnId) {
    return findUnique(
