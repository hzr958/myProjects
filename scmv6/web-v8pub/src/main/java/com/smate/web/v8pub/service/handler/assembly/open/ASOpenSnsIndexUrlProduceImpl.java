...
public class ASOpenSnsIndexUrlProduceImpl implements PubHandlerAssemblyService {
  ...
  public Map<String, String> excute(PubDTO pub) throws PubHandlerAssemblyException {
    try {
      ...
      pub.pubIndexUrl = pubIndexUrlService.producePubShortUrl(pub.pubId, ShortUrlConst.A_TYPE);
      pub.pubLongIndexUrl = pubIndexUrlService.producePubShortUrl(pub.pubId, ShortUrlConst.AT_TYPE);
      logger.debug("sns库生成成果短地址成功");
    } catch (Exception e) {
      logger.error("生成成果短地址异常！pubId={}", pub.pubId, e);
      throw new PubHandlerAssemblyException(this.getClass().getSimpleName() + "个人库生成成果短地址出错！", e);
    }
    return null;
  }
