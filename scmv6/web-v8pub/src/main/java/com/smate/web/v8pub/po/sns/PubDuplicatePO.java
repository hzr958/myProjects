...
@Entity
@Table(name = "V_PUB_DUPLICATE")
public class PubDuplicatePO implements Serializable {

  private static final long serialVersionUID = 3114534382316607651L;
  ...
  public String toString() {
    return "PubDuplicatePO{" + "pubId='" + pubId + '\'' + ", hashTP='" + hashTP + '\'' + ", hashTTP='" + hashTPP + '\''
