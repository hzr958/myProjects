...
public class V8pubConst {
  ...
  public static final String PUB_DEFAULT_FULLTEXT_IMG_NEW = "/resmod/images_v5/images2016/file_img1.jpg";
  ...
  static {
    ...
    typeMap.put(12, "standard"); // 标准
    typeMap.put(13, "software_copyright"); // 软件著作权
    ...
    typeMapZh.put(12, "标准"); // 标准
    typeMapZh.put(13, "软件著作权"); // 软件著作权

    typeMapEn.put(1, "Award"); // 奖励
    typeMapEn.put(2, "Book / Monograph"); // 书/著作
    typeMapEn.put(3, "Conference Paper"); // 会议论文
    typeMapEn.put(4, "Journal Article"); // 期刊论文
    typeMapEn.put(5, "Patent"); // 专利
    typeMapEn.put(7, "Others"); // 其他
    typeMapEn.put(8, "Thesis"); // 学位论文
    typeMapEn.put(10, "Book Chapter"); // 书籍章节
    typeMapEn.put(12, "Standard"); // 标准
    typeMapEn.put(13, "Software Copyright"); // 软件著作权
  ...
  public final static String DESC_PUB_ID = "des3PubId"; // 成果id
