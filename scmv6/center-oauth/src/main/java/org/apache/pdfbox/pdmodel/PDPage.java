...
public class PDPage implements COSObjectable, PDContentStream {
  ...
  /**
   * A rectangle, expressed in default user space units, defining the visible region of default user
   * space. When the page is displayed or printed, its contents are to be clipped (cropped) to this
   * rectangle.
   */
  ...
  /**
   * A rectangle, expressed in default user space units, defining the region to which the contents of
   * the page should be clipped when output in a production environment. The default is the CropBox.
   * 
  ...
  /**
   * A rectangle, expressed in default user space units, defining the extent of the page's meaningful
   * content (including potential white space) as intended by the page's creator The default is the
   * CropBox.
   * 
   ...
   *
   * @return The rotation angle in degrees in normalized form (0, 90, 180 or 270) or 0 if invalid or
   ...
   *
   * @return A list of article threads on this page, never null. The returned list is backed by the
   *         beads COSArray, so any adding or deleting in this list will change the document too.
   */
   ...
   * 
   * @param transition The new transition to set on this page.
   * @param duration The maximum length of time, in seconds, that the page shall be displayed during
   *        presentations before the viewer application shall automatically advance to the next page.
   */
   ...
   *         annotations COSArray, so any adding or deleting in this list will change the document
   *         too.
   * 
  ...
  public PDFReadForm getReadForm() {
    return readForm;
  }

  public void setReadForm(PDFReadForm readForm) {
