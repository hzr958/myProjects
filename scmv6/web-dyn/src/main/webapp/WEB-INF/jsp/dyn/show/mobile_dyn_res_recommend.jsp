...
<c:if test='${dynRemdResList.size() ge 1 }'>
  <div class="main-list__read-item global__padding_0 dyn_pageready_read main-list__item-noborder">
          ...
          <div class="dynamic-content__main">
            <div class="dynamic-main__setbox" style="flex-direction: column;">
              <div class="dynamic-main__att new-Recommend_container" style="width: 100%;">
                  ...
                  <c:if test="${ft.type == 1}">
                    <c:if test="${ft.hasFulltext == 1}">
                      <div class="file-left file-left__border  file-left__download " style="position: relative;"
                        ...
                        <img src="${empty ft.fullTextUrl ? false :ft.fullTextUrl}" name="fullImg"
                          des3ResId="${ft.des3ResId}" onerror="this.onerror=null;this.src='${resmod}/images_v5/images2016/file_img1.jpg'"  style="width: 40px; height:50px;">
                    ...
                    <c:if test="${ft.hasFulltext == 0}">
                      <div class="file-left__border  file-left__download fileupload__box-border"
                        ...
                        <img src="${empty ft.fullTextUrl ? false :ft.fullTextUrl}" name="fullImg"
                          des3ResId="${ft.des3ResId}" onerror="this.onerror=null;this.src='${resmod}/images_v5/images2016/file_img.jpg'" style="width: 40px; height:50px;">
                  ...
                  <c:if test="${ft.type == 2}">
                    <div class="file-left__border  file-left__download fileupload__box-border"
                      ...
                      <a href="/prjweb/outside/showfund?encryptedFundId=${ft.des3ResId }" target="_blank"> <img
                        ...
                        onerror="this.onerror=null;this.src='${ressns }/images/default/default_fund_logo.jpg'" style="width: 40px height: 50px;"></a>
                    </div>
                  </c:if>
                </div>
                ...
                style="width: 100%; justify-content: flex-start; margin-bottom: 12px; margin-top: 16px;">
