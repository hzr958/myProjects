                ...
                <div class="new-Recommend_infor-avator">
                  <c:if test="${ft.type == 1}">
                    <c:if test="${ft.hasFulltext == 1}">
                      <div class="file-left__border  file-left__download pub-idx__full-text_newbox-avator" style="position: relative;"
                        onclick="location.href = '${ft.fullTextDownloadUrl}'">
                        <img src="${empty ft.fullTextUrl ? false :ft.fullTextUrl}" name="fullImg"
                          des3ResId="${ft.des3ResId}" onerror="this.onerror=null;this.src='${resmod}/images_v5/images2016/file_img1.jpg'">
                    ...
                    <c:if test="${ft.hasFulltext == 0}">
                      <div class="file-left__border  file-left__download fileupload__box-border"
                        ...
                        <img src="${empty ft.fullTextUrl ? false :ft.fullTextUrl}" name="fullImg"
                          des3ResId="${ft.des3ResId}" onerror="this.onerror=null;this.src='${resmod}/images_v5/images2016/file_img.jpg'">
                  ...
                  <c:if test="${ft.type == 2}">
                    <div class="file-left__border  file-left__download fileupload__box-border"
                      ...
                      <a href="/prjweb/funddetails/show?encryptedFundId=${ft.des3ResId }" target="_blank"> <img
                        ...
                        onerror="this.onerror=null;this.src='${ressns }/images/default/default_fund_logo.jpg'"></a>
                    </div>
                  </c:if>
                </div>
