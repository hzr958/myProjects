...
public class DynamicForm {
  ...
  private List<DynReplayInfo> dynReplayInfoList; // 动态显示数据
  ...
  private DynamicRemdForm remdForm;

  private Integer pageNo;

  private String insPic;// 机构图片
  private String insName;// 机构名
  private String insUrl;// 机构主页链接
  ...
  public List<DynReplayInfo> getDynReplayInfoList() {
    return dynReplayInfoList;
  }

  public void setDynReplayInfoList(List<DynReplayInfo> dynReplayInfoList) {
    this.dynReplayInfoList = dynReplayInfoList;
  }
  ...
  public DynamicRemdForm getRemdForm() {
    return remdForm;
  }

  public void setRemdForm(DynamicRemdForm remdForm) {
    this.remdForm = remdForm;
  }
