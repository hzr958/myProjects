 ...
 */
@Entity
@Table(name = "PDWH_READ_STATISTICS")
public class PdwhReadStatistics implements Serializable {

  private static final long serialVersionUID = -7912989161363521056L;
  ...
  public PdwhReadStatistics() {
    super();
  }

  public PdwhReadStatistics(Long psnId, Long formateDate) {
    super();
    this.psnId = psnId;
    this.formateDate = formateDate;
  }

  public PdwhReadStatistics(Long psnId, Date createDate) {
    super();
    this.psnId = psnId;
