package com.smate.web.dyn.model.file;
...
public class PsnFileShareRecord implements Serializable {
  ...
  public PsnFileShareRecord(Long id, Long sharerId, Long reveiverId, Long fileId, Date createDate, Date updateDate,
  ...
  public PsnFileShareRecord() {
    super();
  }

  public String getOutsideEmail() {
    return outsideEmail;
  }

  public void setOutsideEmail(String outsideEmail) {
    this.outsideEmail = outsideEmail;
  }
}
