package com.smate.web.dyn.model.psn.rol;
...
public class PsnStatisticsRol implements Serializable {
  ...
  public PsnStatisticsRol() {}

  public PsnStatisticsRol(Long psnId, Integer hindex) {
    this.psnId = psnId;
    this.hindex = hindex;
  }
