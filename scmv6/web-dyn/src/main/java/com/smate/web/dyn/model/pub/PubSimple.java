...
public class PubSimple implements Serializable {
  ...
  public PubSimple(Long pubId, String zhTitle, String enTitle, String authorNames, String briefDesc, String briefDescEn,
      Integer publishYear, Long ownerPsnId) {
    super();
    this.pubId = pubId;
  ...
  // 添加一个全文字段
  public PubSimple(Long pubId, String zhTitle, String enTitle, String authorNames, String briefDesc, String briefDescEn,
      Integer publishYear, String fullTextField, Long ownerPsnId) {
    super();
    this.pubId = pubId;
    this.zhTitle = zhTitle;
    this.enTitle = enTitle;
  ...
  // 添加一个全文字段
  public PubSimple(Long pubId, String zhTitle, String enTitle, String authorNames, String briefDesc, String briefDescEn,
      Integer publishYear, String fullTextField) {
    super();
    this.pubId = pubId;
    this.zhTitle = zhTitle;
    this.enTitle = enTitle;
