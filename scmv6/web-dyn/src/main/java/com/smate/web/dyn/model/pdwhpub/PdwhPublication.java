...
public class PdwhPublication implements Serializable {
   ...
   * 
   */
  private static final long serialVersionUID = 6444719989362428587L;
  private Long pubId;
  ...
  public PdwhPublication(Long pubId, String zhTitle, String enTitle, String authorName, String zhBriefDesc,
      String enBriefDesc, Integer pubYear) {
    super();
    this.pubId = pubId;
