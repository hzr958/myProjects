                ...
                <div class="pub-idx_medium">
                  <div class="pub-idx__base-info">
                    <div class="pub-idx__full-text_box">
                      ...
                      <a href="/prjweb/funddetails/show?encryptedFundId=${RES_ID?if_exists}"  target='_blank'>
	                     <#if (FUND_LOGO_URL?exists)>
	        				<img src="${FUND_LOGO_URL?if_exists}"  onerror="this.src='/ressns/images/default/default_fund_logo.jpg'">	
	        			<#else>
	        				<img src="/ressns/images/default/default_fund_logo.jpg"  >
	        			</#if>
	        		  </a>
                      </div>
                    </div>
                    <input type="hidden" class="needInit fundDyn" value="${RES_ID?if_exists}"/>
                    <div class="pub-idx__main_box">
                      <div class="pub-idx__main">
                        <div class="pub-idx__main_title">
	        				<a href="/prjweb/funddetails/show?encryptedFundId=${RES_ID?if_exists}"  target='_blank'>${ZH_RES_NAME?if_exists}</a>
	        			</div>
