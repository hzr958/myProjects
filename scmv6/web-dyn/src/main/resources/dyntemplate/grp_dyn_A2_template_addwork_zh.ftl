<input type="hidden" name="dynId" value="${GROUP_DYN_ID?if_exists }" dynOwnerDes3Id="${DYN_OWNER_DES3_ID?if_exists}" des3ResId="${DES3_RES_ID?if_exists}" resId="${RES_ID?if_exists}" resOwnerDes3Id="${RES_OWNER_DES3ID?if_exists}" resGrpId="${RES_GRP_ID?c}" dynType="${DYN_TYPE?if_exists}" />
