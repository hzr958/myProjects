		...
		<div class="dynamic-creator__box" style="position: relative; height: auto;">
          <div class="dyn-publish_content">
            <span class="dyn-publish_content-author" >
               <a class="dynamic-creator__name" style="margin-right:4px;" title="${PERSON_NAME_EN?if_exists }" onclick="dynamic.openPsnDetail('${DES3_PRODUCER_PSN_ID}' ,event)">${PERSON_NAME_EN?if_exists }</a>${OPERATOR_TYPE_EN?if_exists }
          	</span>
