        ...
        <div class="dynamic-content">
          <div class="dynamic-content__post">
            ...
            <div class="dynamic-post__main" >
              <div class="dynamic-post__author" > <a class="dynamic-post__author_name"  title="${ PERSON_NAME_ZH?if_exists }" onclick="dynamic.openPsnDetail('${DES3_PRODUCER_PSN_ID}' ,event)">${ PERSON_NAME_ZH?if_exists }</a> </div>
