          ...
          <div class="dynamic-content__post" >
            ...
            <div class="dynamic-post__main" >
              <div class="dynamic-post__author" > 
              	<a class="dynamic-post__author_name"  title="${ PERSON_NAME_EN?if_exists }" onclick="dynamic.openPsnDetail('${DES3_PRODUCER_PSN_ID}' ,event)">${ PERSON_NAME_EN?if_exists }</a>
        ...
        <div class="dynamic-social__list">
          ...
          <#if (RES_TYPE==26)> 
            <div class="dynamic-social__item menuList_list-container_none dev_viewcount_${DYN_ID?c }" onclick=""><a>View</a></div>
            </#if>
          <div class="dynamic-social__item  dev_sharecount_${DYN_ID?c }"    resType="${RES_TYPE}"  resId="${RES_ID?c}"  dynType="${DYN_TYPE}" dynId="${DYN_ID?c}"  parentDynId="${PARENT_DYN_ID?c}" 
