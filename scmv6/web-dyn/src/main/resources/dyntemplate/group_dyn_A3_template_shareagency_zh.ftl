                ...
                <div class="pub-idx_medium">
                  <div class="pub-idx__base-info">
                    <div class="pub-idx__full-text_box">
                      ...
                      <a href="/prjweb/fundAgency/detailMain?Des3FundAgencyId=${RES_ID?if_exists}"  target='_blank'>
	                     <#if (AGENCY_LOGO_URL?exists)>
	        				<img src="${AGENCY_LOGO_URL?if_exists}"  onerror="this.src='/resmod/smate-pc/img/logo_instdefault.png'">	
	        			<#else>
                    ...
                    <div class="pub-idx__main_box">
                      <div class="pub-idx__main">
                        <div class="pub-idx__main_title">
	        				<a href="/prjweb/fundAgency/detailMain?Des3FundAgencyId=${RES_ID?if_exists}"  target='_blank'>${ZH_RES_NAME?if_exists}</a>
	        			</div>
