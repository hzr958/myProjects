...
import com.smate.web.prj.dto.PrjFulltextDTO;

/**
 * @author yamingd 项目XML数据
 */
public class PrjXmlDocument implements Serializable {


  private static final long serialVersionUID = -3236389226176756998L;
  private Document xmlDocument = null;

  /**
   * @throws DocumentException DocumentException
   */
  public PrjXmlDocument() throws DocumentException {
    try {
      String xml = PrjXmlConstants.XML_DECL;
   ...
   * @throws DocumentException DocumentException
   */
  public PrjXmlDocument(String xmlData) throws DocumentException {
    try {
  ...
  public List getPubAuthorList() {
    List list = this.getNodes(PrjXmlConstants.PUB_AUTHOR_XPATH);
    return list;
  }
   ...
   * @throws DocumentException DocumentException
   */
  public PrjXmlDocument(Document doc) throws DocumentException {
    xmlDocument = doc;
  }
  ...
  public long getPrjId() {
    ...
    String tmp = this.getXmlNodeAttribute(PrjXmlConstants.PRJ_META_XPATH, "prj_id");
    if ("".equals(tmp)) {
  ...
  public int getVersionNO() {
    String versionNO = this.getXmlNodeAttribute(PrjXmlConstants.PRJ_META_XPATH, "version_no");
    if ("".equals(versionNO)) {
  ...
  public long getOwerPsnId() {
    String str = this.getXmlNodeAttribute(PrjXmlConstants.PRJ_META_XPATH, "record_psn_id");
  ...
  public List getPrjMembers() {
    List list = this.getNodes(PrjXmlConstants.PRJ_MEMBERS_MEMBER_XPATH);
    return list;
  }
  ...
  public List getPrjErrorFields() {
    ...
    List list = this.getNodes(PrjXmlConstants.PRJ_ERRORS_ERROR_XPATH);
    return list;
  }
  ...
  public Node getPrjMeta() {
    return this.getNode(PrjXmlConstants.PRJ_META_XPATH);
  }
  ...
  public Node getPrjMember() {
    return this.getNode(PrjXmlConstants.PRJ_MEMBERS_XPATH);
  }
  ...
  public String getFormTemplate() {
    return this.getXmlNodeAttribute(PrjXmlConstants.PRJ_META_XPATH, "tmpl_form");
  }

  public void setFormTemplate(String tmplForm) {
    Element element = (Element) this.getNode(PrjXmlConstants.PRJ_META_XPATH);
    if (element == null) {
      element = this.createElement(PrjXmlConstants.PRJ_META_XPATH);
    }
  ...
  public Node getRootNode() {
    return this.xmlDocument.selectSingleNode(PrjXmlConstants.ROOT_XPATH);
  }
  ...
  public List getNodes(String xpath) {
    ...
    if (!xpath.startsWith(PrjXmlConstants.ROOT_XPATH))
      xpath = PrjXmlConstants.ROOT_XPATH + xpath;
  ...
  public String getSourceUrl() {
    String url = this.getXmlNodeAttribute(PrjXmlConstants.PRJ_META_XPATH, "source_url");
    return url;
  }
   ...
   * @param attrs2
   */
  public void fillAttributeValue(PrjXmlDocument oldDoc, String oldXpath, String newXpath, String[] fromAttrs,
      String[] toAttrs) {
   ...
   * @return
   */
  public PrjFulltextDTO getFulltext() {
    String url = this.getXmlNodeAttribute(PrjXmlConstants.PRJ_FULLTEXT_XPATH, "fulltext_url");
    Long fileId = IrisNumberUtils.createLong(this.getXmlNodeAttribute(PrjXmlConstants.PRJ_FULLTEXT_XPATH, "file_id"));
    Integer fileNodeId =
        IrisNumberUtils.createInteger(this.getXmlNodeAttribute(PrjXmlConstants.PRJ_FULLTEXT_XPATH, "node_id"));
    Long insId = IrisNumberUtils.createLong(this.getXmlNodeAttribute(PrjXmlConstants.PRJ_FULLTEXT_XPATH, "ins_id"));
    Integer dbid =
        IrisNumberUtils.createInteger(this.getXmlNodeAttribute(PrjXmlConstants.PRJ_META_XPATH, "source_db_id"));

    String fileName = this.getXmlNodeAttribute(PrjXmlConstants.PRJ_FULLTEXT_XPATH, "file_name");
    String fileExt = this.getXmlNodeAttribute(PrjXmlConstants.PRJ_FULLTEXT_XPATH, "file_ext");
    if (!"".equals(fileName)) {
      fileName = fileName + fileExt;
    }

    PrjFulltextDTO ret = new PrjFulltextDTO(url, fileId, fileName, fileExt, dbid, fileNodeId, insId);
    return ret;
  }
}
