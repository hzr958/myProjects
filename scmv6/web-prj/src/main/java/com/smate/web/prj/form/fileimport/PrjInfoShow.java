 ...
 *
 */
public class PrjInfoShow implements Serializable {
  ...
  public PrjInfoShow(String zhTitle, String enTitle, String authorNames, String authorNamesEn, String briefDesc,
      String briefDescEn) {
    super();
  ...
  public PrjInfoShow buildProjectInfo(Project project, PrjInfoShow prjInfo) {
    if (project != null) {
      prjInfo = new PrjInfoShow();
