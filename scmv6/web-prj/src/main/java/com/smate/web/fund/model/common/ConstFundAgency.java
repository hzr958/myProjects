...
public class ConstFundAgency implements Serializable {
  ...
  public ConstFundAgency(String nameZh, String nameEn) {
    super();
    this.nameZh = nameZh;
    this.nameEn = nameEn;
  }
  ...
  public String getNameView() {
    nameView = LocaleTextUtils.getStrByLocale(LocaleContextHolder.getLocale().toString(), this.nameZh, this.nameEn);
    return nameView;
  }
  ...
  public String getViewAddress() {
    viewAddress =
        LocaleTextUtils.getStrByLocale(LocaleContextHolder.getLocale().toString(), this.address, this.enAddress);
    return viewAddress;
  }
