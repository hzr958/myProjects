 ...
 * @author yamingd
 */
public class PrjXmlFragmentCleanerHelper {
   ...
   * @return String[]
   */
  public static String[] splitDateYearMonth(PrjXmlDocument doc, String xpath, String attrName, String pattern) {
  ...
  public static String[] getDateYearMonth(String pattern, String date) {
    ...
    if (PrjXmlConstants.CHS_DATE_PATTERN.equalsIgnoreCase(pattern)) {
    ...
    } else if (PrjXmlConstants.ENG_DATE_PATTERN.equalsIgnoreCase(pattern)) {
      String[] temp = date.split("[-/.]");
      if (temp.length == 1) {
        year = "0".equals(temp[0]) ? "" : temp[0];
   ...
   */
  public static void setDateValueFromYMD(PrjXmlDocument doc, String xpathPrefix, String pattern)
      throws InvalidXpathException {
    // /data/project/@start_year
