 ...
 * 
 */
public class PrjFulltextDTO implements java.io.Serializable {
  ...
  public PrjFulltextDTO(String url, Long fileId, String fileName, String fileExt, Integer dbid, Integer fileNodeId,
      Long insId) {
