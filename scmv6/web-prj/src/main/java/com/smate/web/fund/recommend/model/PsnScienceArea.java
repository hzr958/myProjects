...
public class PsnScienceArea implements Serializable {
  ...
  private Long scienceAreaId; // 科技领域ID,对应category_map_base
  ...
  public PsnScienceArea(Long scienceAreaId, String scienceArea, String enScienceArea) {
    this.scienceAreaId = scienceAreaId;
    this.scienceArea = scienceArea;
    this.enScienceArea = enScienceArea;
  }

  public PsnScienceArea(Long id, Long psnId, String scienceArea, Long scienceAreaId, Integer status) {
    super();
    this.id = id;
    this.psnId = psnId;
    this.scienceArea = scienceArea;
