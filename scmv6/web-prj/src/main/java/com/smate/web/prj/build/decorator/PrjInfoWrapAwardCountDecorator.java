 ...
 * @version 6.0.1
 */
public class PrjInfoWrapAwardCountDecorator extends PrjInfoAbstractDecorator {

  protected Logger logger = LoggerFactory.getLogger(getClass());
  private PrjInfoComponentDecorator prjInfoComponentDecorator;


  public PrjInfoWrapAwardCountDecorator(PrjInfoComponentDecorator prjInfoComponentDecorator) {
    super();
  ...
  public PrjInfo fillPrjInfo() throws BuildDecoratorException {
    ...
    if (projectStatistics != null) {
      prjInfo.setAwardCount(projectStatistics.getAwardCount() == null ? 0 : projectStatistics.getAwardCount());
    } else {
      prjInfo.setAwardCount(0);
    }
    return prjInfo;
  }
