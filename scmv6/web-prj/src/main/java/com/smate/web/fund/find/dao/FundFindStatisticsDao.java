package com.smate.web.fund.find.dao;
 ...
 */
@Repository
public class FundFindStatisticsDao extends SnsHibernateDao<AgencyStatistics, Long> {
  ...
  public void reduceAgencyListStatistics(List<Long> agencyIds) {
    String hql = " update AgencyStatistics t set interestSum=(interestSum-1) where t.agencyId in (:agencyIds)";
  ...
  public void reduceAgencyStatistics(Long agencyId) {
    String hql = " update AgencyStatistics t set interestSum=interestSum-1 where t.agencyId=:agencyId";
  ...
  public void addAgencyStatistics(Long agencyId) {
    ...
    if (angency == null) {
      ...
      String hqlUdpate = " update AgencyStatistics t set interestSum=interestSum+1 where t.agencyId=:agencyId";
