  ...
  <table id="fullTextUploadMsg" style="${style }" class="t_table mtop10 t_nr" cellSpacing="0" cellPadding="0">
    <tr class="t1_css">
      ...
      <c:if test="${res ne '/resscmwebrol'}">
        <td><s:text name="publication.label.permissions" /></td>
      </c:if>
    ...
    <tr>
      <td align="center"><input type="hidden" id="_prj_fulltext_current_node_id" value="${currentNodeId }" /> <input
        ...
        class="inp_text" maxlength="200" style="width: 305px" id="_prj_fulltext_file_name"
...
<c:if test="${res ne '/resscmwebrol'}">
  <div style="clear: both; padding-top: 10px;" onclick="replaceFulltextWithMyFile();">
    <a title="<s:text name="projectEdit.label.linkFile"/>" class="Blue"> <s:text name="projectEdit.label.linkFile" />
    </a>
  </div>
  <a
    href="${ctx}/group/ajaxLinkFile?suffix=jpegtxtjpggifpdfdocdocxpnghtmlxhtmlhtmrarzip&prjOrpub=2&TB_iframe=true&height=450&width=550"
...
<div class="attachment mtop5">
  ...
  <table id="tblAttachs" class="t_table mtop10 t_nr" cellSpacing="0" cellPadding="0">
    ...
    <tr class="template">
      ...
      <td align="center"><input style="width: 260px;" id="_prj_attachments_prj_attachment_0_file_name"
        name="/prj_attachments/prj_attachment[0]/:file_name" type="text" value="" class="inp_text" /></td>
      <td align="center"><input style="width: 315px;" name="/prj_attachments/prj_attachment[0]/:file_desc"
    ...
    <x:forEach select="$myoutput/data/prj_attachments/prj_attachment" var="attach">
      ...
      <tr>
        ...
        <!--<td align="center"><span  id="_prj_attachments_prj_attachment_${flag }${index }_sequence_no" name="/prj_attachments/prj_attachment[${flag }${index }]/@sequence_no" >${index }</span></td>
						-->
        <td align="center"><input style="width: 280px;"
        ...
        <c:if test="${res ne '/resscmwebrol'}">
          <td align="center"><select name="/prj_attachments/prj_attachment[${flag }${index }]/@permission"
            id="_prj_attachments_prj_attachment_${flag }${index }_permission" class="inp_text">
              <option value="1" ${empty permission || permission eq 1?'selected=selected':''}><s:text
                  name="publication.label.friend.view" /></option>
