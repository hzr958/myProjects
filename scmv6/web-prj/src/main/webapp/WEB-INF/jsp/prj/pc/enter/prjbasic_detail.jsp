  ...
  <dl>
    ...
    <dd>
      ...
      <input type="hidden" id="_project_old_scheme_agency_name" name="/project/@old_scheme_agency_name"
        value="${scheme_agency_name }" /> <input type="hidden" id="_project_old_scheme_name"
        name="/project/@old_scheme_name" value="${scheme_name }" /> <input type="text" maxlength="200" class="inp_text"
        isselect="true" style="width: 300px" id="_project_scheme_agency_name" name="/project/@scheme_agency_name"
        value="${scheme_agency_name }" /> &nbsp;-&nbsp; <input type="text" maxlength="200" class="inp_text"
        isselect="true" style="width: 300px" id="_project_scheme_name" name="/project/@scheme_name"
        value="${scheme_name }" />
    </dd>
  </dl>
</li>
<li>
  <dl>
    ...
    <dd>
      ...
      <input type="hidden" id="_project_old_scheme_agency_name_en" name="/project/@old_scheme_agency_name_en"
  ...
  <dl>
    ...
    <dd>
      <input type="text" maxlength="20" class="inp_text" style="width: 300px" id="_project_prj_internal_no"
        name="/project/@prj_internal_no"
        <c:if test="${!empty prjId }">
                value="<x:out  select="$myoutput/data/project/@prj_internal_no" />"
                </c:if> />
    </dd>
  </dl>
</li>
  ...
  <dl>
    ...
    <dd>
      <input type="text" maxlength="20" class="inp_text" style="width: 300px" id="_project_prj_external_no"
        name="/project/@prj_external_no"
        <c:if test="${!empty prjId }">
                value="<x:out  select="$myoutput/data/project/@prj_external_no" />"
                </c:if> />
    </dd>
  </dl>
</li>
  ...
  <dl>
    ...
    <dd>
      <input type="hidden" id="_project_ins_id" name="/project/@ins_id"
        <c:if test="${!empty prjId }">
            value="<x:out select="$myoutput/data/project/@ins_id" />"
            </c:if> />
      <input type="hidden" id="_project_old_ins_name" name="/project/@old_ins_name"
        <c:if test="${!empty prjId }">
            value="<x:out select="$myoutput/data/project/@ins_name" />" 
            </c:if> />
      <input type="text" maxlength="200" isselect="true" class="inp_text" style="width: 300px" id="_project_ins_name"
        name="/project/@ins_name"
        <c:if test="${!empty prjId }">
                value="<x:out select="$myoutput/data/project/@ins_name" />"
                </c:if> />
    </dd>
  ...
  <dl>
    ...
    <dd>
      <input type="text" maxlength="4" class="inp_text" style="width: 40px" id="_project_funding_year"
        name="/project/@funding_year"
        <c:if test="${!empty prjId }">
                value="<x:out  select="$myoutput/data/project/@funding_year" />"
                </c:if> />
    </dd>
  </dl>
</li>
