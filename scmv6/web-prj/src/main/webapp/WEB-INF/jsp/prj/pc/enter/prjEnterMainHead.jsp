...
<script type="text/javascript" src="${res}/js_v5/home/project/project-fulltext-upload.js"></script>
<script type="text/javascript" src="${res}/js_v5/home/project/project-attach-upload.js"></script>
...
<script type="text/javascript" src="${res}/js_v5/plugin/jquery.disccomplete.js"></script>
...
<script type="text/javascript" src="${res }/js_v5/home/project/project.enter.js"></script>
...
<%@ include file="prjEnter_inlineJs.jsp"%>
<script type="text/javascript">
	var editors={};
