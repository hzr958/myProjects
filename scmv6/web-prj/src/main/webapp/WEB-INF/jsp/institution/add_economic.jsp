                  ...
                  <div class="nav-cascade__toggle-list">
                    <c:forEach items="${economicMap[subKey] }" var="subLevel">
                      <c:if test="${!subLevel.added }">
                        <div class="nav-cascade__item" onclick="Institution.addEconomic('${subLevel.code}')"
        ...
        <div class="sugg-panel right-panel">
          ...
          <div class="sugg-panel__content">
            <div class="main-list__list global_no-border" id="choosed_area_list">
              <c:forEach items="${economicList }" var="area" varStatus="status">
...
<div class="dialogs__childbox_fixed">
  <div class="dialogs__footer">
    <button class="button_main button_primary-reverse" id="homepage_area_save_btn" onclick="Institution.saveEconomic();">
      确认
    </button>
    <button class="button_main button_primary-cancle" onclick="Institution.hideEconomicBox(this);">
      取消
    </button>
  </div>
</div>
