...
<div class="js_listinfo" smate_count="${totalCount} " smate_page_num="${pageNum }"></div>
...
<table border="0" cellpadding="0" cellspacing="0" class="tab-style">
  <s:if test="fundInfoList != null && fundInfoList.size() > 0">
    <s:iterator value="fundInfoList" id="fund" status="sta">
      <tr class="main-list__item"  style="width: 940px!important; padding: 0px;" des3id="<iris:des3 code='${fund.fundAgencyId }'/>">
                ...
                <div class="new-Standard_Function-bar">
                  <a style="${fund.hasAward ? 'display:none;' : ''}"
                    ...
                    <div class="new-Standard_Function-bar_item" style="margin-left: 0px;">
                      ...
                      <span class="new-Standard_Function-bar_item-title"> 
                         <s:text name='homepage.fundmain.recommend.like' />
                      <span class="awardOperateCount"> 
        ...
        <c:if test="${!fund.isStaleDated }">style="color:#000; height: 111px; line-height: 111px;"</c:if>
         >${fund.showDate }</td>
