...
$(function(){
    ...
    var agencys = $(".message-page__fuctool-selector_item");
    if(agencys[0] != null && agencys[0] != 'undefined'){
...
<body style="background-color: white;">
  ...
  <div id="header" class="fund__page-header">
    <span class="fund__page-icon"><i class="material-icons" style="margin-left: 10px" onclick="goback();">keyboard_arrow_left</i></span>
...
<!--       <div class="message-page__fuctool-item dev_select_agency message-page__fuctool-item_header" value="0">
        <span>全部推荐</span>
      </div> -->
      ...
      <div class="message-page__selector-line setting-list_page-item_hidden" style="left: 0px; max-width: 160px; display: none;"></div>
    </div>
