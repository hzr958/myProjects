 ...
 *
 * @author houchuanjie
 * @date 2017年12月22日 下午7:24:00
 */
@Entity
@Table(name = "SHARE_STATISTICS")
public class ShareStatisticsQuery implements Serializable {
  ...
  public ShareStatisticsQuery() {
    super();
  }

  public ShareStatisticsQuery(Long psnId, Long formateDate) {
    super();
    this.psnId = psnId;
