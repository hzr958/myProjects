...
public class V_GrpFile implements Serializable {
  ...
  public V_GrpFile(Long grpId, Long grpFileId, String fileName, String filePath, String fileType, String fileDesc,
  ...
  public V_GrpFile(String fileName, String filePath, String fileType, Long fileSize, String fileDesc,
      Integer fileStatus, Date uploadDate, Date updateDate, Long uploadPsnId, Long archiveFileId,
      Integer fileModuleType) {
    super();
    this.fileName = fileName;
    this.filePath = filePath;
    this.fileType = fileType;
