...
public class PubSimple implements Serializable {
  ...
  private Integer articleType;// 存储内容类型 publication=1,reference=2,file=3,project=4
  ...
  @Column(name = "STATUS")
  private Integer status;// 1: 已删除，0: 未删除 2:未确认(成果确认) 3：他人推荐（共享、推荐）4:代检索成果 (仅在Scholar/SNS使用) 5:从群组跳转而导入录入的成果.
  ...
  private Long simpleStatus;// 简单表数据状态 0:待处理 1,T表任务成功执行(v_pub_data_store对应记录被删除) 2,被删除 99:处理失败
   ...
   * @param authorNames
   */
  public PubSimple(Long pubId, Integer citedTimes, String zhTitle, String enTitle, String authorNames, String briefDesc,
      String briefDescEn) {
    super();
    this.pubId = pubId;
  ...
  public PubSimple(Long pubId, Long ownerPsnId, String zhTitle, String enTitle, String authorNames, String briefDesc,
      String briefDescEn) {
    super();
    this.pubId = pubId;
  ...
  public PubSimple(Long pubId, Long ownerPsnId, String zhTitle, String enTitle, String authorNames, String briefDesc,
      String briefDescEn, String fullTextField, Integer updateMark) {
    super();
    this.pubId = pubId;
    this.ownerPsnId = ownerPsnId;
    this.zhTitle = zhTitle;
