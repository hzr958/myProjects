...
public class GrpPubs implements Serializable {
  ...
  public GrpPubs(Long id, Long grpId, Long pubId, Integer labeled, Integer relevance, Long createPsnId, Date createDate,
      Date updateDate, Integer isProjectPub, Integer status) {
    super();
    this.id = id;
    this.grpId = grpId;
    this.pubId = pubId;
  ...
  public GrpPubs(Long pubId, Integer labeled, Integer relevance, Long createPsnId, Date createDate, Date updateDate,
  ...
  public GrpPubs(Long pubId, Integer labeled, Integer relevance, Long createPsnId, Date createDate, Date updateDate,
      Long updatePsnId, Integer isProjectPub, Integer status, Long ownerPsnId) {
    super();
    this.pubId = pubId;
    this.labeled = labeled;
    this.relevance = relevance;
  ...
  public String toString() {
    return "GrpPubs [id=" + id + ", grpId=" + grpId + ", pubId=" + pubId + ", labeld=" + labeled + ", relevance="
        + relevance + ", createPsnId=" + createPsnId + ", createDate=" + createDate + ", updateDate=" + updateDate
        + ", updatePsnId=" + updatePsnId + ", isProjectPub=" + isProjectPub + ", status=" + status + "]";
  }
