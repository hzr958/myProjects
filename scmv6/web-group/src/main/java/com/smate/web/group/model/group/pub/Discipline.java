...
public class Discipline implements Serializable {
  ...
  public Discipline(String secondCategoryZhName, String secondCategoryEnName) {
    this.secondCategoryZhName = secondCategoryZhName;
    this.secondCategoryEnName = secondCategoryEnName;
  }

  public Discipline(Long topCategoryId, String topCategoryZhName, String topCategoryEnName) {
  ...
  public Discipline(String secondCategoryZhName, Long secondCategoryId, String secondCategoryEnName) {
    this.secondCategoryZhName = secondCategoryZhName;
