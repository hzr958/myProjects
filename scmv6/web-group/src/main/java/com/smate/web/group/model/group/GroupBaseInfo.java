...
public class GroupBaseInfo implements Serializable {
  ...
  public GroupBaseInfo(String groupName, Long groupId) {
    super();
    this.groupId = groupId;
    this.groupName = groupName;
  }

  public GroupBaseInfo(Long groupId, String groupName, String groupDescription, String groupCategory, String openType,
      Date createDate, Date lastVisitDate, Long groupNo) {
    super();
    this.groupId = groupId;
    this.groupName = groupName;
  ...
  // 我的群组菜单列表检索构造函数.
  public GroupBaseInfo(Long groupId, String groupName, String groupDescription, String groupCategory,
      String groupImgUrl, Date lastVisitDate, Long psnId, String isAccept, String groupRole, Integer sumToMembers) {
    super();
    this.groupId = groupId;
    this.groupName = groupName;
    this.groupDescription = groupDescription;
  ...
  public GroupBaseInfo(Long groupId, Long groupNo, String groupName, String groupDescription, String groupCategory,
      String groupAnnouncement, String email, String tel, String address, String fundingTypes, Long fileId,
      String groupImgUrl, String groupPageUrl, Date createDate, Date updateDate, Date lastVisitDate) {
    super();
    this.groupId = groupId;
    this.groupNo = groupNo;
    this.groupName = groupName;
  ...
  public GroupBaseInfo(String groupName, String groupImgUrl) {
    super();
    this.groupName = groupName;
    this.groupImgUrl = groupImgUrl;
  }

  public GroupBaseInfo(String groupName, String groupImgUrl, String groupCategory, String groupDescription) {
    super();
    this.groupName = groupName;
    this.groupImgUrl = groupImgUrl;
    this.groupCategory = groupCategory;
    this.groupDescription = groupDescription;// SCM-10764 群组简介在两张表里都有保存group_baseInfo 和group_brief_description
  }
