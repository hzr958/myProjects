...
public class GrpBaseinfo implements Serializable {
  ...
  public GrpBaseinfo(String grpName, String grpDescription, Integer grpCategory, String grpAuatars, Long grpId) {
    super();
    this.grpName = grpName;
    this.grpDescription = grpDescription;
    this.grpCategory = grpCategory;
  ...
  public GrpBaseinfo(Long grpId, String grpName, Integer grpCategory, String grpAuatars) {
    super();
    this.grpId = grpId;
    this.grpName = grpName;
    this.grpCategory = grpCategory;
  ...
  public void setGrpDescription(String grpDescription) {
    grpDescription = IrisStringUtils.getMaxCharacterLength2(grpDescription, 2000);
    this.grpDescription = grpDescription;
  }
  ...
  public String getDes3GrpId() {
    return Des3Utils.encodeToDes3(Objects.toString(grpId, ""));
  }
