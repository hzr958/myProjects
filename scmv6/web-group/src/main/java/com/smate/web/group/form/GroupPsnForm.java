...
public class GroupPsnForm {
  ...
  // 群组分类 11表示项目群组，10表示兴趣群组
  private String groupCategory = "10";
  // 学科领域
  ...
  /*
   * // 群组好友 private List<GroupMember> groupMemberFriends;
   */
  // 群组好友名称
  ...
  private Integer hasUnion = 0; // 群组是否关联， 默认为0：没有 ， 1：关联了

  // 群组成果 分业查询
  private Page<GroupPubs> page = new Page();

  private String searchName;// 搜索类别
  private String searchId;// 类别ID
  private String searchIds;
  private String searchKey;// 搜索关键字
  private GroupPsn groupPsn;// 群组详情
  private List<GroupFolder> groupFolderList;// 成果标签
  private List<ConstPubType> pubTypes;// 左側欄成果類型
  private List<Map<String, String>> groupFolderListMap;// 左側文件ListMap集合
  private List<Map<String, Object>> recordList;// 左侧栏收录类别
  private Map<String, Object> yearsMap;// 左侧栏年份
  private String isAllowUpload;// 判断是否为邮件链接
  private String isMailReq;// 邮件请求参数
  ...
  private String screenYears;// 群组成果筛选年份
  private String screenPubTypes;// 群组成果筛选成果类型
  private String screenRecords;// 群组成果筛选收录来源
  private String backType;// 群组成果返回的页面类型 其他为返回整个页面,为1返回publist
  private Integer newestpublishYear;// 最新的出版年份 ，用于群组成果筛选
  private String pubTypesStr;// 有数据的成果类型Id,以逗号隔开 用于群组成果筛选
  private String recordsStr;// 有数据的成果收录数量,以逗号隔开 用于群组成果筛选

  private int isGroupPrj;// 是否是我的》项目》创建群组哪里点击创建的群组（1是）
  ...
  private String leftMenuId;// 左侧菜单栏菜单定位
  ...
  public List<GroupFolder> getGroupFolderList() {
    return groupFolderList;
  }

  public void setGroupFolderList(List<GroupFolder> groupFolderList) {
    this.groupFolderList = groupFolderList;
  }
  ...
  public void setDes3GroupId(String des3GroupId) {
    if (this.groupId == null && StringUtils.isNotBlank(des3GroupId)) {
      this.groupId = NumberUtils.toLong(ServiceUtil.decodeFromDes3(des3GroupId));
      if (this.groupId == 0L) {
        try {
          this.groupId =
              NumberUtils.toLong(ServiceUtil.decodeFromDes3(java.net.URLEncoder.encode(des3GroupId, "UTF-8")));
  ...
  /*
   * public List<GroupMember> getGroupMemberFriends() { return groupMemberFriends; }
   * 
   * public void setGroupMemberFriends(List<GroupMember> groupMemberFriends) { this.groupMemberFriends
   * = groupMemberFriends; }
   */
  ...
  /*
   * public Map<String, List<KeywordsHot>> getRdKeywords() { return rdKeywords; }
   * 
   * public void setRdKeywords(Map<String, List<KeywordsHot>> rdKeywords) { this.rdKeywords =
   * rdKeywords; }
   */
  ...
  public Page<GroupPubs> getPage() {
    return page;
  }

  public void setPage(Page<GroupPubs> page) {
    this.page = page;
  }
  ...
  public boolean getIsReadyJoin() {
    return isReadyJoin;
  }

  public void setIsReadyJoin(boolean isReadyJoin) {
    this.isReadyJoin = isReadyJoin;
  }
  ...
  public List<Map<String, String>> getGroupFolderListMap() {
    return groupFolderListMap;
  }

  public void setGroupFolderListMap(List<Map<String, String>> groupFolderListMap) {
    this.groupFolderListMap = groupFolderListMap;
  }
  ...
  public void setYearsMap(Map<String, Object> yearsMap) {
    this.yearsMap = yearsMap;
  }

  public String getIsAllowUpload() {
    return isAllowUpload;
  }

  public void setIsAllowUpload(String isAllowUpload) {
    this.isAllowUpload = isAllowUpload;
  }

  public String getIsMailReq() {
    return isMailReq;
  }

  public void setIsMailReq(String isMailReq) {
    this.isMailReq = isMailReq;
  }

  public String getSearchIds() {
    if (searchId != null) {
      return Des3Utils.decodeFromDes3(searchId);
    }
    return searchIds;
  }
  ...
  public Long getGpubId() {
    return gpubId;
  }

  public void setGpubId(Long gpubId) {
    this.gpubId = gpubId;
  }
  ...
  public Integer getNewestpublishYear() {
    return newestpublishYear;
  }

  public void setNewestpublishYear(Integer newestpublishYear) {
    this.newestpublishYear = newestpublishYear;
  }

  public String getPubTypesStr() {
    return pubTypesStr;
  }

  public void setPubTypesStr(String pubTypesStr) {
    this.pubTypesStr = pubTypesStr;
  }
  ...
  public int getIsGroupPrj() {
    return isGroupPrj;
  }

  public void setIsGroupPrj(int isGroupPrj) {
    this.isGroupPrj = isGroupPrj;
  }
  ...
  public Integer getHasUnion() {
    return hasUnion;
  }

  public void setHasUnion(Integer hasUnion) {
