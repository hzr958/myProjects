<li onmouseover="dynMsgUtil.showDynOperation(this)"  onmouseout="dynMsgUtil.hideDynOperation(this)">
    ...
    <div class="publish-nr">
      <div class="moving-contat">
        <#list replyerDetails as replyer><a href="/scmwebsns/resume/psnView?des3PsnId=${replyer.replyer_des3PsnId}&menuId=<#if (isGroupFlag==1)>3<#else>1100</#if>" target="_blank" class="Blue">${replyer.replyer_psnName}</a><#if replyer_has_next>、</#if></#list>发表了评论：
      </div>
