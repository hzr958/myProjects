<li onmouseover="dynMsgUtil.showDynOperation(this)"  onmouseout="dynMsgUtil.hideDynOperation(this)">
    ...
    <div class="publish-nr">
     <div class="moving-contat">
       <#list sharerDetails as sharer><a href="/scmwebsns/resume/psnView?des3PsnId=${sharer.sharer_des3PsnId}&menuId=<#if (isGroupFlag==1)>3<#else>1100</#if>" target="_blank" class="Blue">${sharer.sharer_psnName}</a><#if sharer_has_next>、</#if></#list>分享<#switch resType><#case 1>成果<#break><#case 2>文献<#break><#case 3>文件<#break><#case 4>项目<#break><#case 5>课件<#break><#default>others</#switch>：
     </div>
     ...
     <#list resDetails as dynRes>
      <div class="txt_box">
        ...
        <#else>
        <p><a href="${dynRes.imgIcPath}" onclick="dynMsgUtil.ajaxIsShowPicInTB(this,'${resType}','${dynRes.resNode}','${dynRes.resId?c}')" class="gallery_link thickbox" rel="gallery-plants${dynId?c}" title="${dynRes.resTitle}"><img src="${dynRes.imgIc}"/></a></p>
