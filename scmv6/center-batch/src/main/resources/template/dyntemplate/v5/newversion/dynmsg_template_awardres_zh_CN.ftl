<li onmouseover="dynMsgUtil.showDynOperation(this)"  onmouseout="dynMsgUtil.hideDynOperation(this)">
    ...
    <div class="publish-nr">
      <div class="moving-contat"><a href="/scmwebsns/resume/psnView?des3PsnId=${des3PsnId}&menuId=<#if (isGroupFlag==1)>3<#else>1100</#if>" target="_blank" class="Blue">${psnName}</a>赞了<#if resOwner_des3PsnId?exists><a href="/scmwebsns/resume/psnView?des3PsnId=${resOwner_des3PsnId}&menuId=<#if (isGroupFlag==1)>3<#else>1100</#if>" target="_blank" class="Blue">${resOwner_psnName }</a>的</#if><#switch resType><#case 0>分享<#break><#case 1>成果<#break><#case 2>文献<#break><#case 3>文件<#break><#case 4>项目<#break><#case 5>课件<#break><#case 8>群组<#break><#case 9>简历<#break><#case 19>工作经历<#break><#case 20>教育经历<#break><#case 21>研究领域<#break><#default>资源</#switch>：</div>
