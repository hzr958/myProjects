<li onmouseover="dynMsgUtil.showDynOperation(this)"  onmouseout="dynMsgUtil.hideDynOperation(this)">
    ...
    <div class="publish-nr">
     <div class="moving-contat">
        <a href="/scmwebsns/resume/psnView?des3PsnId=${des3PsnId}&menuId=<#if (isGroupFlag==1)>3<#else>1100</#if>" target="_blank" class="Blue">${psnName}</a>分享${resTotal}<#switch resType><#case 1>条成果<#break><#case 2>条文献<#break><#case 3>个文件<#break><#case 4>条项目<#break><#case 5>个课件<#break><#default>others</#switch>：${sayContent}
     </div>
     ...
     <#list resDetails as dynRes>
      <div class="txt_box">
        ...
        <span class="icon_${dynRes.fileExt} shared_pic" style="margin-left:-2px;">&nbsp;</span><a href="${dynRes.resLink}" class="Blue">${dynRes.resTitle}</a>
        <#else>
