<li onmouseover="dynMsgUtil.showDynOperation(this)"  onmouseout="dynMsgUtil.hideDynOperation(this)">
    ...
    <div class="publish-nr">
      ...
      <a href="/scmwebsns/resume/psnView?des3PsnId=${des3PsnId}&menuId=<#if (isGroupFlag==1)>3<#else>1100</#if>" target="_blank" class="Blue">${psnEnName}</a> updated the information of <#list resumeDetails as resume><#if (!resume_has_next) && (resume_index!=0)> and <#else>${splitChar}</#if><#switch resume.resumeType><#case 0>base information<#break><#case 1>contact<#break><#case 2>edducation experience<#break><#case 3>work experience<#break><#case 4>research area<#break><#case 5>brief<#break><#default></#switch><#if resume_has_next><#assign splitChar>, </#assign></#if></#list></div>
      <div class="appraisa-choose">
        <p class="t_detail">
        <#assign dynDateVar>
             <#if dynDate=='dateTime'>${normalEnDynDate}<#else>${dynDate} ago</#if>
        </#assign>
        <span class="f888 date01"> ${dynDateVar}</span>&nbsp;&nbsp;&nbsp;&nbsp;</p>
      </div>
    </div>
