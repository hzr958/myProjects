      ...
      <div class="comments_box">
        ...
        <div style="display:none;" class="reply_content_div" id="textarea_${dynId?c}_${dynRes.resId?c}">
          ...
          <div class="t_message3">
              ...
              <p>
                <a style="cursor:pointer" onclick="dynMsgUtil.ajaxReply('${resType}','${dynRes.resNode}','${dynRes.resId?c}','${dynId?c}','${permission}', 0, this)" class="replyBtn uiButton uiButtonConfirm">回复</a>&nbsp;&nbsp;
              </p> 
           </div>
        </div>
      </div>
