<li onmouseover="dynMsgUtil.showDynOperation(this)"  onmouseout="dynMsgUtil.hideDynOperation(this)">
    ...
    <div class="publish-nr">
      <div class="moving-contat"><a href="/scmwebsns/resume/psnView?des3PsnId=${des3PsnId}&menuId=<#if (isGroupFlag==1)>3<#else>1100</#if>" target="_blank" class="Blue">${psnEnName}</a> added ${resTotal} <#switch resType><#case 1><#if (resTotal>1)>publications<#else>publication</#if><#break><#case 2><#if (resTotal>1)>references<#else>reference</#if><#break><#case 3><#if (resTotal>1)>files<#else>file</#if><#break><#case 4><#if (resTotal>1)>projects<#else>project</#if><#break><#case 5><#if (resTotal>1)>Course Materials<#else>Course Material</#if><#break><#default>others</#switch>.
	  </div>
        ...
        <div class="drop_jt_en_US"></div>
           <ul>
             <#if (isGroupFlag==1)>
               ...
               <li><a style="cursor:pointer; <#if (isMine!=0)>border-width:0;</#if>" onclick="dynMsgUtil.ajaxShieldDynByType('','${dynId?c}')"><i class="img_nochoose"></i>Shield such update</a></li>
             	<#if (isMine==0)>
