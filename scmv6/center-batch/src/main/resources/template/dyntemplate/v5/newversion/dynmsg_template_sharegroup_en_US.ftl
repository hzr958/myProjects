<li onmouseover="dynMsgUtil.showDynOperation(this)" onmouseout="dynMsgUtil.hideDynOperation(this)">
    ...
    <div class="publish-nr">
      <div class="moving-contat"><a href="/scmwebsns/resume/psnView?des3PsnId=${des3PsnId}&menuId=<#if (isGroupFlag==1)>3<#else>1100</#if>" target="_blank" class="Blue">${psnEnName}</a> shared group: ${sayContent}</div>
    ...
    <div class="drop_down">
        ...
        <div class="drop_jt_en_US"></div>
           <ul>
             ...
             <#else>
               <#if ((isGroupFlag==0) || isGroupManager == '1')>
