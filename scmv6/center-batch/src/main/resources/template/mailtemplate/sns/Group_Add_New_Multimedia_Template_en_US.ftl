...
<title>
	Scholarmate - Group Multimedia Template
</title>
</head>
														...
														<tr style="font-size: 14px;">
															<td colspan="2" style="line-height: 25px;">
																...
																<#if fileCount?number == 1>
																	<label>${sender}</label> uploaded a multimedia "${fileNames}" to "${groupName}" group. 
																	<#elseif (fileCount?number > 1)>
																	<label>${sender}</label> uploaded ${fileCount} multimediaes named "${fileNames}" etc. to "${groupName}" group. 
																</#if>
															</td>
														</tr>
