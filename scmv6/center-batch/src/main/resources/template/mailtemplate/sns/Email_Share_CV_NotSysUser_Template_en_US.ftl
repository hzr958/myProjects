              ...
              <tr>
	            <td align="center" valign="top"><table width="100%" border="0" cellspacing="20" cellpadding="0" style="font-size:14px;">
	              <tr>
	                ...
	                <tr>
	                <td colspan="2" style="font-size:14px;">${senderName} invited you to view research CV “${cvName}”.</td>
	                </tr>
	                  <tr>
	                    ...
	                    <table width="100%" border="0" cellspacing="0" cellpadding="5" style="font-size:12px; line-height:16px;">
							<tr>
									...
									Click hyperlink below, or download from email to view the details.<br/><br/>
									<a style="color: #426cad;" target="_blank" href="${recommendUrl}">${recommendUrl}</a><br/>
									<#if (pdfUrl?exists)>
									<p><a style="color: #426cad;" target="_blank" href="${pdfUrl}">${cvName}.pdf</a></p>
									</#if>
									<#if (wordUrl?exists)>
									<p><a style="color: #426cad;" target="_blank" href="${wordUrl}">${cvName}.doc</a></p>
									</#if>
						  	  	</td>
						  	</tr>
	                    </table>
