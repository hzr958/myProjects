...
<title>科研之友-群组“${groupName}”新增教学课件</title>
</head>
	                  ...
	                  <tr style="font-size:14px;">
	                    <td colspan="2" style="line-height:25px;">
	                    	...
	                    	<#if fileCount?number == 1>
								<label>${sender}</label>为群组“${groupName}”新增了一个教学课件“${fileNames}”。
							<#elseif (fileCount?number > 1)>
								<label>${sender}</label>为群组“${groupName}”新增了“${fileNames}” 等${fileCount}个教学课件。
							</#if>
	                    </td>
	                  </tr>
	                        ...
	                        <table width="135" border="0" cellpadding="0" cellspacing="1" bgcolor="#6a8bbf">
	                          <tr>
								<td height="37" align="center" bgcolor="#d6e3f6"  style=" border-top:1px solid #ebf1fb;">
									<a href="${fileUrl}" style="font-size:14px; color:#3f68a8;text-align:center; line-height:37px; text-align:center; font-weight:bold; text-decoration:none;">查看更多</a>
								</td>
	                          </tr>
	                        </table>
	                        </td>
