...
<title>
	Scholarmate - Group Normal Invitation Template
</title>
</head>
												...
												<td align="left" valign="top"><table width="100%" border="0" cellpadding="6"
														...
														<tr style="font-size: 14px;">
															<td colspan="2" style="line-height: 25px;">
																Dear 
																<span style="font-weight: bold;"><#if (invitePsnId?exists)>${invitePsnName},</#if></span><br /> 
																${psnName} invites you to join ScholarMate group "${groupName}".
															</td>
														</tr>
														<tr>
													                        ...
													                        <table width="190" border="0" cellpadding="0" cellspacing="1" bgcolor="#6a8bbf">
													                          <tr>
													                            <td height="37" align="center" bgcolor="#d6e3f6"  style=" border-top:1px solid #ebf1fb;">
																					<a href="${groupInviteUrl}" style="font-size:14px; color:#3f68a8;text-align:center; line-height:37px; text-align:center; font-weight:bold; text-decoration:none;">Join Group</a>
																				</td>
													                          </tr>
													                        </table>
													                    </td>
