...
<title>科研之友-${psnName}邀请您加入群组</title>
</head>
	                ...
	                <td align="left" valign="top"><table width="100%" border="0" cellpadding="6" cellspacing="0" style="font-size:14px;">
	                  <tr style="font-size:14px;">
	                    <td colspan="2" style="line-height:25px;">
	                    	...
	                    	<#if (invitePsnId?exists)>${invitePsnName}，</#if>
	                    	</span><br />
	                    	${psnName}邀请您加入群组“${groupName}”。
	                    </td>
	                  </tr>
	                  <tr>
	                        ...
	                        <table width="135" border="0" cellpadding="0" cellspacing="1" bgcolor="#6a8bbf">
	                          <tr>
								<td height="37" align="center" bgcolor="#d6e3f6"  style=" border-top:1px solid #ebf1fb;">
									<a href="${groupInviteUrl}" style="font-size:14px; color:#3f68a8;text-align:center; line-height:37px; text-align:center; font-weight:bold; text-decoration:none;">加入群组</a>
								</td>
	                          </tr>
	                        </table>
	                        </td>
