...
<table width="600" border="0" align="center" cellpadding="0" bgcolor="#d0daea" cellspacing="10" style="font-family:Arial, Helvetica, '宋体'; font-size:12px; color:#333;">
  ...
  <tr style="font-size:14px;">
    <td style="line-height:25px;"><span style="font-weight:bold;">${psnName}</span>, welcome to Group <a href="${viewGroupUrl}" target="_blank" style="font-weight:bold; color:#426cad; text-decoration:none;">${groupName}</a></td>
  </tr>
  <#if (groupDesc?exists)>
  <tr>
    <td align="left" valign="top" bgcolor="#f9f9f9"><table width="100%" border="0" cellspacing="0" cellpadding="5" style="font-size:12px; color:#333; line-height:20px;">
      <tr>
        <td align="left" valign="top"><a href="${viewGroupUrl}" style="font-weight:bold; color:#426cad; font-size:12px; text-decoration:none;">${groupName}</a><br />Group’s Introduction : ${groupDesc}</td>
        </tr>
      </table></td>
  </tr>
   </#if>
