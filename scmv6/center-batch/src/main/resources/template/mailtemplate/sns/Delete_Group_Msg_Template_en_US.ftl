...
<title>
	ScholarMate - Group Delete Template
</title>
</head>
														...
														<tr>
															<td colspan="2" valign="top" bgcolor="#f9f9f9">
																...
																<table width="100%" border="0" cellspacing="0" cellpadding="5"
																	...
																	<tr>
																		<td align="left">
																			${sender} has deleted the group "${groupName}".
																		</td>
																	</tr>
																</table>
															</td>
													                        ...
													                        <table width="135" border="0" cellpadding="0" cellspacing="1" bgcolor="#6a8bbf">
													                          <tr>
													                            <td height="37" align="center" bgcolor="#d6e3f6"  style=" border-top:1px solid #ebf1fb;">
																					<a href="${recvUrl}" style="font-size:14px; color:#3f68a8;text-align:center; line-height:37px; text-align:center; font-weight:bold; text-decoration:none;">View</a>
																				</td>
													                          </tr>
													                        </table>
													                    </td>
