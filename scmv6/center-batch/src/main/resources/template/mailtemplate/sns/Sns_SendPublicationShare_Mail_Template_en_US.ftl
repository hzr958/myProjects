												...
												<td align="left" valign="top"><table width="100%" border="0" cellpadding="6"
														...
														<tr style="font-size: 14px;">
															<td colspan="2" style="line-height: 25px;">
																...
																Please click the button and reset your password in 24 hours.
															</td>
														</tr>
														<tr>
																...
																<table width="100%" border="0" cellspacing="0" cellpadding="5"
																	...
																	<tr>
																		<td align="left">
																			...
																			标题：  ${keycode_sharePsnName}共享给您了 ${keycode_sharePubCount}个成果 <br/>
																			内容：  ${keycode_sharePsnName}共享给您了${keycode_sharePubCount}个文成果，请点击以下链接查看详细的成果信息：<br/>
																			${keycode_shareURL}
																			<div>
																		</td>
																	</tr>
