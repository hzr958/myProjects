              ...
              <tr>
                <td align="center" valign="top"><table width="100%" border="0" cellspacing="20" cellpadding="0" style="font-size:14px;">
                    <tr>
                      <td align="left" valign="top"><table width="100%" border="0" cellpadding="6" cellspacing="0" style="font-size:14px;">
                          <tr style="font-size:14px;">
                            <td style="line-height:25px;"><span style="font-weight:bold;">${receivePsnName}</span>，恭喜您发表会议论文<a href="${pubUrl!'#'}" style="font-weight:bold; text-decoration:none; color:#426cad;">${pubName}</a>。
                              <br />
                              			您可以考虑将其修改后向以下期刊投稿：</td>
                          </tr>
                          <tr>
                            <td align="left" valign="top" bgcolor="#f9f9f9"><table width="100%" border="0" cellspacing="0" cellpadding="5" style="font-size:12px; color:#005eac;">
                                ...
                                <tr>
                                  <td width="50%" align="left"><a href="${jnlDetailUrl!'#'}" style="text-decoration:none; color:#005eac; font-size:12px;">${journal.journalName ! ''}</a></td>
                                  <#assign sufCo=5-journal.recommendation/>
                                  <td align="left">相关性： <#list 1..journal.recommendation as  co >★</#list><#if (sufCo?number != 0)><#list 1..sufCo as  co2 >☆</#list></#if>
                                  </td>
                                </tr>
                                </#list>
                                <#if (counts?number > 3)>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="40" align="center" bgcolor="#f3f3f3" style="text-align:center; font-size:14px; color:#999999;">向最适合的期刊投稿，提高投稿命中率。</td>
                    </tr>
                  </table></td>
              </tr>
            </table></td>
