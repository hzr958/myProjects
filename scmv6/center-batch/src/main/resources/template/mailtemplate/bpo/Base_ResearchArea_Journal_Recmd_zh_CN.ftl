              ...
              <tr>
                <td align="center" valign="top"><table width="100%" border="0" cellspacing="20" cellpadding="0" style="font-size:14px;">
                    <tr>
                      <td align="left" valign="top"><table width="100%" border="0" cellpadding="6" cellspacing="0" style="font-size:14px;">
                          <tr style="font-size:14px;">
                            <td style="line-height:25px;"><span style="font-weight:bold;">${receivePsnName}</span>，向您推荐适合您研究领域的<a href="${viewUrl}" style="text-decoration:none;font-weight:bold; color:#426cad;">${counts}</a>个学术期刊：</td>
                          </tr>
                          <tr>
                            <td align="left" valign="top" bgcolor="#f9f9f9"><table width="100%" border="0" cellspacing="0" cellpadding="5" style="font-size:12px; color:#005eac;">
                                ...
                                <tr>
                                  <td width="60%" align="left"><a href="${viewUrl}" style="text-decoration:none; color:#005eac; font-size:12px;">${journal.journalName!''}</a></td>
                                  <td align="left" style="color:#000;">相关性：<#assign sufCo=5-journal.recommendation/>
                                     <#list 1..journal.recommendation as  co >★</#list><#if (sufCo?number != 0)><#list 1..sufCo as  co2 >☆</#list></#if>
                                  <!--<a href="${viewUrl}" style="text-decoration:none; color:#005eac; font-size:12px;">${journal.recommendation!''}</a>-->
                                  </td>
                                </tr>
                                </#list>
                                <#if (counts?number > 3)>
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td height="40" align="center" bgcolor="#f3f3f3" style="text-align:center; font-size:14px; color:#999999;">完善研究领域信息，发掘更多期刊投稿机会。</td>
                    </tr>
                  </table></td>
              </tr>
            </table></td>
