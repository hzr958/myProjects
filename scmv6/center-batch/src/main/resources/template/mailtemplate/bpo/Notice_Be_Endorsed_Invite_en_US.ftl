                    ...
                    <tr>
                      <td align="left" valign="top"><table width="100%" border="0" cellpadding="6" cellspacing="0" style="font-size:14px;">
                          <tr style="font-size:14px;">
                            <td style="line-height:25px;"><span style="font-weight:bold;">${psnName}</span>, <a href="${psnUrl}" style="font-weight:bold;text-decoration:none; color:#426cad;">${count}</a> people endorsed your research areas.</td>
                          </tr>
                          <tr>
                            <td align="left" valign="top" bgcolor="#f9f9f9"><table width="100%" border="0" cellspacing="0" cellpadding="10" style="font-size:12px; color:#005eac;">
                               <#list frdRaList as frdRa >
                                <tr>
                                  ...
                                  <td width="left"><#list frdRa.raList as ra><a href="${psnUrl!'#'}%26src%3ddiscipline_box" style="text-decoration:none; color:#005eac; font-size:12px;">${ra}</a>;</#list></td>
                                 
                              	 <td width="25%" align="left"><table width="80" border="0" cellpadding="0" cellspacing="1" bgcolor="#285510">
        					  <tr>
            					<td height="22" align="center" bgcolor="#69a551"  style=" border-top:1px solid #8fbb7b;"><a href="#" title="立即体验" style="font-size:12px; color:#FFF; font-family:Arial, Helvetica, sans-serif;  text-align:center; text-align:center; font-weight:bold; text-decoration:none;">Endorse</a></td>
        					  </tr>
    						</table></td>
										  </tr>
                                </#list>
                      ...
                      <td align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td align="left" valign="middle"><table width="130" border="0" cellpadding="0" cellspacing="1" bgcolor="#6a8bbf">
                            <tr>
                              <td height="30" align="center" bgcolor="#d6e3f6"  style=" border-top:1px solid #ebf1fb;"><a href="${psnUrl}%26src%3ddiscipline_box" style="font-size:14px; font-weight:bold; color:#3f68a8;  text-align:center; line-height:30px; text-align:center; text-decoration:none;">View More</a></td>
                            </tr>
                          </table></td>
                        </tr>
                      </table></td>
