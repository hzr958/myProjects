...
<title>${keycode_ins_name}科研之友机构版成果认领邮件</title>
</head>
               ...
               <table width="94%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
					  <td height="60" align="left" valign="middle">
					  	<span style="font-size:16pt; font-family:'宋体';font-weight:bold; color:#FFF; ">ScholarMate Institutional Edition :</span>
					  	<span style="font-family:Microsoft JhengHei;font-weight:bold;font-size:14pt;color:#FFF;"><i>Social Institutional Repository, Research Made Easy.</i></span>
					  </td>
	                    ...
	                    <table width="100%" border="0" cellspacing="0" cellpadding="5" style="font-size:12px; line-height:16px;">
							<tr>
						  	  	<td align="left" style="font-family:Microsoft JhengHei;font-size:11pt;">
						  	  	    ${en_US_psnname},you have ${keycode_total} publication(s) to confirm on ${keycode_ins_name} ScholarMate Institutional Edition<br/>
						  	  		<#list pubs as pub>
									${pub.pubContent}<br /><br />
									</#list>
						  	  	</td>
						  	</tr>
	                    </table>
	                        ...
	                        <table width="200" border="0" cellpadding="0" cellspacing="1">
	                          <tr>
	                            <td height="37" align="center" style="font-family:Microsoft JhengHei;font-size:11pt;" >
									<b>Claim scientific publication, improve the work efficiency</b>
								</td>
	                          </tr>
	                        </table></td>
	                      </tr>
