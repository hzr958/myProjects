                ...
                <table width="94%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
					  <td height="60" align="left" valign="middle">
					  	<span style="font-size:16pt; font-family:'宋体';font-weight:bold; color:#FFF; ">ScholarMate Associational Edition :</span>
					  	<span style="font-family:Microsoft JhengHei;font-weight:bold;font-size:14pt;color:#FFF;"><i>Social Associational Repository, Research Made Easy.</i></span>
					  </td>
	                ...
	                <td align="left" valign="top"><table width="100%" border="0" cellpadding="6" cellspacing="0" style="font-size:14px;">
	                  ...
	                  <tr>
	                    ...
	                    <table width="100%" border="0" cellspacing="0" cellpadding="5" style="font-size:12px; line-height:16px;">
							<tr>
									...
									Below is your ${keycode_ins_name} ScholarMate Associational Edition Account information:<br/><br/>
									URL：${keycode_app_InsDomain}<br/><br/>
									Account：${keycode_psn_login}<br/><br/>
									Please change password within 72 hours to ensure your personal information security.<br/><br/>
									<!--隐藏变量：当前机构ID-->
	                        ...
	                        <table width="200" border="0" cellpadding="0" cellspacing="1" bgcolor="#6a8bbf">
	                          <tr>
	                            <td height="37" align="center" bgcolor="#d6e3f6" style=" border-top:1px solid #ebf1fb;">
									<a href="${keycode_app_baseUrl}&locale=en_US" 
	                        ...
	                        <table width="170" border="0" cellpadding="0" cellspacing="1">
	                          <tr>
	                            <td height="37" align="center" style="font-family:Microsoft JhengHei;font-size:11pt;" >
									<b>your personal information security is our concern</b>
								</td>
	                          </tr>
	                        </table></td>
	                      </tr>
	                  ...
	                  <tr>
	                    <td align="left" valign="middle" style="line-height:20px;">
							...
							${keycode_ins_name} Technology Department<br />
							ScholarMate Associational Edition：
							</span>
...
<table width="600" border="0" align="center" cellpadding="0" cellspacing="0" style="font-family:Arial, Helvetica, '宋体'; font-size:12px; color:#666666;">
  ...
  <tr>
    <td height="40" align="center" style="color:#666666; line-height:150%;">
		For enquiry, please write to <a href="mailto:support@scholarmate.com">support@scholarmate.com</a><br />
