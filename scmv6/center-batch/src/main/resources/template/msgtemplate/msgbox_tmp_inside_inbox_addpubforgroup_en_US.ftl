	...
	<div class="mail_words">
		<ul>
			<li>
				...
				<p></p>
				<br />
				<span>Please click <a class="Blue" href="/scmwebsns/group/pub?groupPsn.groupNodeId=1&groupPsn.des3GroupId=${des3GroupId!''}&sharePub=true" scmflag="hidden">here</a> to add publications for the group.</span>
			</li>
			<li>
				<div class="Fleft">
					<#if (senderDes3Id?exists)>
