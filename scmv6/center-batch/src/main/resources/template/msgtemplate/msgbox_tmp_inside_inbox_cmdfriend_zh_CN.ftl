					         		...
					         		<tr>
					                  ...
					                  <td height="20" align="left" id="lab${commender.commenderId}">
			                  			<#if (commender.isFriend?? && commender.isFriend="0")>
						            			<a class="addFriendClass thickbox" title="请求加${commender.commenderName?html}为好友" des3id="${commender.commenderDes3Id}" style="font-size:12px;"><span class="addfriends"></span>加为好友</a>
						            		</#if>
					                  </td>
					               </tr>
					        		</tbody>
