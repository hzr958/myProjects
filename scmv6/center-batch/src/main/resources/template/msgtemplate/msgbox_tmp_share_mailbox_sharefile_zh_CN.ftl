									...
									<dd>
									    ...
									    <span class="xi_nr">
									    	 <#if resDetail.fileStatus == 1>
									    	 	${resDetail.fileName}
									    	 <#else>
									    	 	<a class="Blue" onclick="openFile('${resDetail.des3ResId}','${resDetail.resNodeId}', '0')" style="cursor:pointer">${resDetail.fileName}</a>
									    	 </#if>    
										 </span>
									</dd>
									<dd>
										<span class="xi_name">文件大小：</span><span class="xi_nr">${resDetail.fileSize} KB</span>
									</dd>
								</dl>
							</div>
