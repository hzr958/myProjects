		...
		<div class="scholarmate_top">
			...
			<div class="sm_top_nav">
				<span id="back_span">
					...
					<a href="pub_maint_en_US.html">&nbsp;English&nbsp;</a>
			</div>
		</div>
	</div>
...
<div id="footer">
	<div class="box_footer">
				<div class="footer-left">
					&copy;2019
					<a href="http://www.irissz.com" class="Blue" target="_blank">爱瑞思</a> 
					<a class="Blue" href="http://www.miitbeian.gov.cn" target="_blank">粤ICP备11010329号</a>
				</div>
