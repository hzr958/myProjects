...
@Entity
@Table(name = "PUB_LIST")
public class PublicationListRol implements Serializable {

  /**
   * 
   */
  private static final long serialVersionUID = 8404992982995374875L;
  // 成果编号
  private Long id;
  ...
  public PublicationListRol() {
    super();
  }

  public PublicationListRol(Long id, Integer listEi, Integer listSci, Integer listIstp, Integer listSsci) {
    this.id = id;
    this.listEi = listEi;
