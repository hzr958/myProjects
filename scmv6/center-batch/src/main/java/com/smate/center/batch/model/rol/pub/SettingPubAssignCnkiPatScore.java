 ...
 */
@Entity
@Table(name = "SETTING_PUBASSIGN_CNKIPATSCORE")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class SettingPubAssignCnkiPatScore implements Serializable {

  /**
   * 
   */
  private static final long serialVersionUID = 5791564905119816446L;
  // 数据库ID
  private Long dbId;
  // 用户名称匹配分数
  private Float name;
