...
/**
 * @author yamingd 期刊实体 没有序列 供sns发送消息同步数据用.
 */
@Entity
@Table(name = "JOURNAL")
public class JournalNoSeq implements Serializable {

  /**
   * 
   */
  private static final long serialVersionUID = -387680852176101470L;
  private Long id;
  /**
   * 期刊中文名.
   */
  ...
  public JournalNoSeq(Long id) {
    super();
    this.id = id;
  }

  public JournalNoSeq(Long id, String zhName, String enName, String issn) {
    super();
    this.id = id;
    this.zhName = zhName;
    this.enName = enName;
  ...
  public JournalNoSeq(Long id, String zhName, String enName, String issn, Long matchBaseJnlId) {
    super();
    this.id = id;
    this.zhName = zhName;
    this.enName = enName;
