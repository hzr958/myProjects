 ...
 */
@Entity
@Table(name = "PUB_ASSIGN_PUBMEDSCORE")
public class PubAssignPubMedScore implements Serializable {

  /**
   * 
   */
  private static final long serialVersionUID = 2570852317122734593L;
  private Long id;
  // 成果ID
  private Long pubId;
  // 单位ID
  ...
  public PubAssignPubMedScore() {
    super();
  }

  public PubAssignPubMedScore(Long pubId, Long insId, Long psnId) {
    super();
    this.pubId = pubId;
    this.insId = insId;
    this.psnId = psnId;
  ...
  public PubAssignPubMedScore(PubAssignScoreDetail score) {
    super();
  ...
  public void copy(PubAssignPubMedScore score) {
  ...
  @Id
  @Column(name = "ID")
  @SequenceGenerator(name = "SEQ_STORE", sequenceName = "SEQ_PUB_ASSIGN_PUBMEDSCORE", allocationSize = 1)
