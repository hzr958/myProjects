 ...
 */
@Entity
@Table(name = "V_KEYWORD_SUBSET_DESC")
public class PubKeywordsSubsetDesc implements Serializable {

  /**
   * 
   */
  private static final long serialVersionUID = -7728071814726773733L;
  private Long id;
  private String branchMarkId;
  ...
  @Column(name = "BRANCH_MARK_ID")
  public String getBranchMarkId() {
    return branchMarkId;
  }

  public void setBranchMarkId(String branchMarkId) {
    this.branchMarkId = branchMarkId;
  }
