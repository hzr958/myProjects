...
/**
 * Cnipr成果匹配-成果指派，匹配部门任务.
 * 
 * @author liqinghua
 * 
 */
public class PubAssignMatchCniprDeptTask implements IPubAssignMatchTask {

  /**
   * 
   */
  private static final long serialVersionUID = -2593384089411439040L;
  private final String name = "PubAssignMatchCniprDeptTask";
  @Autowired
  ...
  private void pubDeptMatchPsnUnit(PubAssginMatchContext context, Map<Integer, PubAssignScoreMap> scoreMap)
    ...
    Map<Integer, String> deptMap =
        pubAssignCniprMatchService.getInsPubDept(seqNos, context.getPubId(), context.getInsId());
