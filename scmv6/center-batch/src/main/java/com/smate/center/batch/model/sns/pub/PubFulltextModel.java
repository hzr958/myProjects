 ...
 */
public class PubFulltextModel implements java.io.Serializable {
  ...
  public PubFulltextModel(String url, Long fileId, String fileName, String fileExt, Integer dbid, Integer fileNodeId,
      Long insId) {
