...
import com.smate.center.batch.model.pdwh.pub.cnki.CnkiPubDup;
import com.smate.center.batch.model.pdwh.pub.cnki.CnkiPubExtend;
import com.smate.center.batch.model.pdwh.pub.cnki.CnkiPubExtendOld;
import com.smate.center.batch.model.pdwh.pub.cnki.CnkiPublication;
...
public class CnkiPublicationDao extends PdwhHibernateDao<CnkiPublication, Long> {
  ...
  public CnkiPubExtendOld getCnkiPubExtendOld(Long pubId) {

    String hql = "from CnkiPubExtendOld t where t.pubId = ? ";
    return super.findUnique(hql, pubId);
  }
  ...
  public void saveCnkiPubDup(Long pubId, Long titleHash, Long unitHash) {
    CnkiPubDup dup = this.getCnkiPubDup(pubId);
    if (dup == null) {
      dup = new CnkiPubDup(pubId, titleHash, unitHash);
    } else {
   ...
   * @return
   */
  public CnkiPubDup getCnkiPubDup(Long pubId) {

    String hql = "from CnkiPubDup t where t.pubId = ? ";
    return super.findUnique(hql, pubId);
  }
