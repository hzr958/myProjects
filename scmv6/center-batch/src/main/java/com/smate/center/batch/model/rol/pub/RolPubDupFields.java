...
public class RolPubDupFields implements Serializable {

  /**
   * 
   */
  private static final long serialVersionUID = 7055209434969528912L;
  // 0:删除 1：未删除 4：单位未确认的
  ...
  public RolPubDupFields() {
    super();
  }

  public RolPubDupFields(Long pubId, Integer sourceDbId) {
    super();
    this.pubId = pubId;
