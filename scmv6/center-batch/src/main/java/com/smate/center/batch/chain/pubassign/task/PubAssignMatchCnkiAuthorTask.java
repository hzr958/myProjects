 ...
 * 
 */
public class PubAssignMatchCnkiAuthorTask implements IPubAssignMatchTask {

  /**
   * 
   */
  private static final long serialVersionUID = 3539525923266785260L;
  private final String name = "PubAssignMatchCnkiAuthorTask";
  @Autowired
  ...
  public boolean run(PubAssginMatchContext context) throws Exception {
    ...
    List<Object[]> matchedPsns =
        pubAssignCnkiMatchService.getCnkiNameMatchPubAuthor(context.getPubId(), context.getInsId());
