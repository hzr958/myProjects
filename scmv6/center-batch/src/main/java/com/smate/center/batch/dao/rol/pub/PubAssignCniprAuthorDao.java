...
public class PubAssignCniprAuthorDao extends RolHibernateDao<PubAssignCniprAuthor, Long> {
  ...
  public boolean isExistsPubAuthor(Long pubId) {
    ...
    String hql = "select count(id) from PubAssignCniprAuthor where pubId = ? ";
   ...
   * @return
   */
  public List<Object[]> getCniprNameMatchPubAuthor(Long pubId, Long insId) {

    StringBuilder hql = new StringBuilder();
    hql.append(
        "select distinct rp.pk.psnId,pa.seqNo,pa.insId from PubAssignCniprAuthor pa,PsnPmCnkiName pp,RolPsnIns rp ");
    // 用户必须在职
    hql.append(
  ...
  public List<Object[]> getCniprPubAuthorMatchPsn(Long psnId, Long insId) {

    StringBuilder hql = new StringBuilder();
    hql.append("select distinct pa.pubId,pa.seqNo,pa.insId from PubAssignCniprAuthor pa,PsnPmCnkiName pp ");
   ...
   */
  @SuppressWarnings("unchecked")
  public List<Object[]> getCniprConMatchPubAuthor(Long pubId, Set<Long> psnIds) {
    String hql =
        "select pp.psnId,count(pp.psnId) from PubAssignCniprAuthor pa ,PsnPmCnkiConame pp where pa.pubId =:pubId and pp.psnId in(:psnIds) and pp.name = pa.name group by pp.psnId ";
