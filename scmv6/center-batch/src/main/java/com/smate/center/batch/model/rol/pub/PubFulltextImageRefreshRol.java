...
public class PubFulltextImageRefreshRol implements Serializable {

  /**
   * 
   */
  private static final long serialVersionUID = 8026092734756872685L;
  ...
  public PubFulltextImageRefreshRol() {}

  public PubFulltextImageRefreshRol(Long pubId, Long fulltextFileId, Integer fulltextNode, String fulltextFileExt) {
    this.pubId = pubId;
