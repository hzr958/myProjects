 ...
 */
@Entity
@Table(name = "PUB_ASSIGN_CNIPRSCORE")
public class PubAssignCniprScore implements Serializable {

  /**
   * 
   */
  private static final long serialVersionUID = 907910868220388553L;
  private Long id;
  // 成果ID
  private Long pubId;
  // 单位ID
  ...
  public PubAssignCniprScore() {
    super();
  }

  public PubAssignCniprScore(Long pubId, Long insId, Long psnId) {
    super();
    this.pubId = pubId;
    this.insId = insId;
    this.psnId = psnId;
  ...
  public PubAssignCniprScore(PubAssignScoreDetail score) {
    super();
  ...
  public void copy(PubAssignCniprScore score) {
    this.name = score.getName();
    this.dept = score.getDept();
    this.keywords = score.getKeywords();
    this.coname = score.getConame();
  ...
  @Id
  @Column(name = "ID")
  @SequenceGenerator(name = "SEQ_STORE", sequenceName = "SEQ_PUB_ASSIGN_CNIPRSCORE", allocationSize = 1)
