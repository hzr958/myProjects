 ...
 */
@Entity
@Table(name = "PUBMED_PUBLICATION")
public class PubMedPublication implements Serializable {

  /**
   * 
   */
  private static final long serialVersionUID = -3883669791723309825L;
  private Long pubId;
  // 出版年份
  ...
  // 文献地址列表
  private List<PubMedPubAddr> pubAddrs;
  private String zhKeywords;
  private String enKeywords;

  @Id
  @Column(name = "PUB_ID")
  @SequenceGenerator(name = "SEQ_STORE", sequenceName = "SEQ_PUBMED_PUBLICATION", allocationSize = 1)
  ...
  @Transient
  public List<PubMedPubAddr> getPubAddrs() {
    return pubAddrs;
  }
  ...
  public void setPubAddrs(List<PubMedPubAddr> pubAddrs) {
