...
public class PsnReqInbox implements Serializable {

  /**
   * 
   */
  private static final long serialVersionUID = 3627507048598128801L;
  // 主键
  private Long Id;
  // 收件人Id
  private Long psnId;
  ...
  public PsnReqInbox(Long psnId, Integer status) {
    super();
    this.psnId = psnId;
    this.status = status;
  }
  ...
  public PsnReqMailBox getMailBox() {
    return mailBox;
  }
  ...
  public void setMailBox(PsnReqMailBox mailBox) {
