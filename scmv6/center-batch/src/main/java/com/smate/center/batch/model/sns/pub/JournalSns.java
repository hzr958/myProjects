...
@Entity
@Table(name = "JOURNAL")
public class JournalSns implements Serializable {
   ...
   * 
   */
  private static final long serialVersionUID = -3324822254849969215L;
  private Long id;
  /**
   * 期刊中文名.
   */
  ...
  public JournalSns(Long id) {
    super();
    this.id = id;
  }

  public JournalSns(Long id, String zhName, String enName, String issn) {
    super();
    this.id = id;
    this.zhName = zhName;
    this.enName = enName;
  ...
  public JournalSns(String zhName, String enName, String issn, Long matchBaseJnlId) {
    super();
    this.zhName = zhName;
    this.enName = enName;
    this.issn = issn;
  ...
  public JournalSns(Long id, String zhName, String enName, String issn, Long matchBaseJnlId) {
    super();
    this.id = id;
    this.zhName = zhName;
    this.enName = enName;
  ...
  public JournalSns(Long id, String zhName, String enName, String issn, String enameAlias, String zhNameAlias,
