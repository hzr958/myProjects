...
public class PubXmlDbUtils {
  ...
  public static boolean isRainPatDb(Integer sourceDbId) {
    ...
    return PubXmlConstants.SOURCE_RAINPAT == sourceDbId.longValue();
  }
  ...
  public static boolean isRainPatDb(String dbCode) {
    ...
    return PubXmlConstants.SOURCE_DBCODE_RAINPAT.equalsIgnoreCase(dbCode);
  }
  ...
  public static boolean isOalibDb(Integer oalibDbId) {
    ...
    return PubXmlConstants.SOURCE_OPEN_ACCESS_LIBRARY == oalibDbId.longValue();
  }
  ...
  public static boolean isOalibDb(String oalib) {
    ...
    return PubXmlConstants.SOURCE_DBCODE_OPEN_ACCESS_LIBRARY.equalsIgnoreCase(oalib);
  }
  ...
  public static boolean isRainPatDb(Long sourceDbId) {
    ...
    return PubXmlConstants.SOURCE_RAINPAT.equals(sourceDbId);
  }
