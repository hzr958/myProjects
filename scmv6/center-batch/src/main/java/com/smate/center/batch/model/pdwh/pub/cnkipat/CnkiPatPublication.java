 ...
 */
@Entity
@Table(name = "CNKIPAT_PUBLICATION")
public class CnkiPatPublication implements Serializable {

  /**
   * 
   */
  private static final long serialVersionUID = -51635882121277068L;
  private Long pubId;
  // 发表年份
  ...
  // 文献地址列表
  private List<CnkiPatPubAddr> pubAddrs;

  @Id
  @Column(name = "PUB_ID")
  @SequenceGenerator(name = "SEQ_STORE", sequenceName = "SEQ_CNKIPAT_PUBLICATION", allocationSize = 1)
  ...
  @Transient
  public List<CnkiPatPubAddr> getPubAddrs() {
    return pubAddrs;
  }
  ...
  public void setPubAddrs(List<CnkiPatPubAddr> pubAddrs) {
