 ...
 */
@Entity
@Table(name = "ISI_PUB_ADDR_EXC")
public class IsiPubAddrExc implements Serializable {

  /**
   * 
   */
  private static final long serialVersionUID = 6763576328732121880L;
  ...
  public IsiPubAddrExc() {
    super();
  }

  public IsiPubAddrExc(Long id, Long insId, Long addrHash) {
    super();
    this.id = id;
    this.insId = insId;
  ...
  public IsiPubAddrExc(Long insId, String addr, Long addrHash) {
    super();
    this.insId = insId;
    this.addr = addr;
    this.addrHash = addrHash;
