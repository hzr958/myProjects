...
/**
 * 微信个人消息历史表，V_WECHAT_MESSAGE_PSN表中的已处理和重复的信息
 * 
 * @since 6.0.1
 */
@Entity
@Table(name = "V_BATCH_WECHAT_HISTORY_PSN")
public class WeChatMessageHistoryPsn implements Serializable {


  /**
   * 
   */
  private static final long serialVersionUID = -486053131596837472L;

  @Id
  @Column(name = "ID")
  private Long id; // 主键id，与V_WECHAT_MESSAGE_PSN中Id对应
  ...
  public WeChatMessageHistoryPsn() {
    super();
  }
