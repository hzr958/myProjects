 ...
 */
@Entity
@Table(name = "DYNAMIC_MESSAGE_GROUP")
public class DynamicGroup implements Serializable {

  private static final long serialVersionUID = -6597574016866591997L;
  ...
  private Date createDate;// 动态产生时间
  ...
  public DynamicGroup(Long groupDynId, String dynJson) {
  ...
  @SequenceGenerator(name = "SEQ_STORE", sequenceName = "SEQ_DYNAMIC_MESSAGE_GROUP", allocationSize = 1)
