 ...
 */
@Repository
public class PubAssignEiAuthorDao extends RolHibernateDao<PubAssignEiAuthor, Long> {
  ...
  public boolean isExistsPubAuthor(Long pubId) {
    ...
    String hql = "select count(id) from PubAssignEiAuthor where pubId = ? ";
   ...
   * @return
   */
  public List<Object[]> getEiPrefixNameMatchPubAuthor(Long pubId, Long insId) {

    StringBuilder hql = new StringBuilder();
    hql.append(
        "select pa.seqNo,rp.pk.psnId,pa.insId,pa.initName,pa.fullName from PubAssignEiAuthor pa,PsnPmIsiName pp,RolPsnIns rp ");
   ...
   * @return
   */
  public List<Object[]> getEiNameMatchPubAuthor(Long pubId, Long insId) {
   ...
   * @return
   */
  public List<Object[]> getEiNameFullMatchPubAuthor(Long pubId, Long insId) {
  ...
  public List<Object[]> getEiInitNameMatchPubAuthor(Long pubId, Long insId, Set<Long> psnIds) {

    StringBuilder hql = new StringBuilder();

    hql.append("select distinct pa.seqNo,pp.psnId from PubAssignEiAuthor pa,PsnPmIsiName pp ");
    // 机构ID为空(=2)或者机构ID匹配上，作者名称匹配上
   ...
   */
  @SuppressWarnings("unchecked")
  public List<Object[]> getEiPubAuthorMatchPsnPrefixName(Long psnId, Long insId) {

    StringBuilder hql = new StringBuilder();
    hql.append("select pa.pubId,pa.seqNo,pa.insId,pa.initName,pa.fullName from PubAssignEiAuthor pa,PsnPmIsiName pp ");
   ...
   */
  @SuppressWarnings("unchecked")
  public List<Object[]> getEiPubAuthorMatchPsnName(Long psnId, Long insId) {
   ...
   */
  @SuppressWarnings("unchecked")
  public List<Object[]> getEiPubAuthorMatchPsnFullName(Long psnId, Long insId) {
   ...
   */
  @SuppressWarnings("unchecked")
  public List<Object[]> getEiFullNameMatchPubAuthor(Long pubId, Set<Long> psnIds, Long insId) {

    String hql =
        "select distinct pp.psnId,pa.seqNo from PubAssignEiAuthor pa,PsnPmIsiName pp where pa.pubId = :pubId and pp.psnId in(:psnIds) and (pp.type = 1 or pp.type = 4) and pa.fullName = pp.name and (pa.insId = :insId or pa.insId = 2)";
    Collection<Collection<Long>> container = ServiceUtil.splitList(psnIds, 80);
    List<Object[]> listResult = new ArrayList<Object[]>();
    for (Collection<Long> item : container) {
   ...
   */
  @SuppressWarnings("unchecked")
  public List<Object[]> getEiConMatchPubAuthor(Long pubId, Set<Long> psnIds) {
    String hql =
        "select pp.psnId,count(pp.psnId) from PubAssignEiAuthor pa ,PsnPmIsiConame pp where pa.pubId =:pubId and pp.psnId in(:psnIds) and (pp.initName = pa.initName or pp.fullName = pa.fullName) group by pp.psnId ";
    Collection<Collection<Long>> container = ServiceUtil.splitList(psnIds, 80);
    List<Object[]> listResult = new ArrayList<Object[]>();
    for (Collection<Long> item : container) {
   ...
   */
  @SuppressWarnings("unchecked")
  public List<Object[]> getEiCoeMatchPubAuthor(Long pubId, Set<Long> psnIds) {
    String hql =
        "select pp.psnId,count(pp.psnId) from PubAssignEiEmail pa ,PsnPmCoemailRol pp where pa.pubId =:pubId and pp.psnId in(:psnIds) and pp.email = pa.email group by pp.psnId ";
    Collection<Collection<Long>> container = ServiceUtil.splitList(psnIds, 80);
    List<Object[]> listResult = new ArrayList<Object[]>();
    for (Collection<Long> item : container) {
      listResult.addAll(super.createQuery(hql).setParameter("pubId", pubId).setParameterList("psnIds", item).list());
   ...
   * @return
   */
  public List<PubAssignEiAuthor> getPubAuthor(Long pubId) {

    String hql = "from PubAssignEiAuthor where pubId = ?  ";
