 ...
 * 
 */
public interface PubAssignSpsMatchService extends Serializable {
   ...
   * @throws ServiceException
   */
  public void saveAssignScore(PubAssignSpsScore pubAssignScore) throws ServiceException;
