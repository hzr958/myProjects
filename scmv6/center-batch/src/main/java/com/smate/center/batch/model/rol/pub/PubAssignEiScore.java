 ...
 */
@Entity
@Table(name = "PUB_ASSIGN_EISCORE")
public class PubAssignEiScore implements Serializable {

  /**
   * 
   */
  private static final long serialVersionUID = 5135995317025806483L;
  private Long id;
  // 成果ID
  private Long pubId;
  // 单位ID
  ...
  public PubAssignEiScore() {
    super();
  }

  public PubAssignEiScore(Long pubId, Long insId, Long psnId) {
    super();
    this.pubId = pubId;
    this.insId = insId;
    this.psnId = psnId;
  ...
  public PubAssignEiScore(PubAssignScoreDetail score) {
    super();
  ...
  public void copy(PubAssignEiScore score) {
  ...
  @Id
  @Column(name = "ID")
  @SequenceGenerator(name = "SEQ_STORE", sequenceName = "SEQ_PUB_ASSIGN_EISCORE", allocationSize = 1)
