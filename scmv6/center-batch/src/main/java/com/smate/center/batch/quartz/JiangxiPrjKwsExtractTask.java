 ...
 * 
 */
public class JiangxiPrjKwsExtractTask {
  ...
  public void doRun() throws BatchTaskException {
    List<BigDecimal> pdwhPubIdList = nsfcKeywordsService.getJiangxiPrjKwsToHandleKwList(SIZE);
    ...
    for (BigDecimal id : pdwhPubIdList) {
      ...
      Integer rs = 0;
      try {
        rs = this.nsfcKeywordsService.extractJiangxiPrjKws(prjId);
