...
public class PubXmlDocument {
  ...
  public void fillPubList(PdwhPubSourceDb pubSourceDb, Integer dbid) {
    if (this.xmlDocument == null) {
      throw new java.lang.NullPointerException("xmlDocument can't be null.");
    }
    PubXmlDocument.fillPubList(this, pubSourceDb, dbid);
  }

  private static void fillPubList(PubXmlDocument pubXmlDocument, PdwhPubSourceDb pubSourceDb, Integer dbid) {
    if (pubSourceDb.getSci() != null && pubSourceDb.getSci() != 0) {
    ...
    if (pubSourceDb.getIstp() != null && pubSourceDb.getIstp() != 0) {
    ...
    if (pubSourceDb.getSsci() != null && pubSourceDb.getSsci() != 0) {
    ...
    if (pubSourceDb.getEi() != null && pubSourceDb.getEi() != 0) {
    ...
    if (pubSourceDb.getCnki() != null && pubSourceDb.getCnki() != 0) {
      pubXmlDocument.setXmlNodeAttribute(PubXmlConstants.PUB_LIST_XPATH, "list_cnki", "1");
      if (dbid == 4) {
        pubXmlDocument.setXmlNodeAttribute(PubXmlConstants.PUB_LIST_XPATH, "list_cnki_source", "1");
      }
    }
    if (pubSourceDb.getCnkiPat() != null && pubSourceDb.getCnkiPat() != 0) {
      pubXmlDocument.setXmlNodeAttribute(PubXmlConstants.PUB_LIST_XPATH, "list_cnkipat", "1");
      if (dbid == 21) {
        pubXmlDocument.setXmlNodeAttribute(PubXmlConstants.PUB_LIST_XPATH, "list_cnkipat_source", "1");
      }
    }
  }
