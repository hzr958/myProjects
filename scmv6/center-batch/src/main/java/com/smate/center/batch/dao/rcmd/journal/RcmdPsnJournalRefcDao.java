...
import com.smate.center.batch.model.rcmd.journal.RcmdPsnJournalRefc;
 ...
 */
@Repository
public class RcmdPsnJournalRefcDao extends RcmdHibernateDao<RcmdPsnJournalRefc, Long> {
  ...
  public int getPsnJnlByRefc(Long psnId, String issn) {
    String hql = "select count(id) from RcmdPsnJournalRefc where psnId=? and issnTxt=?";
