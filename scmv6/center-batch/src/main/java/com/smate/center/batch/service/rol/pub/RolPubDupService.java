 ...
 * 
 */
public interface RolPubDupService extends Serializable {
   ...
   * @throws ServiceException
   */
  public Map<Integer, List<Long>> getDupPub(RolPubDupFields dupFields, Long ownerId) throws ServiceException;
