...
public class PsnPmJournalRol implements Serializable {

  /**
   * 
   */
  private static final long serialVersionUID = -192690842286695173L;
  ...
  public PsnPmJournalRol() {
    super();
  }

  public PsnPmJournalRol(Long jid, String jname, String issn, Long psnId) {
    super();
    this.jid = jid;
    this.jname = jname;
    this.issn = issn;
