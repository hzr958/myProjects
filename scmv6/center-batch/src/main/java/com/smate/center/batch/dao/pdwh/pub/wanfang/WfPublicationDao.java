...
import com.smate.center.batch.model.pdwh.pub.wanfang.WfPubExtendOld;
...
public class WfPublicationDao extends PdwhHibernateDao<WfPublication, Long> {
  ...
  public WfPubExtendOld getWfPubExtendOld(Long pubId) {

    String hql = "from WfPubExtendOld t where t.pubId = ? ";
    return super.findUnique(hql, pubId);
  }
