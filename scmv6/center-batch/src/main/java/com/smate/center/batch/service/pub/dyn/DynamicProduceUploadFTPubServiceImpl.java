 ...
 * 
 */
@Service("dynamicProduceUploadFTPubService")
@Transactional(rollbackFor = Exception.class)
public class DynamicProduceUploadFTPubServiceImpl extends DynamicProduceAbstract {

  /**
   * 
   */
  private static final long serialVersionUID = -6788334133270708413L;
  @Autowired
  ...
  public void produceDynamic(String jsonParam) {
    ...
    try {
      ...
      jsonObject.accumulate("tmpId", DynamicConstant.DYNMSG_TEMPLATE_UPLODFULLTEXT);
