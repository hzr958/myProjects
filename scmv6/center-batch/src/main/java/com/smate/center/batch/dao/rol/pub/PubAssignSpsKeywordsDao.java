...
public class PubAssignSpsKeywordsDao extends RolHibernateDao<PubAssignSpsKeywords, Long> {
  ...
  public boolean isExitKeyWords(Long pubId, Integer keyHash) {
    ...
    String hql = "select count(id) from PubAssignSpsKeywords where pubId = ? and keyHash = ? ";
  ...
  public Map<Long, Long> getKwMatchPubKw(Long pubId, Set<Long> psnIds) {
    ...
    String kwhql = "select pa.keyHash from PubAssignSpsKeywords pa where pa.pubId = ? ";
