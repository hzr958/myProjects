...
public class OpenProject implements Serializable {
  ...
  public OpenProject(String token, String internalNo, String externalNo, Integer isPrincipalIns, String state,
      Long schemeId, Integer fundingYear, String agencyName, String schemeName, String type, Integer startYear,
      Integer startMonth, Integer startDay, Integer endYear, Integer endMonth, Integer endDay, Long insId,
      String insName, Long psnId, Integer dbId, String zhTitle, String enTitle, String authorNames, Long agencyId,
      BigDecimal amount, String amountUnit, String authorNamesEn, String enAgencyName, String enSchemeName,
      Long openId) {
    super();
    this.token = token;
