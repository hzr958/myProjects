...
public class PsnInsideInbox implements Serializable {
   ...
   * 
   */
  private static final long serialVersionUID = -7734352630864690619L;
  ...
  // 邮件
  private PsnInsideMailBox mailBox;
  ...
  public PsnInsideMailBox getMailBox() {
    return mailBox;
  }
   ...
   */
  public void setMailBox(PsnInsideMailBox mailBox) {
