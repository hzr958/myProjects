...
/**
 * CnkiPat成果匹配-成果指派，匹配部门任务.
 * 
 * @author liqinghua
 * 
 */
public class PubAssignMatchCnkiPatDeptTask implements IPubAssignMatchTask {

  /**
   * 
   */
  private static final long serialVersionUID = -2532495513596273007L;
  private final String name = "PubAssignMatchCnkiPatDeptTask";
  @Autowired
  ...
  private void pubDeptMatchPsnUnit(PubAssginMatchContext context, Map<Integer, PubAssignScoreMap> scoreMap)
    ...
    Map<Integer, String> deptMap =
        pubAssignCnkiPatMatchService.getInsPubDept(seqNos, context.getPubId(), context.getInsId());
