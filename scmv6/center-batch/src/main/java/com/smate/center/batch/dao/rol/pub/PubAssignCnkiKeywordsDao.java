...
public class PubAssignCnkiKeywordsDao extends RolHibernateDao<PubAssignCnkiKeywords, Long> {
  ...
  public boolean isExitKeyWords(Long pubId, Integer keyHash) {
    ...
    String hql = "select count(id) from PubAssignCnkiKeywords where pubId = ? and keyHash = ? ";
  ...
  public Map<Long, Long> getKwMatchPubKw(Long pubId, Set<Long> psnIds) {
    ...
    String kwhql = "select pa.keyHash from PubAssignCnkiKeywords pa where pa.pubId = ? ";
  ...
  public List<PubAssignCnkiKeywords> getKwByPubId(Long pubId) {
    String hql = "from PubAssignCnkiKeywords where pubId = ? ";
