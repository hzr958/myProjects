...
public class PsnJournalRefc implements Serializable {

  /**
   * 
   */
  private static final long serialVersionUID = 3195427835844283671L;
  private Long id;
  // 成果所有人
  private Long psnId;
  // ISSN
  ...
  public PsnJournalRefc() {
    super();
  }

  public PsnJournalRefc(Long psnId, String issn, String issnTxt) {
    super();
    this.psnId = psnId;
    this.issn = issn;
