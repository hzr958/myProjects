 ...
 */
@Entity
@Table(name = "CNKI_PUBLICATION")
public class CnkiPublication implements Serializable {

  /**
   * 
   */
  private static final long serialVersionUID = -1190538108611918972L;
  ...
  // 文献地址列表
  private List<CnkiPubAddr> pubAddrs;
  ...
  @Id
  @Column(name = "PUB_ID")
  @SequenceGenerator(name = "SEQ_STORE", sequenceName = "SEQ_CNKI_PUBLICATION", allocationSize = 1)
  ...
  @Transient
  public List<CnkiPubAddr> getPubAddrs() {
    return pubAddrs;
  }
  ...
  public void setPubAddrs(List<CnkiPubAddr> pubAddrs) {
