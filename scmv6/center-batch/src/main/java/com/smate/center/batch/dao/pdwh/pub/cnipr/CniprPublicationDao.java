...
import com.smate.center.batch.model.pdwh.pub.cnipr.CniprPubDup;
import com.smate.center.batch.model.pdwh.pub.cnipr.CniprPubExtend;
import com.smate.center.batch.model.pdwh.pub.cnipr.CniprPubExtendOld;
import com.smate.center.batch.model.pdwh.pub.cnipr.CniprPublication;
...
public class CniprPublicationDao extends PdwhHibernateDao<CniprPublication, Long> {
  ...
  public CniprPubExtendOld getCniprPubExtendOld(Long pubId) {

    String hql = "from CniprPubExtendOld t where t.pubId = ? ";
    return super.findUnique(hql, pubId);
  }
