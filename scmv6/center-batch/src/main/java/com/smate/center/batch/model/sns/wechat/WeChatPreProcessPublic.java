...
/**
 * 微信群发消息查重表，对V_WECHAT_MESSAGE_PUBLIC查重
 * 
 * @since 6.0.1
 */
@Entity
@Table(name = "V_BATCH_PRE_WECHAT_PUBLIC")
public class WeChatPreProcessPublic implements Serializable {


  /**
   * 
   */
  private static final long serialVersionUID = -1979988255486191715L;
