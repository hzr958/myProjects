 ...
 */
@Entity
@Table(name = "EI_PUB_MADDR")
public class EiPubMaddr implements Serializable {

  /**
   * 
   */
  private static final long serialVersionUID = -3044447041108308676L;
  ...
  public EiPubMaddr(Long maddrId, Long addrId, Long insId, Long pubId, String addr, Integer matched, String protoAddr) {
    super();
  ...
  public EiPubMaddr(Long addrId, Long insId, Long pubId, String addr, String protoAddr) {
    super();
    this.addrId = addrId;
    this.insId = insId;
    this.pubId = pubId;
  ...
  @Column(name = "EI_NAME_ID")
  public Long getEiNameId() {
    return eiNameId;
  }
  ...
  public void setEiNameId(Long eiNameId) {
    this.eiNameId = eiNameId;
  }
