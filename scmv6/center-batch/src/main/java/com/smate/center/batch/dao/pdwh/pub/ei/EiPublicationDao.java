...
import com.smate.center.batch.model.pdwh.pub.ei.EiPubDup;
import com.smate.center.batch.model.pdwh.pub.ei.EiPubExtend;
import com.smate.center.batch.model.pdwh.pub.ei.EiPubExtendOld;
import com.smate.center.batch.model.pdwh.pub.ei.EiPublication;
...
public class EiPublicationDao extends PdwhHibernateDao<EiPublication, Long> {
  ...
  public EiPubExtendOld getEiPubExtendOld(Long pubId) {

    String hql = "from EiPubExtendOld t where t.pubId = ? ";
    return super.findUnique(hql, pubId);
  }
  ...
  public void saveEiPubDup(Long pubId, Long sourceIdHash, Long titleHash, Long unitHash) {
    EiPubDup dup = this.getIsiPubDup(pubId);
    if (dup == null) {
      dup = new EiPubDup(pubId, sourceIdHash, titleHash, unitHash);
    } else {
   ...
   * @return
   */
  public EiPubDup getIsiPubDup(Long pubId) {

    String hql = "from EiPubDup t where t.pubId = ? ";
    return super.findUnique(hql, pubId);
  }
