 ...
 */
@Entity
@Table(name = "V_KEYWORD_SUBSET_COTF")
public class PubKeywordsSubsetsCotf implements Serializable, Comparable<PubKeywordsSubsetsCotf> {
  ...
  public PubKeywordsSubsetsCotf() {
    super();
  }

  public PubKeywordsSubsetsCotf(Long id, Integer size, String discode, Integer counts) {
    super();
    this.id = id;
    this.size = size;
  ...
  @Override
  public int compareTo(PubKeywordsSubsetsCotf o) {
