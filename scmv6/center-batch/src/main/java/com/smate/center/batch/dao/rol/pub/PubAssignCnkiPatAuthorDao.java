...
public class PubAssignCnkiPatAuthorDao extends RolHibernateDao<PubAssignCnkiPatAuthor, Long> {
  ...
  public boolean isExistsPubAuthor(Long pubId) {
    ...
    String hql = "select count(id) from PubAssignCnkiPatAuthor where pubId = ? ";
   ...
   * @return
   */
  public List<Object[]> getCnkiPatNameMatchPubAuthor(Long pubId, Long insId) {

    StringBuilder hql = new StringBuilder();
    hql.append(
        "select distinct rp.pk.psnId,pa.seqNo,pa.insId from PubAssignCnkiPatAuthor pa,PsnPmCnkiName pp,RolPsnIns rp ");
    // 用户必须在职
    hql.append(
  ...
  public List<Object[]> getCnkiPatPubAuthorMatchPsn(Long psnId, Long insId) {

    StringBuilder hql = new StringBuilder();
    hql.append("select distinct pa.pubId,pa.seqNo,pa.insId from PubAssignCnkiPatAuthor pa,PsnPmCnkiName pp ");
   ...
   */
  @SuppressWarnings("unchecked")
  public List<Object[]> getCnkiPatConMatchPubAuthor(Long pubId, Set<Long> psnIds) {
    String hql =
        "select pp.psnId,count(pp.psnId) from PubAssignCnkiPatAuthor pa ,PsnPmCnkiConame pp where pa.pubId =:pubId and pp.psnId in(:psnIds) and pp.name = pa.name group by pp.psnId ";
