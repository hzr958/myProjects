 ...
 * 
 */
public interface EiPubInsMatchService extends Serializable {
   ...
   * @throws ServiceException
   */
  public Integer matchPubCache(Long insId, Long pubId, List<EiPubAddr> orgs) throws ServiceException;
