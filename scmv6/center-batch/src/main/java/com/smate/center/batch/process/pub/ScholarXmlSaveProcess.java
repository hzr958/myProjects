...
/**
 * @author yamingd 成果保存XML
 */
public class ScholarXmlSaveProcess extends BasePubXmlProcess {
  ...
  public void setNextProcess(IPubXmlProcess process) {
    if (process != null) {
      ...
      if (name.endsWith("ScholarXmlSaveProcess")) {
        return;
      }
    }
  ...
  public void setTasks(List<IPubXmlTask> tasks) {
    ...
    logger.info("初始化ScholarXmlSaveProcess Tasks成功");
  }
