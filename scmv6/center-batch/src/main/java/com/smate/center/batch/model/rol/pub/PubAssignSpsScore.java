 ...
 */
@Entity
@Table(name = "PUB_ASSIGN_SPSSCORE")
public class PubAssignSpsScore implements Serializable {

  /**
   * 
   */
  private static final long serialVersionUID = -5201752894178573716L;
  private Long id;
  // 成果ID
  private Long pubId;
  // 单位ID
  ...
  public PubAssignSpsScore() {
    super();
  }

  public PubAssignSpsScore(Long pubId, Long insId, Long psnId) {
    super();
    this.pubId = pubId;
    this.insId = insId;
    this.psnId = psnId;
  ...
  public PubAssignSpsScore(PubAssignScoreDetail score) {
    super();
  ...
  public void copy(PubAssignSpsScore score) {
  ...
  @Id
  @Column(name = "ID")
  @SequenceGenerator(name = "SEQ_STORE", sequenceName = "SEQ_PUB_ASSIGN_SPSSCORE", allocationSize = 1)
