 ...
 */
@Repository
public class PubAssignCnkiDeptDao extends RolHibernateDao<PubAssignCnkiDept, Long> {
  ...
  public List<Object[]> getInsPubDept(List<Integer> seqNos, Long pubId, Long insId) {
    ...
    String hql =
        "select seqNo,deptName from PubAssignCnkiDept where pubId = :pubId and insId = :insId and seqNo in(:seqNos)";
