...
public class PsnPmKeyWordRol implements Serializable {

  /**
   * 
   */
  private static final long serialVersionUID = 2613603025418257476L;
  ...
  public PsnPmKeyWordRol() {
    super();
  }

  public PsnPmKeyWordRol(String keyword, Integer kwhash, Long psnId) {
    super();
  ...
  public boolean equals(Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    PsnPmKeyWordRol other = (PsnPmKeyWordRol) obj;
    if (id == null) {
      if (other.id != null)
        return false;
