 ...
 */
@Entity
@Table(name = "SETTING_PUBASSIGN_PUBMEDSCORE")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class SettingPubAssignPubMedScore implements Serializable {

  /**
   * 
   */
  private static final long serialVersionUID = 1050299558469467617L;
  // 数据库ID
  private Long dbId;
  // 用户全称匹配分数
