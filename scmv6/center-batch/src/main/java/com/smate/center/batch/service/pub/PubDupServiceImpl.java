...
import com.smate.center.batch.dao.sns.pub.PubDupDao;
import com.smate.center.batch.dao.sns.pub.PubDuplicateDAO;
...
public class PubDupServiceImpl implements PubDupService {
  ...
  private final Logger logger = LoggerFactory.getLogger(PubDupServiceImpl.class);
  @Autowired
   ...
   */
  private List<PubDupFields> getDupBySourceId(PubDupParam param, Long ownerId, Long excludePubId, Integer status)
      throws ServiceException {
   ...
   * @throws ServiceException
   */
  private List<PubDupFields> getDupByDoiId(PubDupParam param, Long ownerId, Long excludePubId, Integer status)
      throws ServiceException {
    try {
      // doi
   ...
   * @throws ServiceException
   */
  private List<PubDupFields> getDupByJournal(PubDupParam param, Long ownerId, Long excludePubId, Integer status)
      throws ServiceException {
    Assert.notNull(ownerId, "ownerid不能为空");
    Assert.notNull(param, "param不能为空");
   ...
   * @throws ServiceException
   */
  private List<PubDupFields> getDupByConference(PubDupParam param, Long ownerId, Long excludePubId, Integer status)
      throws ServiceException {
    Assert.notNull(ownerId, "ownerid不能为空");
    Assert.notNull(param, "param不能为空");
    Assert.notNull(param.getPubType(), "PubType不能为空");
   ...
   * @throws ServiceException
   */
  private List<PubDupFields> getDupByPatent(PubDupParam param, Long ownerId, Long excludePubId, Integer status)
      throws ServiceException {
    Assert.notNull(ownerId, "ownerid不能为空");
    Assert.notNull(param, "param不能为空");
    Assert.notNull(param.getPubType(), "PubType不能为空");
   ...
   * @throws ServiceException
   */
  private Map<Integer, List<PubDupFields>> getTitleDupPub(PubDupParam param, Long ownerId, Integer status)
      throws ServiceException {
  ...
  public Map<Integer, List<PubDupFields>> getDupPubField(Long pubId) throws ServiceException {
    return this.getDupPubField(pubId, PubDupFields.NORMAL_STATUS);
  }

  @Override
  public Map<Integer, List<PubDupFields>> getDupPubField(Long pubId, Integer status) throws ServiceException {
    try {
      PubDupFields dupFields = this.pubDupDao.getPubDupFields(pubId);
      if (dupFields == null) {
        return null;
      }
   ...
   * @return
   */
  public List<Long> covertDupFieldToId(Map<Integer, List<PubDupFields>> dupmap) {
    List<Long> dupIds = new ArrayList<Long>();
    if (MapUtils.isEmpty(dupmap)) {
      return dupIds;
    }
  ...
  @Override
  public Map<Integer, List<Long>> getDupPub(PubDupFields dupFields, Long owner) throws ServiceException {
    try {
  ...
  public Map<Integer, List<PubDupFields>> getDupPubField(PubDupParam param, Long ownerId) throws ServiceException {
    try {
      return this.getDupPubField(param, ownerId, null, PubDupFields.NORMAL_STATUS);
    } catch (Exception e) {
  ...
  public Map<Integer, List<PubDupFields>> getDupPubField(PubDupParam param, Long ownerId, Long excludeId)
      throws ServiceException {
    return this.getDupPubField(param, ownerId, excludeId, PubDupFields.NORMAL_STATUS);
  }
  ...
  public Map<Integer, List<PubDupFields>> getDupPubField(PubDupParam param, Long ownerId, Long excludeId,
    ...
    try {
      Map<Integer, List<PubDupFields>> map = new HashMap<Integer, List<PubDupFields>>();
      // souce_id查重
      List<PubDupFields> dupList = this.getDupBySourceId(param, ownerId, excludeId, status);
      if (CollectionUtils.isNotEmpty(dupList)) {
        map.put(1, dupList);
        return map;
      }
  ...
  public PubDupFields savePubDupFields(PubDupParam param, Integer pubType, Long pubId, Long ownerId,
    ...
    Integer status = PubDupFields.DELETE_STATUS;
    if (canDup) {
      status = PubDupFields.NORMAL_STATUS;
    }
  ...
  public List<Long> getStrictDupPubByImportPub(Element pubEle, Long ownerId) throws ServiceException {
    return this.getStrictDupPubByImportPub(pubEle, ownerId, PubDupFields.NORMAL_STATUS);
  }
  ...
  public List<Long> getStrictDupPubByImportPub(Element pubEle, Long ownerId, Integer status) throws ServiceException {
    try {
      PubDupParam param = buildImportPubDupParam(pubEle);
      Map<Integer, List<PubDupFields>> dupmap = this.getDupPubField(param, ownerId, null, status);
  ...
  public PubDuplicatePO getPubDuplicatePO(Long pubId) {
    return pubDuplicateDao.get(pubId);
  }
}
