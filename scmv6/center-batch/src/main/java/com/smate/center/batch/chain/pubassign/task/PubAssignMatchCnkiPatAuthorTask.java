 ...
 * 
 */
public class PubAssignMatchCnkiPatAuthorTask implements IPubAssignMatchTask {

  /**
   * 
   */
  private static final long serialVersionUID = -5198904879856453181L;
  private final String name = "PubAssignMatchCnkiPatAuthorTask";
  @Autowired
  ...
  public boolean run(PubAssginMatchContext context) throws Exception {
    ...
    List<Object[]> matchedPsns =
        pubAssignCnkiPatMatchService.getCnkiPatNameMatchPubAuthor(context.getPubId(), context.getInsId());
