 ...
 */
@Entity
@Table(name = "SETTING_PUBASSIGN_SPSSCORE")
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
public class SettingPubAssignSpsScore implements Serializable {

  /**
   * 
   */
  private static final long serialVersionUID = 4099033569546859227L;
  // 数据库ID
  private Long dbId;
  // 用户全称匹配分数
