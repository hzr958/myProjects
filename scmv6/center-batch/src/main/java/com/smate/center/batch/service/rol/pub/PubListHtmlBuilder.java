 ...
 * 
 */
public class PubListHtmlBuilder extends PubAbstractHtmlBuilder {
  ...
  public Map<String, Object> invoke(Object... params) throws ServiceException {
    try {
      ...
      resultMap.put(TemplateConstants.EN_TEMPLATE, "publication_common_list_template_en_US.ftl");
      resultMap.put(TemplateConstants.ZH_TEMPLATE, "publication_common_list_template_zh_CN.ftl");
      return resultMap;
    } catch (Exception e) {
  ...
  public Integer getTempCode() throws ServiceException {
    return PubHtmlContants.PUB_LIST_TEM_CODE;
  }
