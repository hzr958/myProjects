...
@Entity
@Table(name = "JOURNAL")
public class JournalRol implements java.io.Serializable {


  /**
   * 
   */
  private static final long serialVersionUID = -525590375429701742L;
  private Long id;
  /**
   * 期刊中文名.
   */
  ...
  public JournalRol(Long id) {
    super();
    this.id = id;
  }

  public JournalRol(Long id, String zhName, String enName, String issn) {
    super();
    this.id = id;
    this.zhName = zhName;
    this.enName = enName;
  ...
  public JournalRol(Long id, String zhName, String enName, String issn, Long matchBaseJnlId) {
    super();
    this.id = id;
    this.zhName = zhName;
    this.enName = enName;
