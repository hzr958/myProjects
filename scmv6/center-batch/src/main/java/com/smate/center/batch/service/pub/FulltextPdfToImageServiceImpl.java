...
import com.smate.center.batch.dao.sns.pub.PubFulltextUploadLogDao;
import com.smate.center.batch.dao.sns.v8pub.PubFullTextDAO;
...
public class FulltextPdfToImageServiceImpl implements FulltextPdfToImageService {
  ...
  public void ConvertPdwhPubFulltextPdfToimage(PdwhPubFullTextPO pubFulltext) {
    try {
      ...
      // pdf生成缩略图
      GMImageUtil.thumbnail(ArchiveFileUtil.THUMBNAIL_WIDTH_72, ArchiveFileUtil.THUMBNAIL_HEIGHT_92, true, srcFilePath,
          destThumbPath);
      ...
      // }
      // // 高清图转缩略图
      // GMImageUtil.sample(ArchiveFileUtil.PDWH_THUMBNAIL_WIDTH_178,
      // ArchiveFileUtil.PDWH_THUMBNAIL_HEIGHT_239, false,
