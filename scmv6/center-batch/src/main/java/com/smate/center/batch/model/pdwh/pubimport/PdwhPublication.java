...
public class PdwhPublication implements Serializable {
  ...
  private String organizationSpec;
  private String isbn;
  private String issn;
  ...
  private Long unitHash;// 老基准库查重计算hash
  private Long patentNoHash;
  private Long patentOpenNoHash;
  private List<PdwhPubAddr> pubAddrs;
  private String xmlString; // 导入xml文件
  private ImportPubXmlDocument xmlDocument;// xml doc
  ...
  public PdwhPublication(String zhTitle, String enTitle, Integer pubType, Integer pubYear) {
    super();
  ...
  @Transient
  public List<PdwhPubAddr> getPubAddrs() {
    return pubAddrs;
  }

  public void setPubAddrs(List<PdwhPubAddr> pubAddrs) {
  ...
  @Transient
  public ImportPubXmlDocument getXmlDocument() {
    return xmlDocument;
  }

  public void setXmlDocument(ImportPubXmlDocument xmlDocument) {
