...
<div class="header-main__actions">
  <div class="header-main__actions_item" onclick="toReqFullTextMsg();">
    ...
    <div class="header-main__actions_item-tip">
      <spring:message code='page.main.full_request' />
    </div>
  </div>
  <div class="header-main__actions_item" onclick="toChatMsg();">
    ...
    <div class="header-main__actions_item-tip">
      <spring:message code='page.main.inner.message' />
    </div>
  </div>
      ...
      <ul class="menu__list">
        <li class="menu__item">
          <div class="menu-item__content">
            <div class="menu-item__content_main" onclick="toPsnSettings();">
              <spring:message code='page.main.selfSetting' />
            </div>
        ...
        <li class="menu__item">
          <div class="menu-item__content">
            <div class="menu-item__content_main" onclick="toChangeSites();">
              <spring:message code='page.main.scholmate_online' />
            </div>
            <div class="menu-item__content_icon"></div>
          </div>
        </li>
        <li class="menu__item">
          <div class="header-main__actions_link"
            ...
            <spring:message code='page.main.online' />
          </div>
        </li>
        <li class="menu__item" id="change_sie_role_li" style="display: none;">
          <div class="menu-item__content">
            <div class="menu-item__content_main"
              ...
              <spring:message code="skin.main.switchrole" />
            </div>
            <div class="menu-item__content_icon"></div>
          </div>
        </li>
        ...
        <li class="menu__item">
          <div class="menu-item__content">
            <div class="menu-item__content_main"
              ...
              <spring:message code='skins.main.jsp.logout' />
            </div> 
            <div class="menu-item__content_icon"></div>
          </div>
        </li>
  ...
  <i class="dev_material-icons" style="margin-left: -10px; cursor: pointer;" onclick="BaseUtils.expand_more(event)">expand_more</i>
