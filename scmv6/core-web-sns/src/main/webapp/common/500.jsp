...
window.onload = function(){
  ...
  if (reg.test(sUserAgent)){
    ...
    document.getElementByClassName("pc_error_tips").style.display="none";
  }else{
    document.getElementById("mobile_error_tips").style.display="none";
    document.getElementByClassName("pc_error_tips").style.display="block";
  }
}
...
<body>
  <fmt:bundle basename="resource.jsp500Resource">
    ...
    <div style="position:absolute; padding-top:50%; left:0; text-align:center; width:100%;font-size: 40px;display:none;" id="mobile_error_tips">
      <div><img src="http://dev.scholarmate.com/resmod/images_v5/error/data_error.png"></div>
      <div>系统正忙，请稍后再试</div>
      <div style="text-align: center; margin-top: 50px; color: #ca2a22;">
          <a href="/oauth/index"><span>首页</span></a>
          <span onclick="document.location.reload();">上一页</span>
      </div>
    </div>
    <!-- 移动端500错误   end -->
  </fmt:bundle>
