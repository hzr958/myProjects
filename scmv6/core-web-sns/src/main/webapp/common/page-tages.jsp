  ...
  <div class="web-Page">
    ...
    <div class="Jump-page">
      <s:if test="page.isHasPre()">
        <a class="Blue" href="#" onclick="page.submit('${page.pageNo-1}');"><s:text name='page.prePage' /></a>
      </s:if>
      <s:else>
      ...
      <s:if test="page.pageNo<=page.listNum/2+1">
        <c:forEach begin="1" end="${page.totalPages<=page.listNum?page.totalPages:page.listNum}" var="tmp">
          <a class="${tmp eq page.pageNo?'Blue b':''}" href="#" onclick="page.submit('${tmp}');">${tmp}</a>
        </c:forEach>
      </s:if>
      ...
      <s:if test="page.isHasNext()">
        <a class="Blue" href="#" onclick="page.submit('${page.pageNo+1}');"><s:text name='page.nextPage' /></a>
      </s:if>
      <s:else>
      ...
      <a class="uiButton" onclick="page.topage()" title="<s:text name='common.label.confirm'/>" href="#"><s:text
