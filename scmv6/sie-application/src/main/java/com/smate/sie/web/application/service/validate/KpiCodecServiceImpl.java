 ...
 *
 */
@Service("kpiCodecService")
public class KpiCodecServiceImpl implements KpiCodecService, InitializingBean {

    protected static Logger logger = LoggerFactory.getLogger(KpiCodecServiceImpl.class);
