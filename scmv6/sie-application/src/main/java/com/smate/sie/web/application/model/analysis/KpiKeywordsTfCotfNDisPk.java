...
@Embeddable
public class KpiKeywordsTfCotfNDisPk implements Serializable {
  ...
  public KpiKeywordsTfCotfNDisPk() {
    super();
  }

  public KpiKeywordsTfCotfNDisPk(String sub3DisCode, String kwFirst) {
    super();
