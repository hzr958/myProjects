 ...
 */
@Entity
@Table(name = "V_MAIL_ORIGINAL_DATA")
public class MailOriginalData implements Serializable {
  private static final long serialVersionUID = -7901325799961548662L;
  @Id
  @Column(name = "MAIL_ID")
  @SequenceGenerator(name = "SEQ_STORE", sequenceName = "V_SEQ_MAIL_ORIGINAL_DATA", allocationSize = 1)
  ...
  @Column(name = "STATUS")
  private Integer status;// 构造状态 0=待构造邮件 1=构造成功 2=构造失败 3=用户不接收此类邮件
  @Column(name = "MSG")
