...
<c:if test="${not empty grpInfos && fn:length(grpInfos) > 0}">
    <c:forEach items="${grpInfos }" var="grpInfo">
        <div class="new-mobileContact_item grp main-list__item" onclick="MobileGrpFile.choose(this,'grp')"  des3GrpId = "${grpInfo.des3GrpId }">
           <div class="new-mobileContact_item-infor">
             <div class="new-mobileContact_item-content"  style="text-align: left;">
               <div class="new-mobileContact_item-author">${grpInfo.grpBaseInfo.grpName }</div>
             </div>
           </div>
