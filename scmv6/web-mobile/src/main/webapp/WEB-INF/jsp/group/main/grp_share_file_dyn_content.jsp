        ...
        <div class="pub-idx__base-info">
            <div class="pub-idx__full-text_box">
                ...
                des3fileid="${jsonDynInfo.FULL_TEXT_FIELD}">
                 <a class="pub-idx__full-text_newbox-avator" onclick='Group.openResDetails("${jsonDynInfo.DES3_RES_ID}", "${jsonDynInfo.RES_TYPE }", event, "${jsonDynInfo.RES_NOT_EXISTS }", "img")'>
                    <img src="<iris:fileIcon fileType='${jsonDynInfo.FILE_TYPE}' defaultSrc='${jsonDynInfo.FILE_IMAGE}'/>" onerror="this.src='/resmod/smate-pc/img/fileicon_default.png'"/>
            ...
            <div class="pub-idx__main_box">
                <div class="pub-idx__main">
                    <div class="pub-idx__main_title">
                        ...
                        ${jsonDynInfo.RES_NAME}</a>
                    </div>
                    <div class="pub-idx__main_author"></div>
                    <div class="pub-idx__main_src pub-idx__main_src-line">${jsonDynInfo.RES_DESC}</div>
                </div>
            </div>
        </div>
    </div>
