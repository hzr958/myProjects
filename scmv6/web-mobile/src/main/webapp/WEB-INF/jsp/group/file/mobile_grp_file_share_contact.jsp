...
<head>
    ...
    <script type="text/javascript">
       $(function(){
          //加载好友列表,并将已经勾选的选中
         MobileGrpFile.showChooseList($.trim($("#m_grp_file_share_search_key").val()),"friend");
       })
...
<div class="paper__func-tool" style="top: 48px;">
    <div class="paper__func-tool-findbox" style = "width: 96%;">
        ...
        <input type="text" placeholder="检索联系人" id = "m_grp_file_share_search_key" oninput="MobileGrpFile.showChooseList(this.value,'friend')">
    </div>
</div>

<div class="effort_list" style="width: 100%;z-index: 99;">
  <div class="paper_content-container main-list" style="padding-top: 95px;">
    <div class="main-list__list item_no-padding" list-main="m_grp_file_share_friend"></div>
  </div>
</div>
</body>
</html>