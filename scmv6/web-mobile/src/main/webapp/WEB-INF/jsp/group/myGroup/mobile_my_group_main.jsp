...
$(function(){
 //初始化检索输入框
  ...
  Group.myGroupList();
  selectRecommendPubMenu('myGroup');   
});
...
<body>
  <form action="/grp/mobile/mygroupconditions" method="get" id="select_filter_action">
  ...
  <div>
    <div class="paper__func-header">
      <a href="/psnweb/mobile/myhome"><i class="material-icons paper__func-header__tip">keyboard_arrow_left</i></a> <span>我的群组</span>
      <i class="material-icons paper__func-header__tip"></i>
    </div>
   <%@ include file="/common/mobile/common_mobile_search_input.jsp" %>
  </div>
  <div style="width: 100%;">
    <div class="paper_content-container main-list" style="margin-bottom: 40px;">   
      <div class="main-list__list item_no-padding" list-main="mygrplist"></div>
    </div> 
  </div>
