...
<input type="hidden" id="eduId" value="${psnOperateVO.eduId}"/>
...
<input type="hidden" id="toMonth" value="${psnOperateVO.toMonth}"/>
        <div class="new-edit_keword-header">
            ...
            <span class="new-edit_keword-header_title">${psnOperateVO.type=="add"?"新增":"编辑"}教育经历</span> 
        ...
        <div class="new-edit_psntitle-body" style=" margin-top: 60px;">
           ...
           <div class="new-edit_psntitle-body_item">
                <div class="new-edit_psntitle-body_item-box">
                    ...
                    <input type="text" class="new-edit_psntitle-body_item-input" autocomplete="new-insName" name="insName" oninput="showAutoInstitution();" id="newInsName" value="${psnOperateVO.insName }" maxlength="200" >
            ...
            <div class="new-edit_psntitle-body_item">
                <div class="new-edit_psntitle-body_item-box">
                    <span class="new-edit_psntitle-body_item-detail">主修</span>
                    <input type="text" class="new-edit_psntitle-body_item-input change-input_backgroundcolor" autocomplete="new-study" name="study" oninput="showAutoStudy()" id="newStudy" value="${psnOperateVO.study }" maxlength="200">
            ...
            <div class="new-edit_psntitle-body_item">
                <div class="new-edit_psntitle-body_item-box">
                    <span class="new-edit_psntitle-body_item-detail">学位</span>
                    <input type="text" class="new-edit_psntitle-body_item-input change-input_backgroundcolor" autocomplete="new-degreeName" name="degreeName" oninput="showAutoDegree()" id="newDegreeName" value="${psnOperateVO.degreeName }" maxlength="50">
                    <div class="new-edit_psntitle-body_item-input_autoshow" style="display:none;height: auto;" id="autodegree"></div>
                </div>
            </div>
        ...
        <div class="new-edit_page-normal_footer" onclick="saveEducateHistory();">保存</div>
</body>
</html>