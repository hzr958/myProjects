...
<body>
  <form id="pub_search" action="/prj/mobile/represent/addenter" method="get">
    ...
    <input id="searchKey" name="searchKey" type="hidden" value="${prjListVO.searchKey}" />  
  ...
  <div class="provision_container-body">
    ...
    <div class="provision_container-body_item">
      <c:forEach items="${prjListVO.agencyNameList}" var="agency">
    ...
    <div class="provision_container-body_item">
      <div class="provision_container-body_item-list fundingYear" value='${prjListVO.currentYear }'>近一年</div>
      <div class="provision_container-body_item-list fundingYear" value='${prjListVO.currentYear-2 }'>近三年</div>
      <div class="provision_container-body_item-list fundingYear" value='${prjListVO.currentYear-4 }'>近五年</div>
