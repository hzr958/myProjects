...
<%-- <link href="${resmod}/smate-pc/css/scmpcframe.css" rel="stylesheet" type="text/css">  12121--%>

</head>
<body>
  <form action="/pub/paper/conditions" method="get" id="select_filter_action">
  ...
  <div style="width: 100%;">
    ...
    <div class="paper_content-container main-list dev_history_comment" id="content_pub_list"
      ...
      <div class="main-list__list item_no-padding" list-main="mobile_find_pub_list" id="mobile_find_pub_list_div" style = "margin-top: 145px;"></div>
...
$(function(){
        ...
        window.addEventListener('pageshow', function(){
            //选中发现菜单栏
            if (isPageHide) {
                setTabs("one",1,3,$("li[id='one1']").parent().get(0));
            }
        });
        window.addEventListener('pagehide', function(){
            isPageHide = true;
        });
    $("#searchStringInput").attr("searchType","paper");
    ...
    commonMobileSearch.initSearchInput(searchOptions);
  //加载数据
...
function sharePub(des3ResId,dbId){
  ...
  //需求变更,进入页面进行分享
  SmateCommon.mobileShareEntrance(des3ResId,"pdwh",$("#searchStringInput").val());
  })
}
