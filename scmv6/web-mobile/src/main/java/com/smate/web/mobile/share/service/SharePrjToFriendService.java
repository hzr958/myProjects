 ...
 * @date May 24, 2019
 */
@Service("sharePrjToFriendService")
@Transactional(rollbackFor = Exception.class)
public class SharePrjToFriendService extends ShareToSmateService {
  ...
  Map<String, Object> shareRes(SmateShareVO vo) {
    ...
    Map<String, Object> resultMap =
        restTemplate.postForObject(vo.getDomainMobile() + SmateShareConstant.SHARE_PRJ_TO_FRIENDS_URL,
  ...
  private MultiValueMap<String, String> buildShareParams(SmateShareVO vo) {
    ...
    params.add("receiverIds", StringUtils.trimToEmpty(vo.getDes3FriendIds()));
