package com.smate.web.mobile.v8pub.po;
...
import com.smate.web.mobile.v8pub.enums.PubSnsStatusEnum;
...
public class PubSnsPO extends PubPO {
   ...
   * 成果状态
   */
  @Convert(converter = PubSnsStatusEnum.PubSnsStatusEnumConverter.class)
  @Column(name = "STATUS")
  ...
  public String toString() {
    return "PubSnsPO{" + "pubId=" + pubId + ", publishDate=" + publishDate + ", countryId=" + countryId
