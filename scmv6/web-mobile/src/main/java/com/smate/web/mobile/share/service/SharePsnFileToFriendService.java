 ...
 * @date May 24, 2019
 */
@Service("sharePsnFileToFriendService")
@Transactional(rollbackFor = Exception.class)
public class SharePsnFileToFriendService extends ShareToSmateService {
  ...
  Map<String, Object> shareRes(SmateShareVO vo) {
    ...
    Map<String, Object> resultMap =
        restTemplate.postForObject(vo.getDomainMobile() + SmateShareConstant.SHARE_PSN_FILE_TO_FRIENDS_URL,
  ...
  private MultiValueMap<String, String> buildShareParams(SmateShareVO vo) {
    ...
    params.add("des3FileIds", StringUtils.trimToEmpty(vo.getDes3ResId()));
