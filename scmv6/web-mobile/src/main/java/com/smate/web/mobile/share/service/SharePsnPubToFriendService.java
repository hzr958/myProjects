 ...
 * @date May 24, 2019
 */
@Service("sharePsnPubToFriendService")
@Transactional(rollbackFor = Exception.class)
public class SharePsnPubToFriendService extends ShareToSmateService {
  ...
  Map<String, Object> shareRes(SmateShareVO vo) {
    ...
    Map<String, Object> resultMap =
        restTemplate.postForObject(vo.getDomainMobile() + SmateShareConstant.SHARE_PSN_PUB_TO_FRIENDS_URL,
