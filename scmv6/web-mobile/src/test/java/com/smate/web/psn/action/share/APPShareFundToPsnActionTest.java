...
public class APPShareFundToPsnActionTest {
  ...
  @CsvSource({"9cSBdcwFjvA%3D,2VbmIdkIerJi4B8gp3FNGQ%3D%3D",
      "'9cSBdcwFjvA%3D,Krm%2Bn7o9wKQ%3D',2VbmIdkIerJi4B8gp3FNGQ%3D%3D"})
  public void testShareFundToPsn(String des3FundIds, String des3ReceiverIds) {
    String commentUrl = domainscm + "/app/psnweb/fund/ajaxshare";
    MultiValueMap<String, Object> param = new LinkedMultiValueMap<>();
    param.add("des3FundIds", des3FundIds);
    param.add("des3PsnId", Des3Utils.encodeToDes3(psnId));
    param.add("des3ReceiverIds", des3ReceiverIds);
