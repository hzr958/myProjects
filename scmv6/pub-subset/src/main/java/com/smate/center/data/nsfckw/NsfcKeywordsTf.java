...
public class NsfcKeywordsTf {

  public static void main(String[] args) throws Exception {
    Job job = Job.getInstance();
    job.setJarByClass(NsfcKeywordsTf.class);
    job.setJobName("keyword subset statistic");
    job.setMapperClass(NsfcKeywordsTfMapper.class);
    job.setReducerClass(NsfcKeywordsTfReducer.class);
