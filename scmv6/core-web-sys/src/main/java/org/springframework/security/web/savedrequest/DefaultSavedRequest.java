 ...
 * and {@link org.springframework.security.web.savedrequest.SavedRequestAwareWrapper} to reproduce
 * the request after successful authentication. An instance of this class is stored at the time of
 * an authentication exception by
 * {@link org.springframework.security.web.access.ExceptionTranslationFilter}.
 * <p>
 * <em>IMPLEMENTATION NOTE</em>: It is assumed that this object is accessed only from the context of
 * a single thread, so no synchronization around internal collection classes is performed.
 * <p>
