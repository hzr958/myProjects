...
import com.smate.batchtask.test.service.TestJob2Service;
import com.smate.batchtask.test.service.TestService;
import com.smate.core.base.utils.exception.BatchTaskException;

public class TestJob2Writer implements ItemWriter<Long>{
	@Autowired
	TestJob2Service testJob2Service;
	...
	public void write(List<? extends Long> items) throws BatchTaskException {
		...
		TestJob2Info single = new TestJob2Info();
		...
		testJob2Service.saveTaskMessage(single);
