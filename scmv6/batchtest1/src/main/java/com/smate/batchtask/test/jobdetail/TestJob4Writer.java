...
import com.smate.batchtask.test.service.TestJob4Service;
import com.smate.batchtask.test.service.TestService;
import com.smate.core.base.utils.exception.BatchTaskException;

public class TestJob4Writer implements ItemWriter<Long>{

	@Autowired
	TestJob4Service testJob4Service;
	...
	public void write(List<? extends Long> items) throws BatchTaskException {
		...
		TestJob4Info single = new TestJob4Info();
		...
		testJob4Service.saveTaskMessage(single);
