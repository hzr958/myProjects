...
import com.smate.batchtask.test.service.TestJob3Service;
import com.smate.batchtask.test.service.TestService;
import com.smate.core.base.utils.exception.BatchTaskException;

public class TestJob3Writer implements ItemWriter<Long>{

	@Autowired
	TestJob3Service testJob3Service;
	...
	public void write(List<? extends Long> items) throws BatchTaskException {
		...
		TestJob3Info single = new TestJob3Info();
		...
		testJob3Service.saveTaskMessage(single);
